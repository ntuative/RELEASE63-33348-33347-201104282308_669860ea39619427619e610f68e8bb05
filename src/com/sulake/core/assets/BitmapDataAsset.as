package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      private var var_1710:AssetTypeDeclaration;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._bitmap)
            {
               try
               {
                  var_514 -= this._bitmap.width * this._bitmap.height * 4;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_104 is BitmapDataAsset)
         {
            ...
            this.var_1429 = BitmapDataAsset(this.var_104).var_1429;
            this.var_1428 = BitmapDataAsset(this.var_104).var_1428;
            if(this._bitmap != null)
            {
               this.var_104 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1429 = _loc4_ == "1" || _loc4_ == "RC4_R27";
                  break;
               case "flipV":
                  this.var_1428 = _loc4_ == "1" || _loc4_ == "RC4_R27";
                  break;
            }
            _loc2_++;
         }
