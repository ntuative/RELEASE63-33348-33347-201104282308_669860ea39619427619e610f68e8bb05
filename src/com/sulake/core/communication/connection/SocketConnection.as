package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1622:int = 10000;
      ...
      private var var_1115:IMessageClassManager;
      
      private var var_243:ICoreCommunicationManager;
      
      private var var_491:IConnectionStateListener;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this._id = param1;
         this.var_243 = param2;
         this.var_490 = new ByteArray();
         this.var_1115 = new MessageClassManager();
         this.var_78 = new Socket();
         this.var_339 = new Timer(const_1622,1);
         this.var_339.addEventListener(TimerEvent.TIMER,this.onTimeOutTimer);
      ...
      public function init(param1:String, param2:uint = 0) : Boolean
      {
         if(this.var_491)
         {
            this.var_491.connectionInit(param1,param2);
         }
         Security.loadPolicyFile("xmlsocket://" + param1 + ":" + param2);
         this.var_339.start();
         this.var_720 = getTimer();
      ...
      {
         this.var_339.delay = param1;
      }
      
      public function addMessageEvent(param1:IMessageEvent) : void
      {
         this.var_243.addConnectionMessageEvent(this._id,param1);
      }
      
      public function removeMessageEvent(param1:IMessageEvent) : void
      {
         this.var_243.removeConnectionMessageEvent(this._id,param1);
      }
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_1115.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
         ...
         if(this.var_491)
         {
            this.var_491.messageSent(String(_loc4_),_loc6_.toString());
         }
         if(this.var_1116 != null)
         {
            _loc3_ = this.var_1116.encipher(_loc6_);
         }
         else
         {
            _loc3_ = _loc6_;
      ...
      {
         this.var_1115.registerMessages(param1);
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = this.var_719.getMessages(this.var_490,receivedMessages);
         try
         {
            for each(message in receivedMessages)
            {
               ...
               if(this.var_491)
               {
                  this.var_491.messageReceived(String(id),data.toString());
               }
               eventClasses = this.var_1115.getMessageEventClasses(id);
               events = new Array();
               for each(eventClass in eventClasses)
               {
                  eventsForClass = this.var_243.getMessageEvents(this,eventClass);
               ...
               for each(messageEventInstance in events)
               {
                  ...
                  if(parserClass != null)
                  {
                     ...
                     if(parserClass != parserClassCurrent)
                     {
                        ...
                        parserInstance = this.var_243.getMessageParser(parserClass);
            ...
            {
               temp = new ByteArray();
               temp.writeBytes(this.var_490,offset);
               this.var_490 = temp;
               this.logConnection("[SOCKET REST] offset: " + offset + " rest: " + this.var_490.toString());
            }
         }
         catch(e:Error)
         {
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         {
            this.var_490.writeByte(this.var_78.readUnsignedByte());
         }
      }
      ...
      private function onConnect(param1:Event) : void
      {
         ...
         this.var_339.stop();
         this.var_1684 = true;
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - this.var_720));
      ...
      private function onClose(param1:Event) : void
      {
         ...
         this.var_1684 = false;
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - this.var_720));
         dispatchEvent(param1);
      }
      ...
      private function onComplete(param1:Event) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - this.var_720));
         dispatchEvent(param1);
      }
      ...
      private function onSecurityError(param1:SecurityErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - this.var_720));
         dispatchEvent(param1);
      }
      ...
      private function onIOError(param1:IOErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - this.var_720));
         switch(param1.type)
         {
      ...
      private function onTimeOutTimer(param1:TimerEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - this.var_720));
         var _loc2_:IOErrorEvent = new IOErrorEvent(IOErrorEvent.IO_ERROR);
         _loc2_.text = "Socket Timeout (" + this.var_339.delay + " ms). Possible Firewall.";
