package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_1487:String = "asset-libraries";
      
      private static const const_1486:String = "library";
      
      private static const const_1485:String = "service-libraries";
      
      private static const const_1489:String = "library";
      
      private static const const_1484:String = "component-libraries";
      
      private static const const_1481:String = "library";
      
      private static const const_1482:String = "error_data";
      
      private static const const_1483:String = "error_cat";
      
      private static const const_1488:String = "error_desc";
       
      
      private var var_386:LibraryLoaderQueue;
      
      private var var_840:IEventDispatcher;
      
      private var var_554:uint;
      
      private var var_385:Function;
      ...
      public function CoreComponentContext(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         switch(param2 & 0)
         {
            case Core.const_1298:
               ...
               this.var_385 = this.simpleFrameUpdateHandler;
               break;
            case Core.const_927:
               debug("Core; using complex frame update handler");
               this.var_385 = this.complexFrameUpdateHandler;
               break;
            case Core.const_712:
               debug("Core; using profiler frame update handler");
               this.var_385 = this.profilerFrameUpdateHandler;
               this.var_212 = new Profiler(this);
               attachComponent(this.var_212,[new IIDProfiler()]);
               var_400.addChild(new ProfilerViewer(this.var_212));
               break;
            case Core.const_473:
               debug("Core; using experimental frame update handler");
               this.var_385 = this.experimentalFrameUpdateHandler;
               break;
            case Core.CORE_SETUP_DEBUG:
               debug("Core; using debug frame update handler");
               this.var_385 = this.debugFrameUpdateHandler;
         }
      }
      ...
      {
         return this.var_554 - this.getNumberOfFilesPending();
      }
      ...
      override public function error(param1:String, param2:Boolean, param3:int = -1, param4:Error = null) : void
      {
         if(param4)
         {
            ErrorReportStorage.setParameter(const_1482,String(param4.getStackTrace()));
         }
         ErrorReportStorage.setParameter(const_1483,String(param3));
         ErrorReportStorage.setParameter(const_1488,param1);
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         this.var_840 = loadingEventDelegate;
         if(this.var_386 == null)
         {
            this.var_386 = new LibraryLoaderQueue(_debug);
         }
         try
         {
            node = config.child(const_1487)[0];
            if(node != null)
            {
         ...
         {
            error("Failed to parse asset libraries from config xml!",true,Core.const_360,e);
         }
         try
         {
         ...
         {
            error("Failed to parse interfaces from config xml!",true,Core.const_360,e);
         }
         try
         {
         ...
         {
            error("Failed to parse components from config xml!",true,Core.const_360,e);
         }
         if(!disposed)
         {
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         this.error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1744);
         if(!disposed)
         {
      ...
      private function finalizeLoadingEventDelegate() : void
      {
         if(this.var_840)
         {
            this.var_840.dispatchEvent(new Event(Event.COMPLETE));
         }
      }
      ...
      private function updateLoadingProgress(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(this.var_840)
         {
            ...
            this.var_840.dispatchEvent(new LibraryProgressEvent(_loc2_.url,param1.bytesLoaded,param1.bytesTotal,_loc2_.elapsedTime));
         }
      }
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(!disposed)
               {
                  if(this.var_840)
                  {
                     this.var_840.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_554 - this.var_386.length,this.var_554,_loc2_.elapsedTime));
                  }
               }
            }
         }
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:int = !!this.var_212 ? 0 : this.var_1566 & 0;
         if(_loc3_ == Core.const_473)
         {
      ...
      private function onEnterFrame(param1:Event) : void
      {
         ...
         this.var_385(_loc2_,_loc2_ - this._lastUpdateTimeMs);
      ...
      private function complexFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         while(priority < CoreComponentContext.const_110)
         {
            ...
            {
               if(this.var_687[priority] < priority)
               {
                  ++this.var_687[priority];
                  skip = true;
               }
            }
            if(!skip)
