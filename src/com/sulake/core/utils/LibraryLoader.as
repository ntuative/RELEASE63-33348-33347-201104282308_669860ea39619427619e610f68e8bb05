package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1833:uint = 1;
      
      protected static const const_1834:uint = 2;
      
      protected static const const_1835:uint = 4;
      
      protected static const const_1832:uint = 3;
      
      protected static const name_4:uint = 7;
      
      public static const const_1778:int = 5;
      
      public static const LIBRARY_LOADER_FINALIZE:String = "LIBRARY_LOADER_FINALIZE";
      
      public static const const_1194:Boolean = false;
      
      public static const const_1531:int = 2;
      
      private static var var_956:Array = new Array();
      
      private static var var_769:Array = new Array();
      ...
      protected var var_669:Class;
      
      protected var var_472:uint = 0;
      
      protected var _name:String;
      
      protected var var_1080:Boolean = false;
      ...
      protected var var_1335:int;
      
      protected var var_1334:int;
      
      protected var var_2996:uint = 0;
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1194)
         {
            ...
            while(_loc2_ > -1)
            {
               _loc1_ = var_769[_loc2_] as LibraryLoader;
            ...
            while(var_769.length < const_1531 && false)
            {
               _loc1_ = var_956.shift() as LibraryLoader;
      ...
      {
         return !!this.var_1080 ? uint(this.var_1335 - this.var_2131) : uint(getTimer() - this.var_2131);
      }
      ...
      public function resume() : void
      {
         ...
         {
            this.var_1079 = false;
            if(!this.var_1080 && this.var_239)
            {
               this.var_1335 = -1;
               this.var_2131 = getTimer();
               queue(this);
            }
         }
      }
      ...
      {
         if(!this.var_1080 && !_disposed && this.var_1334 > 0)
         {
            try
            {
               this.var_43.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_239,const_1778 - this.var_1334);
            if(this.var_2909)
            {
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         if(this.var_472 == LibraryLoader.const_1832)
         {
      ...
      protected function prepareLibrary() : Boolean
      {
         ...
         this.var_669 = this.getDefinition(this._name) as Class;
         ...
         try
         {
            xmlClass = this.var_669.manifest as Class;
            if(xmlClass == null)
            {
               return false;
            }
