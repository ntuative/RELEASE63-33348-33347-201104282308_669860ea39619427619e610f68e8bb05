package com.sulake.core.utils
{
   ...
   public class XMLVariableParser
   {
      ...
      public static const const_1618:String = "float";
      
      public static const const_39:String = "Boolean";
      
      public static const const_1679:String = "bool";
      ...
      private static const const_1870:String = "false";
      ...
      private static function parseVariableToken(param1:XML, param2:Map, param3:Array = null) : void
      {
         ...
         else
         {
            ...
            else if(_loc5_ == const_275 || _loc5_ == const_154)
            {
      ...
      public static function castStringToType(param1:String, param2:String) : Object
      {
         switch(param2)
         {
            ...
            case const_1618:
               return Number(param1);
            case const_39:
               return param1 == const_674 || int(param1) > 0;
            case const_1679:
               return param1 == const_674 || int(param1) > 0;
            case const_155:
               return uint(param1);
            case const_154:
               return param1.split(const_1440);
            default:
