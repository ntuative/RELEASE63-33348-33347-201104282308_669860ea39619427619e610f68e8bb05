package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1439:String = "_TITLE";
      
      private static const const_1436:String = "_HEADER";
      
      private static const const_1437:String = "_CONTENT";
      
      private static const const_1438:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1507:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1439) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1507 = findChildByTag(const_1436) as IHeaderWindow;
            if(!this.var_1507)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_183 = findChildByTag(const_1437) as IWindowContainer;
            if(!this.var_183)
            {
      ...
      {
         return findChildByTag(const_1438) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1311,_loc2_,false);
      ...
      {
         return this.content != null && this.var_1080 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_317,false);
         }
      ...
      override public function get properties() : Array
      {
         ...
         if(_loc2_)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_259,_loc3_.left,PropertyStruct.const_42,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_254,_loc3_.top,PropertyStruct.const_42,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_237,0 - _loc3_.right,PropertyStruct.const_42,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_250,0 - _loc3_.bottom,PropertyStruct.const_42,_loc2_));
         }
         else
         {
