package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_1013:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      {
         this.var_821 = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1257 == param2)
         {
            return;
         }
         param1.var_1257 = param2;
         param1.var_2003 = null;
         if(param1.var_1257 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1257);
      ...
      {
         if(PropertyDefaults.const_939.indexOf(param1) > -1)
         {
            this.var_821 = param1;
         }
      }
      ...
      {
         return this.var_821 == LinkTarget.const_29 ? defaultLinkTarget : this.var_821;
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_1166)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_821 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_740,this.var_821,PropertyStruct.const_52,true,PropertyDefaults.const_939));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_740)
            {
