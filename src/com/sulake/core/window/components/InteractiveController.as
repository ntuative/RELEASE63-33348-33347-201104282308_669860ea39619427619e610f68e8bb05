   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      public static function processInteractiveWindowEvents(param1:IInteractiveWindow, param2:WindowEvent) : void
      {
         if(param1.toolTipCaption != PropertyDefaults.const_547)
         {
            ...
            else if(param2.type != WindowMouseEvent.const_224)
            {
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_547)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_758,param1.toolTipCaption,PropertyStruct.const_52,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1820);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_1188)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_784,param1.toolTipDelay,PropertyStruct.const_280,true));
         }
         else
         {
      ...
      {
         this.var_1332 = param1 == null ? "null" : param1;
      }
