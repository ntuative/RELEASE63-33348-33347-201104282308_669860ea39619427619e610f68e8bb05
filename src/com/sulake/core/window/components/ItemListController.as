package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_2143:Boolean = false;
      
      protected var var_576:Boolean = false;
      ...
      protected var var_1083:Boolean = true;
      
      protected var var_476:Boolean = false;
      
      protected var var_1342:Boolean = false;
      
      protected var var_2142:int = 0;
      
      protected var var_2141:int = 0;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_173 = var_480 || !testParamFlag(WindowParam.const_32);
         this._container = _context.create("_CONTAINER","",WindowType.const_407,WindowStyle.const_170,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         ...
         this.resizeOnItemUpdate = this.var_1342;
      }
      ...
      {
         return new Rectangle(this.var_708 * this.maxScrollH,this.var_705 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         if(param1 != this.var_708)
         {
            this.var_708 = param1;
            this._container.x = -this.var_708 * this.maxScrollH;
            _context.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_59);
            _loc2_ = WindowEvent.allocate(WindowEvent.const_606,this,null);
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_224:
               if(this.var_1343)
               {
                  this.var_1344 = this.var_2142 - _loc3_;
                  this.var_1345 = this.var_2141 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1344 != 0 && this.var_108 != 0)
                     {
                        this.scrollH += this.var_1344 / this.var_108;
                     }
                  }
                  else if(this.var_1345 != 0 && this.var_95 != 0)
                  {
                     this.scrollV += this.var_1345 / this.var_95;
                  }
                  this.var_2142 = _loc3_;
                  this.var_2141 = _loc4_;
                  _loc2_ = true;
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_1083 && !this.var_576 && this._container)
         {
            this.var_576 = true;
      ...
      override public function get properties() : Array
      {
         ...
         if(this._spacing != PropertyDefaults.const_954)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_376,this._spacing,PropertyStruct.const_42,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1211);
         }
         if(this.var_1083 != PropertyDefaults.const_1304)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_823,this.var_1083,PropertyStruct.const_39,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1585);
         }
         if(this.var_476 != PropertyDefaults.const_1195)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_936,this.var_476,PropertyStruct.const_39,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1765);
         }
         if(this.var_1342 != PropertyDefaults.const_1203)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_867,this.var_1342,PropertyStruct.const_39,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1733);
         }
         if(this.var_706 != PropertyDefaults.const_1130)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_818,this.var_706,PropertyStruct.const_123,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1666);
         }
         if(this.var_707 != PropertyDefaults.const_1186)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_837,this.var_707,PropertyStruct.const_123,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1564);
         }
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_823:
                  this.var_1083 = _loc2_.value as Boolean;
                  break;
