package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_449:IScrollbarWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_449)
         {
            this.var_449.removeEventListener(WindowEvent.const_245,this.scrollBarEventProc);
            this.var_449.removeEventListener(WindowEvent.const_216,this.scrollBarEventProc);
            this.var_449 = null;
         }
         if(this.var_1252)
         {
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_449)
         {
            this.var_449 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_449)
            {
               this.var_449.addEventListener(WindowEvent.const_245,this.scrollBarEventProc);
               this.var_449.addEventListener(WindowEvent.const_216,this.scrollBarEventProc);
            }
         }
         return this.var_449;
      }
