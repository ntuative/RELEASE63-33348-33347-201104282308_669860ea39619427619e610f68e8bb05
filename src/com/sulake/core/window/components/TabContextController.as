package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1515:String = "_SELECTOR";
      
      private static const const_1516:String = "_CONTENT";
       
      
      protected var var_1086:ITabSelectorWindow;
      
      protected var var_2146:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1086 = findChildByTag(const_1515) as ITabSelectorWindow;
            if(this.var_1086 != null)
            {
               this.var_1086.procedure = this.selectorEventProc;
            }
         }
      ...
      {
         if(this.var_2146 == null)
         {
            this.var_2146 = findChildByTag(const_1516) as IWindowContainer;
         }
      ...
      {
         return !!this.var_859 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_1086.numSelectables;
      }
