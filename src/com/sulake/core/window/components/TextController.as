package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1314:Dictionary = createPropertySetterTable();
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_788 ? true : null;
         }
      ...
      {
         return new Rectangle(this.var_878 * this.maxScrollH,this.var_571 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_868,this._field.antiAliasType,PropertyStruct.const_52,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1145));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1117 ? new PropertyStruct(PropertyDefaults.const_947,this._autoSize,PropertyStruct.const_52,true,PropertyDefaults.const_1138) : PropertyDefaults.const_1794);
         _loc1_.push(new PropertyStruct("border",this._field.border,PropertyStruct.const_39,this._field.border == true));
         _loc1_.push(new PropertyStruct("border_color",this._field.borderColor,PropertyStruct.const_155,this._field.borderColor != 0));
         ...
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1260 ? new PropertyStruct(PropertyDefaults.const_1270,this._field.gridFitType,PropertyStruct.const_52,true,PropertyDefaults.const_1124) : PropertyDefaults.const_1819);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_810) ? new PropertyStruct(PropertyDefaults.const_374,this._field.textColor,PropertyStruct.const_155,true) : PropertyDefaults.const_1280);
         _loc1_.push(this.var_440 != TextStyleManager.const_201 ? new PropertyStruct(PropertyDefaults.const_426,this.var_440,PropertyStruct.const_52,true,PropertyDefaults.const_958) : PropertyDefaults.const_1101);
         _loc1_.push(this.var_41.left != PropertyDefaults.const_760 ? new PropertyStruct(PropertyDefaults.const_259,this.var_41.left,PropertyStruct.const_42,true) : PropertyDefaults.const_510);
         _loc1_.push(this.var_41.top != PropertyDefaults.const_811 ? new PropertyStruct(PropertyDefaults.const_254,this.var_41.top,PropertyStruct.const_42,true) : PropertyDefaults.const_500);
         _loc1_.push(this.var_41.right != PropertyDefaults.const_813 ? new PropertyStruct(PropertyDefaults.const_237,this.var_41.right,PropertyStruct.const_42,true) : PropertyDefaults.const_474);
         _loc1_.push(this.var_41.bottom != PropertyDefaults.const_943 ? new PropertyStruct(PropertyDefaults.const_250,this.var_41.bottom,PropertyStruct.const_42,true) : PropertyDefaults.const_613);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1119 ? new PropertyStruct(PropertyDefaults.const_835,this._field.mouseWheelEnabled,PropertyStruct.const_39,true) : PropertyDefaults.const_1576);
         ...
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_123,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_123,this._field.thickness != 0));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_123,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
