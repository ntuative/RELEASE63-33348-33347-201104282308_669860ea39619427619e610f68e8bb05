package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1614:uint = 500;
      ...
      {
         this.var_1332 = param1 == null ? "" : param1;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_21)
         {
            var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1109,var_11);
         }
         return var_21;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_859 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            _context.handleError(WindowContext.const_435,e);
         }
      }
      ...
      private function onKeyUpEvent(param1:KeyboardEvent) : void
      {
         ...
         try
         {
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_312,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_780,false,PropertyStruct.const_39,true) : PropertyDefaults.const_1826);
         _loc1_.push(this.var_1346 != PropertyDefaults.const_1226 ? new PropertyStruct(PropertyDefaults.const_692,this.var_1346,PropertyStruct.const_39,true) : PropertyDefaults.const_1535);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1271 ? new PropertyStruct(PropertyDefaults.const_857,_field.selectable,PropertyStruct.const_39,true) : PropertyDefaults.const_1803);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1230 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_39,true) : PropertyDefaults.const_1561);
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_692:
               ...
               case PropertyDefaults.const_780:
                  ...
                  break;
               case PropertyDefaults.const_1225:
