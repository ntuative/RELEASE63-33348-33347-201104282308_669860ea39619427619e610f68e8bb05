package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      private var var_351:Object = null;
      ...
      protected function get textField() : TextField
      {
         ...
         if(_loc1_)
         {
            ...
            {
               _loc1_.textColor = uint(this.var_351);
            }
         }
         return _loc1_;
      }
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2479 = _loc2_.textWidth;
         this.var_2480 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_351 != _loc2_.color : this.var_351 != null && this.var_351 != PropertyDefaults.const_810) ? new PropertyStruct(PropertyDefaults.const_374,this.var_351,PropertyStruct.const_155,true) : PropertyDefaults.const_1280);
         if(this.var_41)
         {
            if(this.var_41.left != PropertyDefaults.const_760)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_259,this.var_41.left,PropertyStruct.const_42,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_510);
            }
            if(this.var_41.top != PropertyDefaults.const_811)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_254,this.var_41.top,PropertyStruct.const_42,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_500);
            }
            if(this.var_41.right != PropertyDefaults.const_813)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_237,this.var_41.right,PropertyStruct.const_42,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_474);
            }
            if(this.var_41.bottom != PropertyDefaults.const_943)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_250,this.var_41.bottom,PropertyStruct.const_42,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_613);
            }
         }
         else
         {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_374:
                  this.var_351 = _loc2_.value as uint;
                  break;
