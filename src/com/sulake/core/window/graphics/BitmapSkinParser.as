package com.sulake.core.window.graphics
{
   ...
   public class BitmapSkinParser
   {
      ...
      protected static function parseLayout(param1:ISkinRenderer, param2:XML, param3:Dictionary, param4:Map) : void
      {
         ...
         var _loc6_:* = param2.attribute("transparent") == "RC4_R27";
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         _loc5_.colorize = _loc6_ == "" ? true : _loc6_ == "RC4_R27";
         _loc6_ = null;
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_397 = SkinLayoutEntity.const_516;
                  break;
               case "move":
                  _loc5_.var_397 = SkinLayoutEntity.const_338;
                  break;
               case "strech":
                  _loc5_.var_397 = SkinLayoutEntity.const_506;
                  break;
               case "tiled":
                  _loc5_.var_397 = SkinLayoutEntity.const_339;
                  break;
               case "center":
                  _loc5_.var_397 = SkinLayoutEntity.const_1172;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_399 = SkinLayoutEntity.const_516;
                  break;
               case "move":
                  _loc5_.var_399 = SkinLayoutEntity.const_338;
                  break;
               case "strech":
                  _loc5_.var_399 = SkinLayoutEntity.const_506;
                  break;
               case "tiled":
                  _loc5_.var_399 = SkinLayoutEntity.const_339;
                  break;
               case "center":
                  _loc5_.var_399 = SkinLayoutEntity.const_1172;
            }
         }
