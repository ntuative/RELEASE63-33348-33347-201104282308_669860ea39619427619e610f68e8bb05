package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1798:uint = 0;
      
      public static const const_935:uint = 1;
      
      public static const const_1109:uint = 2;
      
      public static const const_801:uint = 4;
      
      public static const const_1725:uint = 8;
      
      public static const const_1814:uint = 16;
      
      public static const const_1989:uint = 64;
      
      public static const const_2049:uint = 128;
      
      public static const const_1209:uint = 256;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            case GraphicContext.const_935:
               ...
               break;
            case GraphicContext.const_1109:
         ...
         if(this.var_872)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2124,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2124,16777215);
                  }
                  var_332 += bitmap.width * bitmap.height * 4;
               }
