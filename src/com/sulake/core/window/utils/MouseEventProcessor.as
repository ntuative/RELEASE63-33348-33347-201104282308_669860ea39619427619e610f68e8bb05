package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      {
         super();
         this.var_702 = new Point();
         if(var_333 == null)
         {
            var_333 = new Array();
            var_333[0] = MouseCursorType.const_302;
            var_333[1] = MouseCursorType.const_29;
            var_333[2] = MouseCursorType.const_302;
            var_333[3] = MouseCursorType.const_302;
            var_333[4] = MouseCursorType.const_302;
            var_333[5] = MouseCursorType.const_29;
            var_333[6] = MouseCursorType.const_302;
         }
         if(var_287 == null)
         {
            var_287 = new Array();
            var_287[0] = WindowState.const_108;
            var_287[1] = WindowState.const_89;
            var_287[2] = WindowState.const_88;
            var_287[3] = WindowState.const_68;
            var_287[4] = WindowState.const_55;
      ...
      protected static function convertMouseEventType(param1:MouseEvent, param2:IWindow, param3:IWindow) : WindowMouseEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_UP:
               ...
               _loc4_ = !!_loc6_ ? "null" : WindowMouseEvent.const_221;
               break;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_62 = state.var_1327 as WindowController;
         this.var_174 = state.var_1326 as WindowController;
         this.var_167 = state.renderer;
         this.var_873 = state.var_1323;
         eventQueue.begin();
         this.var_702.x = -1;
         this.var_702.y = -1;
         ...
         while(true)
         {
            ...
            if(event.stageX != this.var_702.x || event.stageY != this.var_702.y)
            {
               this.var_702.x = event.stageX;
               this.var_702.y = event.stageY;
               array = new Array();
               this.var_81.groupParameterFilteredChildrenUnderPoint(this.var_702,array,WindowParam.const_30);
            }
         ...
         state.var_1327 = this.var_62;
         state.var_1326 = this.var_174;
         state.renderer = this.var_167;
         state.var_1323 = this.var_873;
      }
