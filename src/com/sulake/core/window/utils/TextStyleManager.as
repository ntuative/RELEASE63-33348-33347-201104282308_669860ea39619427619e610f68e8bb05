package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      private static var var_528:Array;
      
      private static var _eventDispatcher:IEventDispatcher;
      
      private static const const_663:String = "{";
      
      private static const const_662:String = "}";
      
      private static const const_1443:String = "/*";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_84[const_201],var_84[ITALIC],var_84[BOLD]];
            var_84.reset();
            var_84[const_201] = _loc5_[0];
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(var_528.indexOf(_loc4_.name) == -1)
            {
               var_528.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
      ...
      public static function parseCSS(param1:String) : Array
      {
         ...
         for each(_loc7_ in _loc3_)
         {
            ...
            _loc6_.kerning = !!_loc5_.kerning ? _loc5_.kerning == "RC4_R27" : null;
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_662);
         if(countSubStrings(param1,const_663) != countSubStrings(param1,const_662))
         {
            throw new Error("Mismatching amount of \"" + const_663 + "\" versus \"" + const_662 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1443) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1444) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_663)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
