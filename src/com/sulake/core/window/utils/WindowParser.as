package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1923:String = "_INCLUDE";
      
      public static const const_2033:String = "_TEMP";
      
      private static const const_1498:String = "layout";
      
      private static const const_1061:String = "window";
      
      private static const const_1059:String = "variables";
      
      private static const const_1060:String = "filters";
      
      private static const const_455:String = "name";
      
      private static const const_1504:String = "style";
      
      private static const const_675:String = "params";
      
      private static const const_1492:String = "tags";
      ...
      private static const const_1499:String = "visible";
      
      private static const const_1505:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_4:String = "background";
      
      private static const const_1243:String = "blend";
      
      private static const const_1500:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1493:String = "treshold";
      
      private static const const_1502:String = "children";
      
      private static const const_1494:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1496:String = "height_min";
      
      private static const const_1503:String = "height_max";
      
      private static const const_674:String = "RC4_R27";
      
      private static const const_189:String = "0";
      
      private static const const_1497:String = "$";
      
      private static const const_1440:String = ",";
      
      private static const const_49:String = "";
      
      private static const const_1501:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1495:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1348:Dictionary;
      
      protected var var_1347:Dictionary;
      
      protected var var_1085:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this.var_1348,this.var_1347);
         this.var_1085 = new Dictionary();
         this.var_1620 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1085,this.var_1620);
         this.var_2144 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1495,const_49);
         return param1.replace(const_1501,const_49);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_1348)
            {
               delete this.var_1348[_loc1_];
            }
            for(_loc1_ in this.var_1347)
            {
               delete this.var_1347[_loc1_];
            }
            for(_loc1_ in this.var_1085)
            {
               delete this.var_1085[_loc1_];
            }
            for(_loc1_ in this.var_1620)
            {
               delete this.var_1620[_loc1_];
            }
            this.var_2144.dispose();
            this.var_2144 = null;
            this._context = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1498)
         {
            _loc8_ = param1.child(const_1059);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc4_ = param1.child(const_1061);
         ...
         if(param1.localName() == const_1061)
         {
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1348[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_455,variables,"")));
         style = uint(this.parseAttribute(xml,const_1504,variables,style));
         params = uint(this.parseAttribute(xml,const_675,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1492,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_189));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_189));
         rect.width = Number(this.parseAttribute(xml,name_5,variables,const_189));
         rect.height = Number(this.parseAttribute(xml,name_1,variables,const_189));
         visible = this.parseAttribute(xml,const_1499,variables,visible.toString()) == const_674;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_675).length() > 0)
         {
            list = xml.child(const_675).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               ...
               if(this.var_1085[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_455)) + "\"!");
               }
               params |= this.var_1085[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_49) : const_49;
         caption = unescape(String(this.parseAttribute(xml,const_1505,variables,caption)));
         if(tag != const_49)
         {
            tags = tag.split(const_1440);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_1059)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1494,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1496,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1503,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_4,variables,window.background.toString()) == const_674;
         blend = Number(this.parseAttribute(xml,const_1243,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1500,variables,window.clipping.toString()) == const_674;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1493,variables,window.mouseThreshold.toString()));
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_49;
         var _loc3_:String = this.var_1347[param1.type];
