package com.sulake.core.window.utils
{
   ...
   public class WindowRectLimits implements IRectLimiter
   {
      ...
      private var var_294:int = -2.147483648E9;
      
      private var var_293:int = 2.147483647E9;
      
      private var var_295:int = -2.147483648E9;
      
      private var var_296:int = 2.147483647E9;
      ...
      {
         this.var_294 = param1;
         if(this.var_294 > int.MIN_VALUE && !this._target.disposed && this._target.width < this.var_294)
         {
      ...
      {
         this.var_296 = param1;
         if(this.var_296 < int.MAX_VALUE && !this._target.disposed && this._target.height > this.var_296)
         {
            this._target.height = this.var_296;
         }
      }
      
      public function get isEmpty() : Boolean
      {
         return this.var_294 == int.MIN_VALUE && this.var_293 == int.MAX_VALUE && this.var_295 == int.MIN_VALUE && this.var_296 == int.MAX_VALUE;
      }
      
      public function setEmpty() : void
      {
         this.var_294 = int.MIN_VALUE;
         this.var_293 = int.MAX_VALUE;
         this.var_295 = int.MIN_VALUE;
         this.var_296 = int.MAX_VALUE;
      }
      ...
      public function limit() : void
      {
         ...
         {
            if(this._target.width < this.var_294)
            {
               this._target.width = this.var_294;
            }
            ...
            else if(this._target.height > this.var_296)
            {
               this._target.height = this.var_296;
            }
         }
