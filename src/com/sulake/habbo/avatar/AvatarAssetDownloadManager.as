package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadManager extends EventDispatcher
   {
      ...
      private var var_928:int = 3;
      
      private var var_421:AssetLoaderStruct;
      
      private var var_926:Timer;
      ...
      private const const_2143:int = 100;
      
      private const const_1531:int = 2;
      ...
      public function AvatarAssetDownloadManager(param1:IAssetLibrary, param2:String, param3:String, param4:AvatarStructure)
      {
         ...
         if(_loc6_ == null)
         {
            this.var_421 = this._assets.loadAssetFromFile("figuremap",_loc5_,"text/xml");
         ...
         this.var_926 = new Timer(this.const_2143,1);
         this.var_926.addEventListener(TimerEvent.TIMER_COMPLETE,this.onNextDownloadTimeout);
      }
      ...
      private function addMapLoaderEventListeners() : void
      {
         if(this.var_421)
         {
            this.var_421.addEventListener(AssetLoaderEvent.const_28,this.onConfigurationComplete);
            this.var_421.addEventListener(AssetLoaderEvent.const_47,this.onConfigurationError);
         }
      }
      ...
      private function removeMapLoaderEventListeners() : void
      {
         if(this.var_421)
         {
            this.var_421.removeEventListener(AssetLoaderEvent.const_28,this.onConfigurationComplete);
            this.var_421.removeEventListener(AssetLoaderEvent.const_47,this.onConfigurationError);
         }
      }
      ...
      private function onConfigurationError(param1:Event) : void
      {
         ...
         {
            Logger.log("Could not download figuremap.xml. Retries left: " + this.var_928);
            if(this.var_1412.indexOf("?") > 0)
            {
               _loc2_ = this.var_1412 + "&retry=" + this.var_928;
            }
            else
            {
               _loc2_ = this.var_1412 + "?retry=" + this.var_928;
            ...
            this.var_421 = this._assets.loadAssetFromFile("figuremap",_loc3_,"text/xml");
            this.addMapLoaderEventListeners();
         }
      }
      ...
      private function generateMap(param1:XML) : void
      {
         ...
         {
            _loc3_ = new AvatarAssetDownloadLibrary(_loc2_.@id,_loc2_.@revision,this.var_2396,this._assets);
      ...
      public function loadFigureSetData(param1:IAvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         if(!this.var_1740)
         {
            this.var_1156.push([param1,param2]);
            return;
         }
         ...
         if(_loc4_.length > 0)
         {
            ...
            {
               _loc6_ = this.var_552[_loc3_];
               if(_loc6_ == null)
               {
                  _loc6_ = [];
               }
               _loc6_.push(param2);
               this.var_552[_loc3_] = _loc6_;
            }
            this.var_927[_loc3_] = _loc4_;
      ...
      private function libraryComplete(param1:Event) : void
      {
         ...
         var _loc10_:* = null;
         var _loc2_:* = [];
         for(_loc3_ in this.var_927)
         {
            _loc7_ = true;
            _loc4_ = this.var_927[_loc3_];
            ...
            if(_loc7_)
            {
               ...
               delete this.var_552[_loc3_];
            }
         }
         for each(_loc3_ in _loc2_)
         {
            delete this.var_927[_loc3_];
         }
      ...
      {
         var _loc1_:* = null;
         while(this.var_742.length > 0 && this.var_741.length < this.const_1531)
         {
            _loc1_ = this.var_742[0];
            _loc1_.startDownloading();
            this.var_741.push(this.var_742.shift());
         }
      }
      
      private function addToQueue(param1:AvatarAssetDownloadLibrary) : void
      {
         if(!param1.isReady && this.var_742.indexOf(param1) == -1 && this.var_741.indexOf(param1) == -1)
         {
