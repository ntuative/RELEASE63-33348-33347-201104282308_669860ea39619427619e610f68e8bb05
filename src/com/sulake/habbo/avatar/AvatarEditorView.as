package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1611:IWindowContainer;
      
      public static var var_2092:int = 6710886;
      ...
      private var var_379:ITabSelectorWindow;
      
      private var _catalog:IHabboCatalog;
      
      private var var_531:IFrameWindow;
      
      private var var_443:Timer;
      
      private var var_2201:Number = 0;
      
      private var var_2721:Boolean = true;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1239 = [];
         this.var_1471 = [AvatarEditorFigureCategory.const_869,AvatarEditorFigureCategory.const_50,AvatarEditorFigureCategory.const_267,AvatarEditorFigureCategory.const_838,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_111];
         super();
         ...
         if(var_1611 == null)
         {
            ...
            var_1611 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_443 = new Timer(1000);
         this.var_443.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1471;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_443.stop();
            this.var_443.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_443 = null;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1471);
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2721 = this.canChangeOutfit();
            this.var_443.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_379 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_379.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_379.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1239.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_379.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_379.numSelectables)
               {
                  this.var_379.getSelectableAt(_loc6_).x = this.var_379.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
         }
         this.var_379.setSelected(this.var_379.getSelectableAt(0));
         this.attachImages();
         this.update();
      }
      ...
      private function attachImages() : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         var _loc1_:Array = this.var_1471;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_43) && (this.var_1963 == AvatarEditorSideCategory.const_111 || this.var_2720))
         {
      ...
      {
         if(this.var_1963 == AvatarEditorSideCategory.const_111)
         {
            this.var_2720 = false;
            this.setSideContent(AvatarEditorSideCategory.const_836);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_836:
               break;
            case AvatarEditorSideCategory.const_511:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_511);
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_367 = param1;
         this.var_379.setSelected(this.var_379.getSelectableByName(param1));
      }
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "save":
                  ...
                  this.var_2201 = new Date().valueOf();
                  this.var_2721 = false;
                  this.var_443.start();
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_531)
         {
            ...
            this.var_531 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_531.procedure = this.stripClubDialogEventProc;
            this.var_531.center();
         }
         else
         {
            this.var_531.visible = true;
            this.var_531.center();
         }
      }
      ...
      private function canChangeOutfit() : Boolean
      {
         ...
         return _loc1_ - this.var_2201 > 5000;
      }
   }
}
