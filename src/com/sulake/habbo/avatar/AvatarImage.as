package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1407:int = 2;
      ...
      protected var var_266:AvatarImageCache;
      
      protected var var_623:AvatarFigureContainer;
      ...
      private var var_968:IActiveActionData;
      ...
      private var var_2698:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.var_623 = param3;
         this.var_266 = new AvatarImageCache(this._structure,this,this._assets,this._scale);
         this.setDirection(const_1408,const_1407);
         this.var_330 = new Array();
         this.var_968 = new ActiveActionData(AvatarAction.const_392);
         this.var_968.definition = this._structure.getActionDefinition(const_1409);
         this.resetActions();
      ...
      {
         param2 += this.var_1863;
         if(param2 < AvatarDirectionAngle.const_1236)
         {
            param2 = AvatarDirectionAngle.const_313 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_313)
         {
            param2 -= NaN;
         }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_258.length == 1 && this.var_88 == this.var_1812)
         {
            return this.var_88 + this.var_526 + this.var_648 % 4;
         }
         if(this.var_258.length == 2)
         {
      ...
      {
         if(param3 != this.var_2696 || param2 != this.var_2697 || param1 != this.var_2698)
         {
            this.var_2696 = param3;
            this.var_2697 = param2;
            this.var_2698 = param1;
            this.var_1940 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1338 || this.var_47 == null || (this.var_47.width != _loc5_.width || this.var_47.height != _loc5_.height))
         {
            if(this.var_47 != null && !this.var_1338)
            {
               this.var_47.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_285.definition.geometryType,this.var_88);
         this.var_47.lock();
         ...
         if(this.var_575 != null)
         {
            if(this.var_575.paletteIsGrayscale)
            {
               ...
               this.var_47 = _loc13_;
               this.var_47.paletteMap(this.var_47,this.var_47.rect,new Point(0,0),this.var_575.reds,[],[]);
            }
            else
            {
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_330.push(new ActiveActionData(param1,param2,this.var_648));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_285 = this.var_968;
         this.var_285.definition = this.var_968.definition;
         this.resetBodyPartCache(this.var_968);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_526 = "";
         this.var_258 = this._structure.sortActions(this.var_330);
         if(this.var_258 == null)
         {
         ...
         {
            this.var_757 = this._structure.getCanvasOffsets(this.var_258,this._scale,this.var_88);
            for each(_loc4_ in this.var_258)
            {
               this.var_526 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_308)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1505 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1505 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
            ...
            if(this.var_1504 != this.var_526)
            {
               _loc1_ = true;
               this.var_1504 = this.var_526;
            }
         }
         this.var_1481 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_258)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_969 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_1863 = _loc2_.directionData.offset;
                     }
               ...
               if(_loc1_.actionType == AvatarAction.const_361 || _loc1_.actionType == AvatarAction.const_243 || _loc1_.actionType == AvatarAction.const_413)
               {
                  this.var_969 = true;
               }
            }
