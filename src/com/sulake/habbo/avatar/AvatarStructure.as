package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_968:ActionDefinition;
      
      private var var_508:String;
      
      private var var_1463:PartOffsetData;
      ...
      {
         this.var_1463.loadOffsets(param1);
      }
      ...
      public function initActions(param1:IAssetLibrary, param2:XML) : void
      {
         ...
         this.var_959 = new AvatarActionManager(param1,this.var_508,param2);
         this.var_968 = this.var_959.getDefaultAction();
      }
      ...
      public function initPartSets(param1:XML) : Boolean
      {
         ...
         {
            if(this.var_508 == AvatarType.const_125)
            {
      ...
      public function initFigureData(param1:XML) : Boolean
      {
         ...
         return this.var_360.parse(param1);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         this.var_360.injectXML(param1);
      }
      ...
      public function getPartColor(param1:IAvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = this.var_360.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = this.var_360.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      public function getMandatorySetTypeIds(param1:String, param2:int) : Array
      {
         ...
         this.var_629[param1][param2] = this.var_360.getMandatorySetTypeIds(param1,param2);
         return this.var_629[param1][param2];
      }
      
      public function getDefaultPartSet(param1:String, param2:String) : IFigurePartSet
      {
         return this.var_360.getDefaultPartSet(param1,param2);
      }
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1544[param3];
      ...
      public function getParts(param1:String, param2:IAvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         for each(_loc16_ in _loc20_)
         {
            ...
            _loc29_ = this.var_360.getSetType(_loc16_);
            if(_loc29_)
            {
               _loc30_ = this.var_360.getPalette(_loc29_.paletteID);
               if(_loc30_)
               {
      ...
      {
         return this.var_1463.getOffset(param1,param2,param3,param4,param5,param6);
      }
