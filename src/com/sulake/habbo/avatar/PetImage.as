package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_266:AvatarImageCache;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_50)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1480);
            if(_loc3_ != null)
            {
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         this.var_526 = this.var_526 + param1 + _loc3_;
         switch(param1)
         {
            case AvatarAction.const_433:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1760:
                  case AvatarAction.const_1746:
                  case AvatarAction.const_1530:
                  case AvatarAction.const_1140:
                  case AvatarAction.const_1251:
                  case AvatarAction.const_1661:
      ...
      private function resetActions() : Boolean
      {
         ...
         this.setActionToParts(this.var_968);
         this.getCache().resetBodyPartCache(this.var_968);
         return true;
      }
      ...
      private function sortActions() : void
      {
         ...
         this.var_1479 = this._structure.sortActions(this.var_330);
         ...
         {
            this.var_757 = this._structure.getCanvasOffsets(this.var_1479,this._scale,this.var_88);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for each(_loc1_ in this.var_1479)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_243)
               {
                  this.var_969 = true;
               }
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               for each(_loc4_ in _loc3_.parts)
               {
                  if(_loc4_.type == "pbd")
                  {
                     this.var_1226 = _loc4_.id;
                     this.var_1864 = _loc4_.breed;
                     break;
                  }
               }
            }
