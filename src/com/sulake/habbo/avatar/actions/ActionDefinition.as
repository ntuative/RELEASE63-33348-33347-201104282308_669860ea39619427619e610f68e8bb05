package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_2457 = parseInt(param1.@precedence);
         this.var_2459 = String(param1.@activepartset);
         this.var_2456 = String(param1.@assetpartdefinition);
         this.var_2458 = String(param1.@lay);
         this.var_811 = String(param1.@geometrytype);
         this.var_2460 = Boolean(parseInt(param1.@main));
         this.var_2461 = Boolean(parseInt(param1.@name_8));
         this.var_2455 = Boolean(parseInt(param1.@animation));
         this._preventHeadTurn = Boolean(String(param1.@preventheadturn == "RC4_R27"));
         ...
         for each(_loc3_ in param1.param)
         {
            ...
            if(_loc5_ == "default")
            {
               this.var_2462 = _loc6_;
            }
            else
            {
               this.var_1779[_loc5_] = _loc6_;
            }
         }
      ...
      public function getParameterValue(param1:String) : String
      {
         ...
         var _loc2_:String = this.var_1779[param1];
         if(_loc2_ == null)
         {
            _loc2_ = this.var_2462;
         }
         return _loc2_;
      }
