package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1873:int = 60000;
      ...
      private var var_2760:ByteArray;
      
      private var var_2762:ImageData;
      
      private var var_925:PaletteMap;
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = this.var_266.getKeys();
            for each(_loc3_ in _loc2_)
            {
               _loc1_ = this.var_266.getValue(_loc3_) as AvatarImageBodyPartCache;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      public function disposeInactiveActions(param1:int = 60000) : void
      {
         ...
         var _loc4_:Array = this.var_266.getKeys();
         for each(_loc5_ in _loc4_)
         {
            _loc3_ = this.var_266.getValue(_loc5_) as AvatarImageBodyPartCache;
            if(_loc3_ != null)
            {
      ...
      public function resetBodyPartCache(param1:IActiveActionData) : void
      {
         var _loc2_:* = null;
         var _loc4_:* = null;
         var _loc3_:Array = this.var_266.getKeys();
         for each(_loc4_ in _loc3_)
         {
            _loc2_ = this.var_266.getValue(_loc4_) as AvatarImageBodyPartCache;
            if(_loc2_ != null)
            {
      ...
      public function setGeometryType(param1:String) : void
      {
         ...
         if(this.var_811 == GeometryType.const_1206 && param1 == GeometryType.const_1083 || this.var_811 == GeometryType.const_1083 && param1 == GeometryType.const_1206)
         {
            this.var_811 = param1;
            this.var_86 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         if(this._bodyPartCache == null)
         {
            ...
            this.var_266.add(param1,this._bodyPartCache);
         }
            ...
            if(this.var_381.definition.isAnimation)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc14_ != null)
                  {
                     ...
                     if(_loc14_.type == AnimationLayerData.const_750)
                     {
                        if(_loc14_.action != null)
                        {
                     ...
                     else if(_loc14_.type == AnimationLayerData.const_558)
                     {
                        _loc3_ = _loc11_;
                     }
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1564.getFigure(),_loc5_,this.var_811,_loc3_,_loc6_,_loc7_);
         ...
         if(this.var_442 == null)
         {
            ...
            this.var_442 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_381);
            if(this.var_442 == null)
            {
               return null;
            }
      ...
      {
         var _loc2_:AvatarImageBodyPartCache = this.var_266.getValue(param1) as AvatarImageBodyPartCache;
         if(_loc2_ == null)
         {
            _loc2_ = new AvatarImageBodyPartCache();
            this.var_266.add(param1,_loc2_);
         }
         return _loc2_;
      }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_86)
         {
            this.var_86 = this._structure.getCanvas(this._scale,this.var_811);
            if(!this.var_86)
            {
               return null;
            }
            this.var_2761 = new Point(0,this.var_86.height - int(this.var_86.width / 4));
         }
         ...
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_737 || _loc10_ == AvatarAction.const_413;
         ...
         while(_loc8_ >= 0)
         {
            ...
            {
               this.var_1522 = this.var_118.bodyPartId;
               this.var_189 = this.var_118.partType;
               this.var_1979 = this.var_118.partId;
               this._frame = this.var_118.getFrameIndex(param3);
               _loc5_ = param1;
               _loc7_ = false;
               if(_loc6_)
               {
                  if(_loc9_ == "wav" && (this.var_189 == "lh" || this.var_189 == "ls" || this.var_189 == "lc" || this.var_189 == "lhs"))
                  {
                     _loc7_ = true;
                  }
                  else if(_loc9_ == "drk" && (this.var_189 == "rh" || this.var_189 == "rs" || this.var_189 == "rc" || this.var_189 == "rhs"))
                  {
                     _loc7_ = true;
                  }
                  else if(_loc9_ == "crr" && this.var_189 == "rhs")
                  {
                     _loc7_ = true;
                  }
                  else if(this.var_189 == "ri")
                  {
                     _loc7_ = true;
                  }
                  else if(this.var_189 == "cp")
                  {
                     _loc7_ = true;
                  }
                  else
                  {
                     ...
                     if(this.var_118.flippedPartType != this.var_189)
                     {
                        this.var_189 = this.var_118.flippedPartType;
                     }
                  }
               }
               this.var_1521 = this._scale + "_" + this.var_118.action.assetPartDefinition + "_" + this.var_189 + "_" + this.var_1979 + "_" + _loc5_ + "_" + this._frame;
               this.var_444 = this._assets.getAssetByName(this.var_1521) as BitmapDataAsset;
               if(this.var_444 == null)
               {
                  this.var_1521 = this._scale + "_std_" + this.var_189 + "_" + this.var_1979 + "_" + _loc5_ + "_0";
                  this.var_444 = this._assets.getAssetByName(this.var_1521) as BitmapDataAsset;
               }
               if(!(!this.var_444 || !this.var_444.content))
               {
                  if(this.var_118.paletteMapId > -1)
                  {
                     this.var_925 = this._structure.renderManager.paletteManager.getPalette(this.var_118.paletteMapId);
                     if(this.var_925 != null)
                     {
                        this.var_1005 = this.var_444.content as BitmapData;
                        this.var_188 = new BitmapData(this.var_1005.width,this.var_1005.height);
                        this.var_2760 = this.var_925.colorize(this.var_1005.getPixels(this.var_1005.rect));
                        this.var_188.setPixels(this.var_188.rect,this.var_2760);
                     }
                     else
                     {
                        this.var_188 = (this.var_444.content as BitmapData).clone();
                     }
                  }
                  else
                  {
                  ...
                  if(_loc11_ && (this.var_1522 == AvatarBodyPartType.const_267 || this.var_1522 == AvatarBodyPartType.const_1756 || this.var_1522 == AvatarBodyPartType.const_1772) && this.var_118.color != null)
                  {
                     _loc16_ = 0.7;
                     ...
                     this.var_188.colorTransform(this.var_188.rect,_loc18_);
                  }
                  else if(this.var_118.isColorable && this.var_118.color != null)
                  {
                     this.var_188.colorTransform(this.var_188.rect,this.var_118.color.colorTransform);
                  }
                  if(this.var_118.isBlendable)
                  {
                     this.var_188.colorTransform(this.var_188.rect,this.var_118.blendTransform);
                  }
                  this.var_1003 = this.var_444.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_53)
                     {
                  ...
                  this.var_2762 = new ImageData(this.var_188,this.var_1003,_loc7_);
                  this.var_1004.push(this.var_2762);
               }
            }
            _loc8_--;
         }
         if(this.var_1004.length == 0)
         {
            return null;
         }
         var _loc13_:ImageData = this.createUnionImage(this.var_1004,_loc6_);
         var _loc14_:Point = new Point(-1 * _loc13_.regpoint.x,this.var_2761.y - _loc13_.regpoint.y);
         if(_loc6_)
         {
            if(this._scale == AvatarScaleType.const_53)
            {
         ...
         _loc8_ = this.var_1004.length - 1;
         while(_loc8_ >= 0)
         {
            _loc15_ = this.var_1004.pop();
            if(_loc15_)
            {
               _loc15_.dispose();
            }
