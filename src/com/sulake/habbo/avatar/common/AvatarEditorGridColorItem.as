package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_909:IPartColor;
      ...
      public function AvatarEditorGridColorItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IPartColor)
      {
         ...
         this.var_970 = _loc5_.content as BitmapData;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_970.width,this.var_970.height,true,0);
            _loc5_ = this.var_970.clone();
            _loc5_.colorTransform(_loc5_.rect,this.var_909.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(this._isSelected)
            {
               _loc3_.bitmap = new BitmapData(this.var_910.width,this.var_910.height,true,16777215);
               _loc3_.bitmap.copyPixels(this.var_910,this.var_910.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
