   ...
   public class HeadView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_39)
         {
            ...
            var_39["null"] = new AvatarEditorGridView(var_67,FigureData.const_211,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_67,FigureData.const_255,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_67,FigureData.const_248,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_67,FigureData.const_239,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_67,FigureData.const_281,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_67 && var_149 == "")
         {
            var_67.switchCategory(FigureData.const_211);
         }
      }
