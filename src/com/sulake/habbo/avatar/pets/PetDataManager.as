package com.sulake.habbo.avatar.pets
{
   ...
   public class PetDataManager implements IPetDataManager, IDisposable
   {
      ...
      private var var_167:AvatarRenderManager;
      ...
      private function notifyListeners() : void
      {
         ...
         {
            _loc1_ = this.var_552.pop() as IPetDataListener;
            ...
            if(petData != null)
            {
               ...
               for each(breed in petData.breeds)
               {
                  ...
                  for each(targetSetName in targetSets)
                  {
                     ...
                     {
                        figurePart = figureTargetSet.name_7.part.(@id == petData.species).(hasOwnProperty("palettemapid") && @palettemapid == breed.patternId)[0];
                        if(figurePart == null)
                        {
                        }
      ...
      public function assetsReady(param1:int, param2:String, param3:IPetDataListener = null) : Boolean
      {
         ...
         {
            if(this.var_1554.indexOf(_loc6_) == -1)
            {
               _loc7_ = false;
               if(this.var_682.getValue(_loc6_) == null)
               {
                  ...
                  if(param3 != null && this.var_552.indexOf(param3) == -1)
                  {
                     this.var_552.push(param3);
                  }
               }
            }
         }
