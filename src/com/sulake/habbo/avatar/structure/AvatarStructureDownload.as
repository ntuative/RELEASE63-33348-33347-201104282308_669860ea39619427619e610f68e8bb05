package com.sulake.habbo.avatar.structure
{
   ...
   public class AvatarStructureDownload extends EventDispatcher
   {
      ...
      public static const const_1137:String = "AVATAR_STRUCTURE_DONE";
       
      
      private var var_2431:IStructureData;
      ...
      private function onDataComplete(param1:Event) : void
      {
         ...
         try
         {
            this.var_1764 = new XML(loaderStruct.assetLoader.content as String);
         }
         catch(e:Error)
         {
         ...
         this.var_2431.appendXML(this.var_1764);
         dispatchEvent(new Event(AvatarStructureDownload.const_1137));
      }
   }
}
