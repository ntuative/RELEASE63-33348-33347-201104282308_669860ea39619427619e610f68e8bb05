package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeSlot implements IOutfit, IAvatarImageListener
   {
      ...
      private function createView() : void
      {
         ...
         this.var_356 = this._view.findChildByName("image") as IBitmapWrapperWindow;
      }
      ...
      public function updateView() : void
      {
         ...
         if(this.var_623 && this.var_1448)
         {
            _loc5_ = this._controller.avatarRenderManager.createAvatarImage(this.figure,AvatarScaleType.const_92,this.var_947,this);
            if(_loc5_)
            {
               _loc5_.setDirection(AvatarSetType.const_34,parseInt(FigureData.const_875));
         ...
         if(this.var_356)
         {
            if(this.var_356.bitmap)
            {
               this.var_356.bitmap.dispose();
            }
            this.var_356.bitmap = new BitmapData(this.var_356.width,this.var_356.height,true,0);
            _loc7_ = (this.var_356.width - _loc1_.width) / 2;
            _loc8_ = (this.var_356.height - _loc1_.height) / 2;
            this.var_356.bitmap.draw(_loc1_,new Matrix(1,0,0,1,_loc7_,_loc8_));
         }
         if(_loc2_)
         {
            _loc1_.dispose();
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "set_button":
               ...
               this._controller.handler.saveWardrobeOutfit(this.var_1806,this);
               this.updateView();
               break;
            case "get_button":
               if(this.var_623)
