package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private static const const_651:uint = 1;
      ...
      private var var_1165:IRoomSession;
      ...
      private var var_182:CatalogViewer;
      ...
      private var var_224:PurchaseConfirmationDialog;
      
      private var var_299:ChargeConfirmationDialog;
      ...
      private var var_1164:ClubGiftController;
      
      private var var_498:ClubBuyController;
      
      private var var_755:Map;
      
      private var var_1166:Boolean = false;
      
      private var var_937:IPurchasableOffer;
      
      private var var_1427:IDragAndDropDoneReceiver;
      
      private var var_63:PlacedObjectPurchaseData;
      
      private const const_991:Point = new Point(100,20);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_16 != null)
         {
            ...
            this.var_16.events.removeEventListener(RoomSessionEvent.const_96,this.onRoomSessionEvent);
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         if(param1 is Offer)
         {
            if(this.var_224 == null)
            {
               this.var_224 = new PurchaseConfirmationDialog(this._localization);
            }
            _loc5_ = [];
            ...
            this.var_224.showOffer(this,param1,param2,param3,_loc5_);
            if(param4)
            {
         ...
         {
            this.var_498.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._communication.addHabboConnectionMessageEvent(new SellablePetBreedsMessageEvent(this.method_8));
      }
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_187,this.onObjectPlaced);
      }
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_192.getKey("client.credits.embed.enabled","false") == "RC4_R27";
         if(false && _loc1_)
         {
         ...
         {
            _loc2_ = this.var_192.getKey("link.format.credits","/credits");
      ...
      {
         return this.var_441.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_441.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_64)
         {
            _loc3_ = this.var_441.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Array = this.var_755.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_103.getActivityPointsForType(Purse.const_197)));
         var _loc1_:int = 0;
      ...
      {
         this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_131,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!this.var_859)
         {
            if(!this.var_441.loadProductData(this))
            {
               return;
            }
            this.init();
         ...
         {
            this._toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_56,HabboToolbarIconEnum.CATALOGUE,this._mainContainer));
         }
         if(this.mainWindowVisible())
         {
         ...
         this.setupInventoryForRecycler(this.var_90.active && this.mainWindowVisible());
      }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_182.getCurrentLayoutCode();
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_182 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_182.habboCatalog = this;
      }
      
      private function createMainWindow() : void
      {
         var _loc1_:XmlAsset = assets.getAssetByName("catalog") as XmlAsset;
         this._mainContainer = this._windowManager.buildFromXML(_loc1_.content as XML,const_651) as IWindowContainer;
         this._mainContainer.tags.push("habbo_catalog");
         this._mainContainer.position = this.const_991;
         this.hideMainWindow();
         ...
         _loc3_.setParamFlag(WindowParam.const_282,false);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_85:
               this.var_1771 = param1.session.isPrivateRoom;
               this.var_1165 = param1.session;
               if(this.var_90 != null)
               {
      ...
      private function method_9() : void
      {
         ...
         {
            this.var_1164 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_498 == null)
         {
            this.var_498 = new ClubBuyController(this);
         }
      }
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_182 != null)
         {
            this.var_182.catalogWindowClosed();
         }
         if(this.var_90 != null && this.getCurrentLayoutCode() == "recycler")
         {
            this.var_90.cancel();
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         if(this.var_756 && this.var_756 != "")
         {
            this.var_348.openPage(this.var_756);
            this.var_756 = "";
            this.var_936 = -1;
         }
         else if(this.var_936 > -1)
         {
            this.var_348.openPageById(this.var_936,this.var_1770);
            this.var_936 = -1;
            this.var_1770 = -1;
            this.var_756 = "";
         }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_182.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      private function onApproveNameResult(param1:ApproveNameMessageEvent) : void
      {
         ...
         this.var_182.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result,_loc2_.nameValidationInfo));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2433 && this._soundManager != null)
         {
         ...
         events.dispatchEvent(new PurseEvent(PurseEvent.const_71,this.var_103.credits));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_116,_loc2_.amount));
         }
      }
      ...
      private function onActivityPoints(param1:IMessageEvent) : void
      {
         ...
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_116,_loc2_.points["null"]));
         }
      }
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1164.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         this.var_182.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function onIsOfferGiftable(param1:IsOfferGiftableMessageEvent) : void
      {
         ...
         if(this.var_224 != null)
         {
            this.var_224.onIsOfferGiftable(param1.getParser());
         }
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_299 == null)
         {
            this.var_299 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_299.showChargeInfo(_loc2_);
      }
      ...
      private function method_8(param1:SellablePetBreedsMessageEvent) : void
      {
         var _loc2_:SellablePetBreedsParser = param1.getParser();
         this.var_755.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_755.add(_loc2_.productCode,_loc3_.slice());
            this.var_182.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.productCode,_loc3_.slice()));
         }
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         {
            if(false && "RC4_R27" == this.var_192.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = this.var_192.getKey("link.format.credits");
               if(_loc3_ != "")
               {
                  this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         if(param2.type == WindowEvent.const_178)
         {
            _loc3_ = this.var_192.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
               HabboWebTools.navigateToURL(_loc3_,"habboMain");
      ...
      {
         if(!this.var_192.keyExists("catalog.drag_and_drop") || this.var_192.getKey("catalog.drag_and_drop") != "RC4_R27")
         {
            return false;
         }
         if(!this.var_1165 || !this.var_1165.isRoomOwner)
         {
            return false;
         }
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(this.var_1166 && param1.type == RoomEngineObjectEvent.const_187)
         {
            ...
            _loc3_ = this.var_937.productContainer.firstProduct;
            _loc4_ = false;
            ...
            this.var_63 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_937);
            _loc5_ = this.var_1427;
            if(_loc5_ != null)
            {
      ...
      public function resetPlacedOfferData(param1:Boolean = false) : void
      {
         ...
         if(this.var_63 != null)
         {
            if(this.var_63.category == RoomObjectCategoryEnum.const_26)
            {
               this._roomEngine.disposeObjectFurniture(this.var_63.roomId,this.var_63.roomCategory,this.var_63.objectId);
            }
            else if(this.var_63.category == RoomObjectCategoryEnum.const_25)
            {
      ...
      private function retrievePreviewAsset(param1:String, param2:Function) : void
      {
         ...
         var _loc3_:String = this.var_192.getKey("image.library.catalogue.url");
      ...
      private function showMainWindow() : void
      {
         ...
         {
            _loc1_ = this._windowManager.getDesktop(const_651);
            if(_loc1_ != null)
            {
