package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      public const const_1972:int = 1;
      
      public const const_2025:int = 2;
      
      public const const_2178:int = 3;
      ...
      private var var_224:MarketplaceConfirmationDialog;
      ...
      private var var_2710:MarketplaceItemStats;
      ...
      private function showConfirmation(param1:int, param2:MarketPlaceOfferData) : void
      {
         if(!this.var_224)
         {
            this.var_224 = new MarketplaceConfirmationDialog(this,this._catalog,this._roomEngine);
         }
         this.var_224.showConfirmation(param1,param2);
      }
      ...
      {
         this.requestOffers(this.var_2709,this.var_2712,this.var_2375,this.var_2715);
      }
      ...
      public function buyOffer(param1:int) : void
      {
         ...
         this.showConfirmation(this.const_1972,_loc2_);
      }
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         this.var_2713 = _loc3_.creditsWaiting;
         for each(_loc4_ in _loc3_.offers)
         {
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         else if(parser.result == 3)
         {
            ...
            this.showConfirmation(this.const_2025,updateItem);
            if(this._visualization != null)
            {
               this._visualization.listUpdatedNotify();
            }
      ...
      {
         if(param1.furniCategoryId != this.var_2714 || param1.furniTypeId != this.var_2711)
         {
            return;
         }
      ...
      private function isPosterItem(param1:IMarketPlaceOfferData) : Boolean
      {
         ...
         if(param1.furniType == 2 && param1.stuffData != null)
         {
            ...
            {
               _loc4_ = _loc3_.name;
               if(_loc4_ != null && _loc4_ == const_1442)
               {
                  _loc2_ = true;
               }
            }
