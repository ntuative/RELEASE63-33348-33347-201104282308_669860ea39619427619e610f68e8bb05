package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1380:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1431:XML;
      
      private static var var_1433:XML;
       
      
      private var var_1780:Number = 4.294967295E9;
      ...
      public function CatalogNodeRenderable(param1:ICatalogNavigator, param2:NodeData, param3:int)
      {
         ...
         if(var_1433 == null)
         {
            ...
            var_1433 = _loc4_.content as XML;
         }
      }
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_1780 == 4294967295)
            {
               this.var_1780 = _loc1_.color;
            }
            _loc1_.color = const_1380;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1597;
            }
         }
      }
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1569;
            }
         }
      }
      ...
      {
         this._list = navigator.catalog.windowManager.buildFromXML(var_1433) as IItemListWindow;
         if(this._list == null)
         {
