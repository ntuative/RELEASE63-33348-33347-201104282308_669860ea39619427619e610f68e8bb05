package com.sulake.habbo.catalog.purchase
{
   ...
   public class PlacedObjectPurchaseData implements IDisposable
   {
      ...
      private var var_652:IFurnitureData;
      ...
      private function setOfferData(param1:IPurchasableOffer) : void
      {
         ...
         this.var_1748 = param1.productContainer.firstProduct.productClassId;
         this.var_1952 = param1.productContainer.firstProduct.productData;
         this.var_652 = param1.productContainer.firstProduct.furnitureData;
         this.var_1510 = param1.productContainer.firstProduct.extraParam;
      }
      
      public function toString() : String
      {
         return [this._roomCategory,this._roomId,this.var_195,this._category,this.var_1749,this._x,this.var_157,this._direction,this._offerId,this.var_1748].toString();
      }
