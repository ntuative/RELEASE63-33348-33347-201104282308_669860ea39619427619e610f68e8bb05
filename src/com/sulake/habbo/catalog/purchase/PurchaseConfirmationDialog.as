package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_2156:int = 10;
      ...
      private const const_1868:uint = 4.293848814E9;
      
      private const const_1869:uint = 4.294967295E9;
      
      private const const_1353:uint = 4.291613146E9;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1914 = _loc1_.stuffTypes;
            this.var_803 = _loc1_.boxTypes;
            this.var_804 = _loc1_.ribbonTypes;
            this.var_1232 = this.var_1914[0];
            this.var_376 = this.var_803[0];
            this.var_378 = this.var_804[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_378 < 0)
         {
            this.var_378 = this.var_804.length - 1;
         }
         if(this.var_378 > this.var_804.length - 1)
         {
            this.var_378 = 0;
         }
         if(this.var_376 < 0)
         {
            this.var_376 = this.var_803.length - 1;
         }
         if(this.var_376 > this.var_803.length - 1)
         {
            this.var_376 = 0;
         }
         var _loc1_:int = this.var_803[this.var_376] * 1000 + this.var_804[this.var_378];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_89.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1232,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1509 = _loc3_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1914;
      ...
      private function giveGift() : void
      {
         ...
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_803[this.var_376]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_804[this.var_378]);
         this._catalog.purchaseProductAsGift(this.var_1508,this.var_89,this.var_1510,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this.var_1508,this.var_89.offerId,this.var_1510);
               this.dispose();
               break;
            case "cancel_button":
         ...
         switch(param1.type)
         {
            case WindowEvent.const_107:
               ...
               for each(_loc7_ in this.var_223)
               {
                  ...
                  if(_loc5_.length >= this.const_2156)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2702 = _loc3_.text;
               break;
            case WindowMouseEvent.const_41:
               ...
               break;
            case WindowKeyboardEvent.const_312:
               _loc6_ = param1 as WindowKeyboardEvent;
               switch(_loc6_.keyCode)
               {
                  case Keyboard.UP:
                     this.highlightSuggestion(this.var_377 - 1);
                     break;
                  case Keyboard.DOWN:
                     this.highlightSuggestion(this.var_377 + 1);
                     break;
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(this.var_377) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_649 == null)
         {
            this.var_649 = this.createWindow("suggestion_list_item") as IWindowContainer;
            this.var_649.procedure = this.suggestionsEventHandler;
         }
         if(this.var_261 == null || this.var_649 == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_649.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(this.var_377) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.getColor(this.var_377);
         }
         this.var_377 = param1;
         if(this.var_377 < 0)
         {
            this.var_377 = _loc2_.numListItems - 1;
         }
         if(this.var_377 >= _loc2_.numListItems)
         {
            this.var_377 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(this.var_377) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1353;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1868) : uint(this.const_1869);
      }
