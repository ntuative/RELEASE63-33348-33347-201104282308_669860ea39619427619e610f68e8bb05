package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      {
         return this.var_679 != const_1054;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_2022 != RecyclerStatusMessageEvent.const_1310;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_679 == const_462;
      }
      ...
      {
         this.var_679 = const_1053;
         this.var_122 = new Array(const_223);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_2022)
         {
            case RecyclerStatusMessageEvent.const_1716:
               this.var_679 = const_462;
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_1310:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1540:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1214:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1549:
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         {
            oldObjectData = this.var_122[0];
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_223)
            {
               oldObjectData = this.var_122[newSlotId];
         ...
         this.var_122[slotId] = new FurniSlotItem(itemId,category,typeId,xxxExtra);
         this.updateRecyclerSlots();
         this.updateRecyclerButton();
      }
      ...
      public function releaseSlot(param1:int) : void
      {
         ...
         if(!this._catalog.returnInventoryFurniFromRecycler(this.var_122[param1].id))
         {
            return;
         }
      ...
      public function executeRecycler() : void
      {
         ...
         var _loc2_:int = 0;
         while(_loc2_ < this.var_122.length)
         {
            _loc3_ = this.var_122[_loc2_];
            if(_loc3_ == null)
            {
               return;
            }
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_122.length < const_223)
         {
            return false;
         }
         var _loc1_:int = 0;
