package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1827:String = "ctlg_";
      ...
      private var var_483:EventDispatcher;
      
      private var _catalog:HabboCatalog;
      
      private var var_1096:ItemGridCatalogWidget;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_483 = new EventDispatcher();
      ...
      {
         return this._localization.getLinks(this.var_1095);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1095);
      }
      ...
      {
         var _loc2_:String = const_1827 + param1;
         ...
         this.var_1330 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_1330) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1726:
               if(this.var_1096 == null)
               {
                  this.var_1096 = new ItemGridCatalogWidget(param1);
                  this.var_35.push(this.var_1096);
               }
               break;
            ...
            case CatalogWidgetEnum.const_1552:
               ...
               break;
            case CatalogWidgetEnum.const_1790:
            ...
            case CatalogWidgetEnum.const_1797:
               ...
               break;
            case CatalogWidgetEnum.const_1553:
            ...
            case CatalogWidgetEnum.const_1628:
               ...
               break;
            case CatalogWidgetEnum.const_1647:
            ...
            case CatalogWidgetEnum.const_1547:
               ...
               break;
            case CatalogWidgetEnum.const_1754:
      ...
      private function initializeWidgets() : void
      {
         ...
         this.var_483.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         if(this.var_483 != null)
         {
            return this.var_483.dispatchEvent(param1);
         }
         return false;
      }
