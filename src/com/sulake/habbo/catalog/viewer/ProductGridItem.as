package com.sulake.habbo.catalog.viewer
{
   ...
   public class ProductGridItem implements IGridItem
   {
      ...
      private static const const_1015:String = "bg";
       
      
      protected var _view:IWindowContainer;
      
      private var var_256:IItemGrid;
      ...
      {
         this._view.getChildByName(const_1015).style = HabboWindowStyle.const_29;
      }
      
      public function deActivate() : void
      {
         this._view.getChildByName(const_1015).style = 3;
      }
      ...
      public function setDraggable(param1:Boolean) : void
      {
         ...
         {
            (this._view as IInteractiveWindow).setMouseCursorForState(WindowState.const_88,MouseCursorType.const_789);
            (this._view as IInteractiveWindow).setMouseCursorForState(0 | 0,MouseCursorType.const_789);
         }
      }
      ...
      private function eventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_41)
         {
            ...
            this.var_256.select(this);
            this.var_618 = param2;
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OUT && this.var_618 != null && this.var_618 == param2)
         {
            _loc3_ = this.var_256.startDragAndDrop(this);
            if(_loc3_)
            {
               this.var_618 = null;
            }
