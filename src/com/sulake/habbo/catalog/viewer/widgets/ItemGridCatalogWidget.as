package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IDragAndDropDoneReceiver
   {
      ...
      protected var var_570:IItemGridWindow;
      ...
      public function ItemGridCatalogWidget(param1:IWindowContainer)
      {
         ...
         if(this._scrollBar != null)
         {
            ...
            this._scrollBar.addEventListener(WindowEvent.const_745,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_245,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_742,this.deActivateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_216,this.deActivateScrollbar);
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_215.stop();
            this.var_215.removeEventListener(TimerEvent.TIMER,this.populateItemGrid);
            this.var_215 = null;
         }
         if(this.var_570 != null)
         {
            this.var_570.destroyGridItems();
            this.var_570 = null;
         }
         this.var_1712 = null;
         this.var_359 = null;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_570 = _window.findChildByName("itemGrid") as IItemGridWindow;
      ...
      protected function loadItemGridGraphics(param1:TimerEvent = null) : void
      {
         ...
         while(_loc2_ < 3)
         {
            if(this.var_786 >= 0 && this.var_786 < page.offers.length)
            {
               _loc3_ = page.offers[this.var_786];
               this.loadGraphics(_loc3_);
               _loc3_.productContainer.grid = this;
            }
            ++this.var_786;
            if(this.var_786 >= page.offers.length)
            {
               this.resetTimer();
               break;
            }
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         this.var_570.addGridItem(_loc2_);
         ...
         {
            ++this.var_1884;
            (param1.productContainer as BundleProductContainer).setBundleCounter(this.var_1884);
         }
      }
