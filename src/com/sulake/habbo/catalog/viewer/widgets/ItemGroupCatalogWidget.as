package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      {
         var _loc2_:Offer = this.var_204[this.var_525][this.var_798];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         this.var_525 = var_570.getGridItemIndex(param1.view);
         var _loc2_:String = this._groupNames[this.var_525];
         var _loc3_:Array = this.var_204[this.var_525] as Array;
      ...
      override protected function populateItemGrid() : void
      {
         ...
         {
            if(this.var_798 < _loc1_.length)
            {
               _loc2_ = _loc1_[this.var_798] as Offer;
         ...
         for each(_loc1_ in page.offers)
         {
            if(_loc1_.pricingModel == Offer.const_401 || _loc1_.pricingModel == Offer.const_397)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc3_.productType == ProductTypeEnum.const_64 || _loc3_.productType == ProductTypeEnum.const_78)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        ...
                        (this.var_204[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
