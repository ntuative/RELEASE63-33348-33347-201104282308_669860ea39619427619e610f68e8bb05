package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private const const_2165:int = 40;
      
      private const const_2166:int = 10;
      
      private var var_848:Array;
      
      private var var_1575:MarketPlaceOfferData;
      
      private var _itemList:IItemListWindow;
      
      private var var_691:IWindowContainer;
      
      private var var_560:Timer;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_560)
         {
            this.var_560.removeEventListener(TimerEvent.TIMER,this.onPopulationTimer);
            this.var_560 = null;
         }
      }
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         switch(param1)
         {
            ...
            case "search_by_activity":
               _loc5_ = "marketplace_search_simple";
               this.var_848 = [3,4,5,6];
               break;
            case "search_advanced":
               _loc5_ = "marketplace_search_advanced";
               this.var_848 = [1,2,3,4,5,6];
               break;
            default:
               return;
         }
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(this.getSortKeys(this.var_848));
            _loc7_.selection = 0;
         }
      }
      ...
      private function updateList() : void
      {
         ...
         if(!this.var_691)
         {
            ...
            this.var_691 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!this.var_691)
         {
            return;
         ...
         this.updateStatusDisplay(this.const_1888,_loc2_.length);
         if(!this.var_560)
         {
            this.var_560 = new Timer(25);
            this.var_560.addEventListener(TimerEvent.TIMER,this.onPopulationTimer);
         }
         this.var_1288 = 0;
         this.populateList();
         this.var_560.start();
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(this.var_1288 >= this._offers.length)
            {
               return true;
            }
            this.addListItem(this._offers.getWithIndex(this.var_1288));
            ++this.var_1288;
            _loc1_++;
         }
         return false;
      ...
      private function doSearch() : void
      {
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < this.var_848.length)
         {
            _loc4_ = this.var_848[_loc6_.selection];
         }
         ...
         else if(param1.type == WindowEvent.const_107)
         {
            ...
            switch(_loc7_.name)
            {
               ...
               case "max_price_input":
                  _loc8_ = this.const_2166;
                  break;
               case "search_input":
                  _loc8_ = this.const_2165;
                  break;
               default:
                  return;
            }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  this.marketPlace.buyOffer(this.var_1575.offerId);
            }
            return;
         }
         if(param1.type == WindowEvent.const_58)
