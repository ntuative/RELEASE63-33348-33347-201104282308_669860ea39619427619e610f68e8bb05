package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_532:IItemGridWindow;
      
      private var var_1515:IScrollbarWindow;
      
      protected var var_1712:XML;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_996 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1243 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_85 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1964 = new Point(this.var_85.x,this.var_85.y);
         this.var_532 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         ...
         this.var_1965 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(this.var_532 != null)
         {
            this.var_532.visible = false;
            this.var_532.destroyGridItems();
         }
         ...
         this.var_996.text = _loc4_;
         this.var_1243.text = _loc5_;
         this.var_996.height = this.var_996.textHeight + 5;
         this.var_1243.y = this.var_996.y + this.var_996.height;
         this.var_1243.height = Math.max(130,this.var_1243.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_551:
                  _loc6_ = this.var_1965.clone();
                  if(this.var_532 != null)
                  {
                     this.var_532.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_532,this.var_1515,this.var_1712);
                     ...
                     case ProductTypeEnum.const_225:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_327,AvatarAction.const_564);
                              _loc16_.appendAction(AvatarAction.const_308,_loc8_.productClassId);
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_85 != null && true)
         {
            ...
            this.var_85.x = this.var_1964.x;
            this.var_85.y = this.var_1964.y;
            if(param3 != null)
            {
