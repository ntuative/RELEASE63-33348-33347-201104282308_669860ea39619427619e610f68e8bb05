package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_952:IButtonWindow;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_952.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_952 = null;
         }
         if(this.var_951 != null)
         {
            this.var_951.removeEventListener(WindowKeyboardEvent.const_175,this.windowKeyEventProcessor);
            this.var_951 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_952 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_952 != null)
         {
            this.var_952.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_951 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_951 != null)
         {
            this.var_951.addEventListener(WindowKeyboardEvent.const_175,this.windowKeyEventProcessor);
         }
         return true;
      }
