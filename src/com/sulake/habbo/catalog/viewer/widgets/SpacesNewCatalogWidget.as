package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesNewCatalogWidget extends ItemGridCatalogWidget implements IDisposable, ICatalogWidget, IItemGrid
   {
      ...
      override public function dispose() : void
      {
         ...
         var _loc2_:* = null;
         super.dispose();
         for each(_loc1_ in this.var_204)
         {
      ...
      override public function init() : Boolean
      {
         ...
         this.switchCategory(this.var_100[this.var_525]);
      ...
      {
         var _loc2_:int = this.var_798[this.var_525];
         var _loc3_:Offer = this.var_204[this.var_525][_loc2_];
      ...
      {
         var _loc2_:* = null;
         if(param1 > -1 && param1 < var_570.numGridItems)
         {
            _loc2_ = this.var_204[this.var_525][param1];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         this.var_798[this.var_525] = (this.var_204[this.var_525] as Array).indexOf(_loc2_);
         this.updateRoomPreview();
      }
      
      private function updateRoomPreview() : void
      {
         var _loc1_:int = this.var_798[0];
         var _loc2_:int = this.var_798[1];
         var _loc3_:int = this.var_798[2];
         var _loc4_:Offer = this.var_204[0][_loc1_];
         var _loc5_:Offer = this.var_204[1][_loc2_];
         var _loc6_:Offer = this.var_204[2][_loc3_];
      ...
      private function createOfferGroups() : Boolean
      {
         ...
         {
            if(!(_loc1_.pricingModel == Offer.const_401 || _loc1_.pricingModel == Offer.const_397))
            {
               continue;
            }
            ...
            while(this.var_204.length < this._groupNames.length)
            {
               this.var_204.push(new Array());
            }
            switch(_loc4_)
            {
               case "floor":
                  (this.var_204[_loc5_] as Array).push(_loc1_);
                  break;
               case "wallpaper":
                  (this.var_204[_loc5_] as Array).push(_loc1_);
                  break;
      ...
      private function switchCategory(param1:String) : void
      {
         ...
         if(_loc2_ > -1)
         {
            ...
            if(var_570)
            {
               var_570.destroyGridItems();
            }
            page.replaceOffers(this.var_204[this.var_525],false);
            resetTimer();
            populateItemGrid();
            ...
            _loc3_ = this.var_798[this.var_525];
