package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_538:IKeyExchange;
      
      private var var_1006:String;
      
      private var _view:HabboLoginDemoView;
      
      private var var_2764:PseudoRandom;
      ...
      private var var_231:HabboHotelView;
      
      private var var_1526:String = "";
      
      private const const_1854:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_663 = param1;
            this.var_57.initConnection(HabboConnectionType.const_285);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_16.events.addEventListener(RoomSessionEvent.const_96,this.onRoomSessionEnded);
         this.checkRequirements();
      }
      ...
      {
         if(this.var_57 && this.var_142 && this.var_16 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         var _loc1_:Boolean = this.var_142.getBoolean("client.hotel_view.show_on_startup",true);
         this.var_231 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         var _loc2_:String = this.var_142.getKey("client.hotel_view.image");
         var _loc3_:String = this.var_142.getKey("image.library.url");
         if(_loc2_ != null && _loc3_ != null)
         {
            this.var_231.loadHotelViewImage(_loc3_ + _loc2_);
         }
         var _loc4_:* = this.var_142.getKey("use.sso.ticket") == "1";
         this.var_663 = this.var_142.getKey("sso.ticket",null);
         this.var_1982 = this.var_142.getKey("flash.client.url","");
         this.var_2763 = this.var_142.getKey("external.variables.txt","");
         if(this.var_231 == null)
         {
            this.var_231 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         }
         if(_loc4_)
         {
            this.var_57.mode = HabboConnectionType.const_93;
            if(this.var_663)
            {
               this.var_57.initConnection(HabboConnectionType.const_285);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc5_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_621,this.onInitConnection);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         {
            this.var_57.mode = HabboConnectionType.const_93;
            if(this.var_142.keyExists("local.environment"))
            {
               this.var_57.mode = HabboConnectionType.const_1219;
            }
         }
         this.var_57.initConnection(HabboConnectionType.const_285);
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2764 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_57.mode)
         {
            case HabboConnectionType.const_93:
               _loc6_ = "";
               _loc6_ = this.var_142.getKey("url.prefix",_loc6_);
               _loc6_ = _loc6_.replace("http://","");
               _loc6_ = _loc6_.replace("https://","");
               _loc7_ = this.var_142.getKey("hotelview.banner.url","http:/\nsitename$/gamedata/banner");
               _loc7_ = _loc7_.replace("$sitename$",_loc6_);
               this.var_1526 = _loc4_;
               this.var_231.loadBannerImage(_loc7_ + "?token=" + this.var_1526,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1219:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1545:
               this.var_1006 = this.generateRandomHexString(30);
               this.var_538 = new DiffieHellman(new BigInteger(this.var_142.getKey("connection.development.prime"),16),new BigInteger(this.var_142.getKey("connection.development.generator"),16));
               this.var_538.init(this.var_1006);
               _loc8_ = this.var_538.getPublicKey(10);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_538.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_538.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2764);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1982,this.var_2763));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1854,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_663 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_663);
            _loc2_.send(_loc4_);
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_236);
      }
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2765)
         {
            _loc2_ = this.var_142.getKey("logout.disconnect.url");
      ...
      private function onDisconnectReason(param1:DisconnectReasonEvent) : void
      {
         ...
         this.var_2765 = true;
         var _loc2_:String = this.var_142.getKey("logout.url");
         if(_loc2_.length > 0)
         {
      ...
      private function setOriginProperty(param1:String) : String
      {
         ...
         {
            return param1.replace("%origin%",this.var_142.getKey("flash.client.origin","popup"));
         }
         return param1;
      }
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         this.var_538 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_538.init(_loc14_);
            _loc15_ = this.var_538.getPublicKey(10);
