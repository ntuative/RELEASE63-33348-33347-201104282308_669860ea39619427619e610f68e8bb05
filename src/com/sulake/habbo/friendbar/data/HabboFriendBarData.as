package com.sulake.habbo.friendbar.data
{
   ...
   public class HabboFriendBarData extends Component implements IHabboFriendBarData
   {
      ...
      private static const const_1414:String = "visit_btn_click";
      
      private static const const_1416:String = "chat_btn_click";
      
      private static const const_1412:String = "find_friends_btn_click";
      
      private static const const_1031:String = "Toolbar";
      
      private static const const_1029:String = "open";
      
      private static const const_1030:String = "close";
      
      private static const const_1413:String = "FRIENDLIST";
      
      private static const const_1415:String = "MESSENGER";
       
      
      private var var_83:IHabboCommunicationManager;
      
      private var var_369:IHabboFriendList;
      
      private var var_438:IHabboMessenger;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            if(this.var_83)
            {
               this.var_83.release(new IIDHabboCommunicationManager());
               this.var_83 = null;
            }
            if(this.var_369)
            {
               this.var_369.release(new IIDHabboFriendList());
               this.var_369 = null;
            }
            if(this.var_438)
            {
               this.var_438.release(new IIDHabboMessenger());
               this.var_438 = null;
            }
            this.var_140 = null;
      ...
      public function followToRoom(param1:int) : void
      {
         if(this.var_83)
         {
            this.var_83.getHabboMainConnection(null).send(new FollowFriendMessageComposer(param1));
            this.var_83.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_659,const_658,const_1414));
         }
      }
      ...
      public function startConversation(param1:int) : void
      {
         if(this.var_438)
         {
            this.var_438.startConversation(param1);
            events.dispatchEvent(new NewMessageEvent(false));
            if(this.var_83)
            {
               this.var_83.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_659,const_658,const_1416));
            }
         }
      }
      ...
      public function findNewFriends() : void
      {
         if(this.var_83)
         {
            this.var_83.getHabboMainConnection(null).send(new FindNewFriendsMessageComposer());
            this.var_83.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_659,const_658,const_1412));
         }
      }
      ...
      public function toggleFriendList() : void
      {
         if(this.var_369)
         {
            if(!this.var_369.disposed)
            {
               if(!this.var_369.isOpen())
               {
                  if(this._friendRequests.length > 0)
                  {
                     this.var_369.openFriendRequests();
                  }
                  else
                  {
                     this.var_369.openFriendList();
                  }
               }
               else
               {
               ...
               if(this.var_83)
               {
                  this.var_83.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_1031,const_1413,!!this.var_369.isOpen() ? const_1029 : const_1030));
               }
            }
         }
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_438)
         {
            if(!this.var_438.disposed)
            {
               this.var_438.toggleMessenger();
               if(this.var_83)
               {
                  this.var_83.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_1031,const_1415,!!this.var_438.isOpen() ? const_1029 : const_1030));
               }
            }
         }
      }
      ...
      {
         this.var_83 = param2 as IHabboCommunicationManager;
         this.var_83.addHabboConnectionMessageEvent(new MessengerInitEvent(this.onMessengerInitialized));
         this.var_83.addHabboConnectionMessageEvent(new FriendListUpdateEvent(this.method_7));
         this.var_83.addHabboConnectionMessageEvent(new FindFriendsProcessResultEvent(this.onFindFriendProcessResult));
         this.var_83.addHabboConnectionMessageEvent(new NewBuddyRequestEvent(this.onNewFriendRequest));
         this.var_83.addHabboConnectionMessageEvent(new BuddyRequestsEvent(this.onFriendRequestList));
         this.var_83.addHabboConnectionMessageEvent(new NewConsoleMessageEvent(this.onNewConsoleMessage));
         this.var_83.addHabboConnectionMessageEvent(new RoomInviteEvent(this.onRoomInvite));
      }
      
      private function onMessengerComponentAvailable(param1:IID, param2:IUnknown) : void
      {
         this.var_438 = param2 as IHabboMessenger;
      }
      
      private function onFriendListComponentAvailable(param1:IID, param2:IUnknown) : void
      {
         this.var_369 = param2 as IHabboFriendList;
      }
      ...
      private function method_7(param1:IMessageEvent) : void
      {
         ...
         for each(_loc8_ in _loc5_)
         {
            ...
            if(_loc3_)
            {
               ...
               this.var_140.splice(this.var_140.indexOf(_loc3_),1);
            }
         }
         ...
         {
            this.var_140 = !!const_297 ? this.sortByNameAndOnlineStatus(this.var_140) : this.sortByName(this.var_140);
         }
