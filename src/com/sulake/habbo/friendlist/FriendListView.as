package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1876:String = "noconvinfo";
      
      private static const const_1875:String = "messageinput";
      ...
      private var var_1532:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList, param2:IHabboConfigurationManager)
      {
         ...
         this.var_1532 = new FriendListTabsView(this._friendList);
         if(param2.getKey("client.toolbar.static.enabled","false") == "RC4_R27")
         {
            this.var_898 = true;
         }
      }
      ...
      public function openFriendList() : void
      {
         if(this.var_15 == null)
         {
            ...
            this._friendList.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_56,HabboToolbarIconEnum.FRIENDLIST,this.var_15));
         }
         else
         {
      ...
      private function prepare() : void
      {
         ...
         this.var_912 = IWindowContainer(this.var_15.content.findChildByName("main_content"));
         this.var_271 = IWindowContainer(this.var_15.content.findChildByName("footer"));
         this.var_1532.prepare(this.var_912);
         this.var_15.procedure = this.onWindow;
         this.var_15.content.setParamFlag(HabboWindowParam.const_1244,false);
         this.var_15.content.setParamFlag(HabboWindowParam.const_1259,true);
         this.var_15.header.setParamFlag(HabboWindowParam.const_815,false);
         this.var_15.header.setParamFlag(HabboWindowParam.const_889,true);
         this.var_15.content.setParamFlag(HabboWindowParam.const_815,false);
         this.var_15.content.setParamFlag(HabboWindowParam.const_889,true);
         this.var_15.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1531 = ITextWindow(this.var_15.findChildByName("info_text"));
         this.var_1531.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1988 == -1 ? 0 : int(this.var_15.height - this.var_1988);
         var _loc4_:int = this.var_1990 == -1 ? 0 : int(this.var_15.width - this.var_1990);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_271.y = Util.getLowestPoint(this.var_15.content);
         this.var_271.width = this._friendList.tabs.windowWidth;
         ...
         this.var_15.scaler.setParamFlag(HabboWindowParam.const_1143,this._friendList.tabs.findSelectedTab() != null);
         this.var_15.scaler.setParamFlag(HabboWindowParam.const_815,false);
         this.var_15.scaler.setParamFlag(HabboWindowParam.const_1244,false);
         ...
         this.var_1988 = this.var_15.height;
         this.var_1990 = this.var_15.width;
