package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1855:String = "no_reqs_info";
      ...
      private var var_1786:IContainerButtonWindow;
      
      private var var_1787:IContainerButtonWindow;
      ...
      {
         this.var_1786 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1787 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1787.procedure = this.onDismissAllButtonClick;
         this.var_1786.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_443;
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_385;
         ...
         if(this._friendList && this._friendList.events)
         {
            this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_342,param1));
         }
      }
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_443 && _loc4_.state != FriendRequest.const_385)
            {
               _loc4_.state = FriendRequest.const_385;
               this.refreshRequestEntry(_loc4_);
               if(this._friendList && this._friendList.events)
               {
                  this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_342,_loc4_.requestId));
               }
            }
         }
         this.refresh();
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         for each(_loc4_ in this._friendList.friendRequests.requests)
         {
            if(_loc4_.state != FriendRequest.const_443 && _loc4_.state != FriendRequest.const_385)
            {
               ...
               _loc4_.state = FriendRequest.const_443;
               this.refreshRequestEntry(_loc4_);
               if(this._friendList && this._friendList.events)
               {
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1786,_loc1_);
         this.setEnabled(this.var_1787,_loc1_);
      }
