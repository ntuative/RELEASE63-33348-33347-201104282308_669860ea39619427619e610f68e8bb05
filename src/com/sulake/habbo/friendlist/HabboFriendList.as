package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_2323:FriendListLookAndFeel;
      
      private var var_423:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1717:OpenedToWebPopup;
      ...
      private var var_1718:AvatarSearchResults;
      ...
      {
         this.var_2323 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_100 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1718 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_603.stop();
            this.var_603.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_603 = null;
         }
         ...
         if(this.var_1109)
         {
            this.var_1109.release(new IIDAvatarRenderManager());
            this.var_1109 = null;
         }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1717 = new OpenedToWebPopup(this);
         }
         this.var_1717.show(x,y);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_337);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_324,HabboWindowStyle.const_44,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1109.createAvatarImage(param1,AvatarScaleType.const_92,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         var _loc1_:String = this.var_192.getKey("client.minimail.embed.enabled");
         return _loc1_ == "RC4_R27";
      }
      
      private function getVariable(param1:String, param2:Dictionary) : String
      {
         return this.var_192.getKey(param1,param1,param2);
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         this._view = new FriendListView(this,this.var_192);
         ...
         this.var_100.addCategory(new FriendCategory(FriendCategory.const_1132,this.getText("friendlist.friends")));
         this.var_100.addCategory(new FriendCategory(FriendCategory.const_393,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_100.addFriend(new Friend(_loc4_));
         }
         this.var_423 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_603)
         {
            this.var_603 = new Timer(120000);
            this.var_603.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_603.start();
         }
         this.getBuddyRequests();
         this.registerListeners();
         this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_131,HabboToolbarIconEnum.FRIENDLIST));
         ...
         {
            _loc5_ = this.var_100.findCategory(FriendCategory.const_393);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            this._view.openFriendList();
            _loc1_ = this.var_423.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_445));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function registerListeners() : void
      {
         ...
         this._communication.addHabboConnectionMessageEvent(new FriendListUpdateEvent(this.method_7));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_423.findTab(FriendListTab.const_99).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_423.findTab(FriendListTab.const_99);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1718.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_423.findTab(FriendListTab.const_99);
         if(!_loc2_)
         {
            return;
         }
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         else if(this.var_729.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_43))
         {
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ != null && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face != null)
               {
                  _loc4_ = _loc3_.view.getChildByName(const_186) as IBitmapWrapperWindow;
