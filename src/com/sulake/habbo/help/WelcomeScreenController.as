package com.sulake.habbo.help
{
   ...
   public class WelcomeScreenController implements IUpdateReceiver
   {
      ...
      private var var_206:Point;
      
      private var var_766:Timer;
      ...
      {
         return this._notifications[this.var_1450];
      }
      ...
      public function dispose() : void
      {
         if(this.var_136)
         {
            ...
            this.var_136.toolbar.events.removeEventListener(HabboToolbarEvent.const_732,this.onToolbarResized);
            this.var_136 = null;
         }
         ...
         {
            this.var_766.stop();
            this.var_766.removeEventListener(TimerEvent.TIMER,this.onReminderTimer);
            this.var_766 = null;
         }
      ...
      public function showWelcomeScreen(param1:Boolean) : void
      {
         ...
         this.var_136.toolbar.events.addEventListener(HabboToolbarEvent.const_732,this.onToolbarResized);
         var _loc4_:int = parseInt(this._config.getKey("welcome.screen.delay","5000"));
         this.var_766 = new Timer(_loc4_);
         this.var_766.addEventListener(TimerEvent.TIMER,this.onReminderTimer);
         this.var_766.start();
      }
      ...
      public function onReminderTimer(param1:TimerEvent) : void
      {
         ...
         this.var_206.y = this.var_136.toolbar.getIconLocation(this.current.targetIconId) - this._window.height / 2;
         this._window.y = this.var_206.y;
      ...
      {
         var _loc1_:XmlAsset = this.var_136.assets.getAssetByName("welcome_screen_xml") as XmlAsset;
         ...
         var _loc3_:BitmapDataAsset = this.var_136.assets.getAssetByName("welcome_screen_arrow") as BitmapDataAsset;
         ...
         _loc4_.content.setParamFlag(WindowParam.const_330,false);
         _loc4_.height -= 20;
      ...
      {
         var _loc2_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_105,this.current.targetIconId);
      ...
      private function closeWindow() : void
      {
         ...
         if(this.var_1450 < this._notifications.length - 1)
         {
            ++this.var_1450;
         }
         else
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:Number = Point.distance(this._window.rectangle.topLeft,this.var_206);
         if(_loc2_ > 5)
         {
            _loc3_ = Point.interpolate(this._window.rectangle.topLeft,this.var_206,0.5);
            this._window.x = _loc3_.x;
            this._window.y = _loc3_.y;
         }
         else
         {
            this._window.x = this.var_206.x;
            this._window.y = this.var_206.y;
            this.var_136.removeUpdateReceiver(this);
         }
      }
