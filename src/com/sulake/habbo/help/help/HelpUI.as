package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201104282302));
         this._toolbar = param5;
         this.var_117 = new Map();
         this.var_117.add(HabboHelpViewEnum.const_1571,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_117.add(HabboHelpViewEnum.const_218,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_117.add(HabboHelpViewEnum.const_614,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_117.add(HabboHelpViewEnum.const_320,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_117.add(HabboHelpViewEnum.const_274,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_117.add(HabboHelpViewEnum.const_434,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_117.add(HabboHelpViewEnum.const_686,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_117.add(HabboHelpViewEnum.const_296,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_117.add(HabboHelpViewEnum.const_1162,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_117.add(HabboHelpViewEnum.const_1157,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_117.add(HabboHelpViewEnum.const_906,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_515.length == 0 || param1 != this.var_367)
            {
               this.var_515.push(this.var_367);
            }
         }
         this.var_367 = param1;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            ...
            case CallForHelpResultEnum.const_1241:
               this.showUI(HabboHelpViewEnum.const_1162);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_117.getValue(HabboHelpViewEnum.const_218) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_22.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_562));
      }
      ...
      {
         return this.var_117.getValue(this.var_367);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2609 = this._window.width - _loc3_.width;
         this.var_2608 = this._window.height;
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2608;
         this._window.width = _loc1_.width + this.var_2609;
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_367 == HabboHelpViewEnum.const_218)
         {
            return;
         }
         if(this.var_638.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_638.push(_loc3_.content as BitmapData);
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_638[1],this.var_638[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_638[0],this.var_638[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_367 == HabboHelpViewEnum.const_218 || this.var_515.length == 0)
         {
            return;
         }
         if(this.var_368 == null)
