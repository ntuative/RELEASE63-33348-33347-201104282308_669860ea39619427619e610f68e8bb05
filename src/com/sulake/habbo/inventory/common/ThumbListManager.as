package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1546:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_678 = BitmapData(_loc7_.content);
         }
         ...
         this._thumbWidth = this.var_678.width;
         this.var_91 = this.var_678.height;
         this.var_1266 = param5;
         this.var_1026 = param6;
         this.var_236 = Math.floor(this.var_1266 / this._thumbWidth);
         this.var_26 = new BitmapData(this.var_1266,this.var_1026);
      }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         this.var_677 = this.resolveRowCountFromList();
         if(this.var_677 == 0)
         {
            this.var_26 = new BitmapData(this.var_1266,this.var_1026);
            return;
         }
         this.var_26 = new BitmapData(Math.max(this.var_236 * this._thumbWidth,this.var_1266),Math.max(this.var_677 * this.var_91,this.var_1026),true,16777215);
         this.var_26.fillRect(this.var_26.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = this.getList();
         var _loc3_:int = 0;
         while(_loc3_ < this.var_677)
         {
            _loc4_ = 0;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == this.var_236 && this.var_26.height < _loc3_.y * this.var_91)
         {
         ...
         _loc4_ = new Rectangle(0,0,this._thumbWidth * (this.var_236 - 1),this.var_91);
         _loc2_.copyPixels(this.var_26,_loc4_,new Point(this._thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(this._thumbWidth * (this.var_236 - 1),0,this._thumbWidth,this.var_26.height);
         _loc2_.copyPixels(this.var_26,_loc4_,new Point(0,this.var_91),null,null,true);
         _loc4_ = new Rectangle(0,this.var_91,this._thumbWidth * (this.var_236 - 1),this.var_26.height - this.var_91);
      ...
      private function getList() : Array
      {
         ...
         {
            _loc1_ = this.var_1546.getDrawableList();
         }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(this.var_26.height < this.var_1026)
         {
            _loc12_ = new BitmapData(this.var_26.width,this.var_1026);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(this.var_678.width,this.var_678.height);
         if(param2)
         {
            _loc3_.copyPixels(this._itemBgImageSelected,this.var_678.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(this.var_678,this.var_678.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
