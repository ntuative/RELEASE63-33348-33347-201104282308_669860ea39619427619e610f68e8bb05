package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_428:String = "pets";
      ...
      private var var_1944:Vector.<Array>;
      
      private var var_1945:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_651 = new Timer(const_1441,1);
         this.var_651.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc9_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc10_:XmlAsset = XmlAsset(_loc9_);
         this.var_2703 = XML(_loc10_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_187,this.onObjectPlaced);
               }
            ...
            {
               this.var_651.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_651.stop();
               this.var_651 = null;
            }
            if(this.var_205 != null)
            {
               this.var_205.removeEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
               this.var_205.stop();
               this.var_205 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_46)
            {
               ...
               {
                  this.var_1944 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1944;
            }
            else
            {
               if(this.var_1945 == null)
               {
                  this.var_1945 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1945;
            }
         ...
         this._controller.setInventoryCategoryInit(InventoryCategory.const_83);
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         if(this.var_993 == null)
         {
            this.var_993 = this._windowManager.buildFromXML(this.var_2703) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = this.var_993.clone() as IWindowContainer;
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            this.var_205 = new Timer(param1,1);
            this.var_205.addEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
            this.var_205.start();
         }
         else
         {
      ...
      {
         this._controller.checkCategoryInitilization(InventoryCategory.const_438);
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_652.add(const_46,new Array());
         this.var_652.add(const_48,new Array());
         if(this._view != null)
         {
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_316 || _loc3_.category == FurniCategory.const_334 || _loc3_.category == FurniCategory.const_345)
         {
            if(param1)
            {
               return false;
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc3_:Array = this.var_652.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            _loc4_ = 0;
            while(_loc4_ < _loc3_.length)
            {
               ...
               if(_loc5_.category == FurniCategory.const_814)
               {
                  _loc6_ = 1;
               }
               _loc7_ = 0;
