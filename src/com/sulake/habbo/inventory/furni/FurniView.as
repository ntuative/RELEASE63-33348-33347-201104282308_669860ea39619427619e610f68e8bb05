package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_2173:int = 0;
      
      private const const_1036:int = 1;
      
      private const const_1850:int = 2;
      
      private const const_1853:int = 3;
      
      private const const_1851:int = 42;
      
      private const const_1852:int = 120;
      ...
      private var var_726:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboSoundManager)
      {
         ...
         this._soundManager.events.addEventListener(SongInfoReceivedEvent.const_101,this.onSongInfoReceivedEvent);
         this.var_419 = new Map();
         this.var_419.add(FurniModel.const_46,new FurniGridView(this.var_67,FurniModel.const_46,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_419.add(FurniModel.const_48,new FurniGridView(this.var_67,FurniModel.const_48,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._soundManager)
            {
               ...
               {
                  this._soundManager.events.removeEventListener(SongInfoReceivedEvent.const_101,this.onSongInfoReceivedEvent);
               }
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_419.getValue(this.var_420);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_67.getCategoryContent(this.var_420);
         if(!this.var_67.isListInited())
         {
            _loc2_ = this.const_1036;
         }
         ...
         {
            _loc2_ = this.const_1853;
         }
         if(this.var_2393 == _loc2_)
         {
            return;
         }
         this.var_2393 = _loc2_;
      ...
      public function clearViews() : void
      {
         ...
         while(_loc4_ < _loc1_.length)
         {
            ...
            _loc3_ = this.var_419.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = this.var_419.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function addItemToBottom(param1:String, param2:GroupItem) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_419.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_67.getGroupItemInIndex(_loc3_,this.var_420);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            ...
            else if(_loc5_.category == FurniCategory.const_345)
            {
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_726 && this.var_726.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
         ...
         if(_loc5_ != null)
         {
            if(_loc5_.category == FurniCategory.const_1248)
            {
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1852)
         {
            _loc3_ = this.const_1852;
         }
         else if(_loc3_ < this.const_1851)
         {
            _loc3_ = this.const_1851;
         }
         else
         {
         ...
         else if(param1.type == WindowEvent.const_58)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModel.const_428);
            }
         }
      }
