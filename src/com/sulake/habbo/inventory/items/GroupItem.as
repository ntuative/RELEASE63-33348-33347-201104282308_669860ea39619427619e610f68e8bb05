package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_877:int = 0;
      
      protected var var_703:BitmapData;
      
      protected var var_2639:int;
      
      protected var var_1615:Boolean;
      
      protected var var_2133:Boolean;
      
      protected var var_2913:BitmapData;
      
      private const const_2148:int = 8947848;
      
      private const const_2147:int = 13421772;
      
      private const const_1864:Number = 1;
      
      private const const_1863:Number = 0.2;
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2912 == FurniModel.const_46)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1528));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2132);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_814)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1863;
               _loc1_.blend = this.const_1863;
            }
            else
            {
               this._window.blend = this.const_1864;
               _loc1_.blend = this.const_1864;
            }
         }
         if(this.isSelected)
         {
         ...
         if(_loc5_)
         {
            if(this.var_2133 && this.getRecyclableCount() > 0)
            {
