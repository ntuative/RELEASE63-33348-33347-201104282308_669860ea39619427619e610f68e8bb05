package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_41:
               this.var_1475.setSelectedGridItem(this);
               this.var_1476 = true;
               break;
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OUT:
               ...
               {
                  this.var_1476 = false;
                  this.var_1475.placePetToRoom(this._petData.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         this.var_1487.color = !!this._isSelected ? uint(this.const_2148) : uint(this.const_2147);
      }
