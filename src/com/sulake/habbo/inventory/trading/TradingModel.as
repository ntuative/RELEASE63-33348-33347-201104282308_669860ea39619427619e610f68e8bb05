package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1565:uint = 9;
      
      public static const const_193:uint = 0;
      
      public static const const_219:uint = 1;
      
      public static const const_421:uint = 2;
      
      public static const const_321:uint = 3;
      
      public static const const_538:uint = 4;
      
      public static const const_257:uint = 5;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_1159 = false;
         this.var_1808 = param6;
         this.var_789 = true;
         this.state = const_219;
         this.var_56.setup(param1,param3,param4,param6);
         this.var_56.updateItemList(this.var_747);
         this.var_56.updateItemList(this.var_1417);
      ...
      public function close() : void
      {
         if(this.var_789)
         {
            if(this._state != const_193 && this._state != const_257)
            {
      ...
      {
         this.var_56.setMinimized(param1 != InventoryCategory.const_83);
         this._inventory.updateSubView();
      }
      
      public function set state(param1:uint) : void
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_746 + " OTHER: " + this.var_1159);
         ...
         {
            case const_193:
               if(param1 == const_219 || param1 == const_257)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function getOwnItemIdsInTrade() : Array
      {
         ...
         {
            _loc2_ = this.var_246.getWithIndex(_loc4_) as GroupItem;
            if(_loc2_ != null)
            {
               _loc5_ = 0;
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_56.alertPopup(TradingView.const_1175);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_747)
            {
               this.var_746 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_747)
            {
               this.var_56.alertPopup(TradingView.const_1208);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_246.length < const_1565)
         {
