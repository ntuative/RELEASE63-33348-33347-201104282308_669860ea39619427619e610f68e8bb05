package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1075:uint = 4284532064;
      
      private static const const_1076:uint = 2577770;
      ...
      private var var_694:ItemPopupCtrl;
      ...
      private var var_2074:IWindowContainer;
      
      private var var_215:Timer;
      
      private var var_1063:GroupItem;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager, param6:IHabboSoundManager)
      {
         ...
         this.var_694 = new ItemPopupCtrl(_loc9_,this._assetLibrary);
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_2074 = this.createMinimizedWindow();
         }
         if(!this.var_2892)
         {
            return this.var_70;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_70)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_18.ownUserAccepts ? uint(const_1075) : uint(const_1076);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_18.otherUserAccepts ? uint(const_1075) : uint(const_1076);
            }
         ...
         if(this.var_70)
         {
            ...
            switch(this.var_18.state)
            {
               ...
               case TradingModel.const_421:
                  ...
                  break;
               case TradingModel.const_321:
                  _loc1_.enable();
                  _loc1_.caption = "${inventory.trading.confirm}";
                  this.showInfoMessage("${inventory.trading.info.confirm}");
                  break;
               case TradingModel.const_538:
                  _loc1_.disable();
      ...
      public function removeSelection() : void
      {
         if(this.var_1063)
         {
            this.var_1063.isSelected = false;
            this.var_1063 = null;
         }
      }
      ...
      private function thumbEventProc(param1:WindowEvent, param2:IWindow, param3:Boolean) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc5_.category == FurniCategory.const_1598)
            {
            ...
            this.var_694.updateContent(param2 as IWindowContainer,_loc7_,_loc6_,ItemPopupCtrl.const_593);
            this.var_694.show();
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OUT)
         {
            this.var_694.hideDelayed();
         }
      }
         ...
         if(this.var_193.length > 0)
         {
            ...
            if(_loc5_.extra == param1.id)
            {
               if(_loc2_ && this.var_18.ownUserItems.getWithIndex(_loc4_) == _loc3_ || !_loc2_ && this.var_18.otherUserItems.getWithIndex(_loc4_) == _loc3_)
               {
                  ...
                  this.var_694.updateContent(_loc8_ as IWindowContainer,_loc6_,_loc7_,ItemPopupCtrl.const_593);
               }
            }
            else
            {
