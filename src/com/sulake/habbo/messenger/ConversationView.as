package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1004:int = 100;
      
      private static const const_1357:int = 20;
       
      
      private var var_131:HabboMessenger;
      
      private var var_2336:IScrollbarWindow;
      
      private var var_1724:IContainerButtonWindow;
      
      private var _list:IItemListWindow;
      
      private var var_495:Conversation;
      
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_131 = param1;
         this.var_1724 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this._list = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2336 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_1004 + const_1357)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1358;
         param1.invalidate();
      }
      ...
      public function refresh() : void
      {
         ...
         if(this.var_495 == null || _loc1_.id != this.var_495.id)
         {
            this.var_495 = _loc1_;
            this.refreshList();
            this.afterResize();
      ...
      {
         if(this.var_495.followingAllowed)
         {
            this.var_1724.enable();
         }
         else
         {
            this.var_1724.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this._list.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_495.messages.length - const_1004);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < this.var_495.messages.length)
         {
            this.refreshEntry(true,_loc1_,this.var_495.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_713 || param3.type == Message.const_910 ? param3.time + ": " : "";
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc3_["recipientid"] = "" + this.var_495.id;
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_131.send(new FollowFriendMessageComposer(this.var_495.id));
      }
