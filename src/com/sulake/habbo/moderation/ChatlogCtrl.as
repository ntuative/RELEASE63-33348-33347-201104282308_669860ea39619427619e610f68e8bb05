package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1048:Array = [];
      
      private static var var_2064:int = 1000;
      
      private static var var_1049:Array = [];
      
      private static var var_2063:int = 200;
      ...
      {
         this.var_851 = IWindowContainer(this.var_34.getXmlWindow("chatlog_roomheader"));
         this.var_850 = IWindowContainer(this.var_34.getXmlWindow("chatlog_chatline"));
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1048.pop() as IWindowContainer;
         }
      ...
      private function getChatHeaderWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1049.pop() as IWindowContainer;
         }
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_2062[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1581.getValue(param2.chatterName))
            {
               this.var_1581.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1581.getValue(_loc2_);
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1582)
         {
            this.storeChatLineWindow(_loc1_);
         }
         for each(_loc1_ in this.var_1580)
         {
