package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2150:String = "open_issues";
      ...
      private var var_1858:IIssueBrowserView;
      
      private var var_1857:IIssueBrowserView;
      
      private var var_1859:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_364.view.width = this.var_253.container.width;
         this.var_364.view.height = this.var_253.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2151:
               ...
               {
                  this.var_1858 = new MyIssuesView(this.issueManager,this,this.var_253.container);
               }
               return this.var_1858;
            case this.const_2150:
               if(this.var_1857 == null)
               {
                  this.var_1857 = new OpenIssuesView(this.issueManager,this,this.var_253.container);
               }
               return this.var_1857;
            case this.const_2152:
               if(this.var_1859 == null)
               {
                  this.var_1859 = new PickedIssuesView(this.issueManager,this,this.var_253.container);
               }
