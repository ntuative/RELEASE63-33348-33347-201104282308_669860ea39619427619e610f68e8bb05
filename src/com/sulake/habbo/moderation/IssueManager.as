package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_1308:String = "issue_bundle_open";
      
      public static const const_764:String = "issue_bundle_my";
      
      public static const const_1144:String = "issue_bundle_picked";
      
      public static const const_1804:int = 15000;
       
      
      private var var_64:ModerationManager;
      
      private var var_597:IssueBrowser;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         this.var_597 = new IssueBrowser(this,this.var_64.windowManager,this.var_64.assets);
         this.var_1118 = [];
         this.var_1117 = [];
         this.var_906 = new Map();
         this.var_2243 = parseInt(this.var_64.configuration.getKey("chf.score.updatefactor","60"));
         this.var_1686 = new Timer(const_1804,0);
         this.var_1686.addEventListener(TimerEvent.TIMER,this.updatePriorities);
         this.var_1686.start();
      }
      ...
      public function pickBundle(param1:int, param2:Boolean = false, param3:int = 0) : void
      {
         ...
         this.var_1118 = this.var_1118.concat(_loc4_.getIssueIds());
      }
      ...
      public function releaseAll() : void
      {
         ...
         {
            if(_loc3_.state == IssueMessageData.const_375 && _loc3_.pickerUserId == _loc1_)
            {
      ...
      private function sendRelease(param1:Array) : void
      {
         ...
         this.var_1117 = this.var_1117.concat(param1);
      }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(this.var_597 == null || !this.var_597.isOpen())
         {
            this.var_64.soundManager.playSound(HabboSoundTypesEnum.const_1127);
         }
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         if(param1.state == IssueMessageData.const_1818)
         {
            this._issues.remove(param1.issueId);
            return;
         }
         ...
         if(param1.state == IssueMessageData.const_181)
         {
            ...
            _loc9_ = this.var_1117.indexOf(param1.issueId);
            if(_loc9_ == -1 && _loc7_)
            {
      ...
      public function updatePriorities(param1:Event = null) : void
      {
         ...
         for each(_loc4_ in this._issues)
         {
            if(_loc4_ != null)
            {
               ...
               _loc4_.temporalPriority = int(_loc3_ / this.var_2243);
            }
         }
      ...
      {
         var _loc2_:IssueHandler = this.var_906.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      {
         var _loc2_:* = this.var_906.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
         ...
         for each(_loc4_ in this.var_102)
         {
            switch(param1)
            {
               case const_1308:
                  ...
                  break;
               case const_764:
                  if(_loc4_.state == IssueMessageData.const_375 && _loc4_.pickerUserId == _loc3_)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         this.var_906.add(param1,_loc3_);
      ...
      public function unhandleBundle(param1:int) : void
      {
         ...
         var _loc3_:IssueHandler = this.var_906.remove(param1);
         if(_loc3_ != null)
         {
            _loc3_.dispose();
         }
      ...
      public function autoHandle(param1:int) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_375 && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.prioritySum > _loc3_.prioritySum))
            {
               _loc3_ = _loc5_;
            }
         }
      ...
      public function issuePickFailed(param1:Array) : Boolean
      {
         ...
         for each(_loc4_ in param1)
         {
            ...
            {
               _loc12_ = _loc8_.id;
               _loc13_ = this.var_906.getValue(_loc12_) as IssueHandler;
               if(_loc13_ != null)
               {
                  _loc13_.dispose();
               }
