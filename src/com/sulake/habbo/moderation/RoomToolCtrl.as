package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1216:IDropMenuWindow;
      
      private var var_481:ITextFieldWindow;
      
      private var var_598:Boolean = true;
      
      private var var_980:ICheckBoxWindow;
      
      private var var_1494:ICheckBoxWindow;
      
      private var var_1493:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_34.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_345));
      ...
      {
         var _loc2_:Boolean = this._data != null && this._data.method_1 == this.var_34.currentFlatId;
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.method_1 + ", " + this.var_345);
         if(param1.method_1 != this.var_345)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.method_1 + ", " + this.var_345);
            return;
         }
         this._data = param1;
         this.populate();
      ...
      public function populate() : void
      {
         ...
         this.var_1216 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_1216);
         this.var_1216.procedure = this.onSelectTemplate;
         this.var_980 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1494 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1493 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onEnterRoom(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.goToRoom(this._data.method_1);
      }
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.method_1),this.var_34,WindowTracker.const_919,this._data.method_1),this._frame,false,false,true);
      }
      ...
      private function onEditInHk(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.openHkPage("roomadmin.url","" + this._data.method_1);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = this.determineAction(param1,this.var_980.isSelected);
         this.var_34.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1542,_loc2_,this.var_481.text,"",""));
         if(this.var_1494.isSelected || this.var_1493.isSelected || this.var_980.isSelected)
         {
            this.var_34.connection.send(new ModerateRoomMessageComposer(this._data.method_1,this.var_1494.isSelected,this.var_1493.isSelected,this.var_980.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1808);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1812);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_34.initMsg.roomMessageTemplates[this.var_1216.selection];
         if(_loc3_ != null)
         {
            this.var_598 = false;
