package com.sulake.habbo.navigator
{
   ...
   public class AlertView implements IDisposable
   {
      ...
      private static var var_686:Dictionary = new Dictionary();
      ...
      {
         var _loc1_:AlertView = var_686[this.var_1084] as AlertView;
         if(_loc1_ != null)
         {
            _loc1_.dispose();
         }
