package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_302:MainViewCtrl;
      
      private var var_428:RoomInfoViewCtrl;
      
      private var var_1184:RoomCreateViewCtrl;
      
      private var _data:NavigatorData;
      
      private var var_423:Tabs;
      ...
      private var var_2522:RoomThumbnailRenderer;
      
      private var var_923:GuestRoomPasswordInput;
      
      private var var_314:GuestRoomDoorbell;
      
      private var var_1185:OfficialRoomEntryManager;
      
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2521 = new Array();
         ...
         this.var_302 = new MainViewCtrl(this);
         this.var_428 = new RoomInfoViewCtrl(this);
         this.var_1184 = new RoomCreateViewCtrl(this);
         this.var_2522 = new RoomThumbnailRenderer(this);
         this.var_923 = new GuestRoomPasswordInput(this);
         this.var_314 = new GuestRoomDoorbell(this);
         this.var_423 = new Tabs(this);
         this.var_1185 = new OfficialRoomEntryManager(this);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_324,HabboWindowStyle.const_44,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_428.registerToolbarEvents();
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_131,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_131,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         if(param1.type == HabboToolbarEvent.const_36)
         {
            ...
            {
               this.var_428.handleToolbarEvent(param1);
            }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            this._toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_56,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = this.var_192.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      {
         var _loc1_:Boolean = this.var_302.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_302.startSearch(Tabs.const_270,Tabs.const_439,param1);
         this.var_302.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_302.startSearch(Tabs.const_329,Tabs.const_238);
         this.var_423.getTab(Tabs.const_329).tabPageDecorator.tabSelected();
      }
