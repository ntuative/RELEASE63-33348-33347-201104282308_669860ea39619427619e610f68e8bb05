package com.sulake.habbo.navigator
{
   ...
   public class IncomingMessages
   {
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.securityLevel >= SecurityLevelEnum.const_1252)
         {
            this._navigator.data.eventMod = true;
         }
         if(_loc2_.securityLevel >= SecurityLevelEnum.const_1683)
         {
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         else
         {
            ...
            {
               this._navigator.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_131,HabboToolbarIconEnum.ROOMINFO));
            }
      ...
      private function onRoomInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.enterRoom)
         {
            ...
            _loc3_ = this.data.createdFlatId == _loc2_.data.method_1;
         ...
         else if(_loc2_.roomForward)
         {
            ...
            {
               this._navigator.goToRoom(_loc2_.data.method_1,false);
            }
         }
         else
         {
      ...
      {
         if(this._navigator.configuration.getKey("roomenterad.habblet.enabled") == "RC4_R27" && false)
         {
      ...
      private function setToolbarExitIcon() : void
      {
         ...
         var _loc3_:int = this.data.enteredGuestRoom == null ? 0 : int(this.data.enteredGuestRoom.method_1);
      ...
      private function onFlatCreated(param1:IMessageEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("IncomingEvent","Flat created: " + _loc2_.method_1 + ", " + _loc2_.flatName);
         this.data.createdFlatId = _loc2_.method_1;
         this._navigator.goToRoom(_loc2_.method_1,true);
         this._navigator.mainViewCtrl.reloadRoomList(Tabs.const_238);
      }
      ...
      private function onRoomInfoUpdated(param1:IMessageEvent) : void
      {
         ...
         Logger.log("ROOM UPDATED: " + _loc2_.method_1);
         this._navigator.send(new GetGuestRoomMessageComposer(_loc2_.method_1,false,false));
      }
      ...
      private function onFavouriteChanged(param1:IMessageEvent) : void
      {
         ...
         Logger.log("Received favourite changed: " + _loc2_.method_1 + ", " + _loc2_.added);
         this._navigator.data.favouriteChanged(_loc2_.method_1,_loc2_.added);
         this._navigator.roomInfoViewCtrl.reload();
         this._navigator.mainViewCtrl.refresh();
      }
      ...
      private function onFlatControllerAdded(param1:IMessageEvent) : void
      {
         ...
         Logger.log("Flat controller added: " + _loc2_.method_1 + ", " + _loc2_.data.userId + ", " + _loc2_.data.userName);
         for each(_loc3_ in this._navigator.roomSettingsCtrls)
         {
            _loc3_.onFlatControllerAdded(_loc2_.method_1,_loc2_.data);
         }
      }
      ...
      private function onFlatControllerRemoved(param1:IMessageEvent) : void
      {
         ...
         Logger.log("Flat controller removed: " + _loc2_.method_1 + ", " + _loc2_.userId);
         for each(_loc3_ in this._navigator.roomSettingsCtrls)
         {
            _loc3_.onFlatControllerRemoved(_loc2_.method_1,_loc2_.userId);
         }
      }
