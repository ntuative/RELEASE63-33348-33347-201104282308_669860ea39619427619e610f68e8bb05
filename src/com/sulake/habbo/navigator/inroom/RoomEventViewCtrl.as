package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private var var_751:TextFieldManager;
      ...
      private var var_2427:ITextWindow;
      
      private var var_1757:ITextWindow;
      
      private var var_1759:ITextWindow;
      
      private var var_1419:IButtonWindow;
      
      private var var_1421:IButtonWindow;
      
      private var var_2426:IButtonWindow;
      ...
      private function editEvent(param1:RoomEventData) : void
      {
         ...
         this.var_2427.text = this._navigator.getText("roomevent_type_" + param1.eventType);
         this._eventNameInput.setText(param1.eventName);
         this.var_751.setText(param1.eventDescription);
         this.var_922.setText(this.getTagFromEvent(param1,1));
         this.var_921.setText(this.getTagFromEvent(param1,2));
         this.var_1419.visible = false;
         this.var_1421.visible = true;
         this.var_1420.visible = true;
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc5_:String = this.var_751.getText();
         var _loc6_:Array = new Array();
         this.addTag(_loc6_,this.var_922.getText());
      ...
      private function isMandatoryFieldsFilled() : Boolean
      {
         ...
         if(!this.var_751.checkMandatory(this._navigator.getText("navigator.eventsettings.descerr")))
         {
            return false;
         }
         return true;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(this._window == null)
         {
            ...
            this.var_1758 = IWindowContainer(this.find("event_type_disabled_cont"));
            this.var_2427 = ITextWindow(this.find("event_type_disabled_text"));
            this.var_1757 = ITextWindow(this.find("create_caption"));
            this.var_1759 = ITextWindow(this.find("edit_caption"));
            this.var_1419 = IButtonWindow(this.find("create_button"));
            this.var_1421 = IButtonWindow(this.find("edit_button"));
            this.var_2426 = IButtonWindow(this.find("cancel_button"));
            this.var_1420 = IButtonWindow(this.find("end_button"));
            this.var_935 = IDropMenuWindow(this.find("event_type"));
            this.prepareEventTypes();
            Util.setProcDirectly(this.var_1419,this.onCreateButtonClick);
            Util.setProcDirectly(this.var_1421,this.onEditButtonClick);
            Util.setProcDirectly(this.var_1420,this.onEndButtonClick);
            Util.setProcDirectly(this.var_2426,this.onCancelButtonClick);
            this._eventNameInput = new TextFieldManager(this._navigator,this.getInput("event_name"),25);
            this.var_751 = new TextFieldManager(this._navigator,this.getInput("event_desc"),100);
            this.var_922 = new TextFieldManager(this._navigator,this.getInput("event_tag_1"),25);
