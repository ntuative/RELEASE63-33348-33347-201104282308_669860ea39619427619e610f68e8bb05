package com.sulake.habbo.navigator.mainview
{
   ...
   public class MainViewCtrl implements IUpdateReceiver, IDisposable
   {
      ...
      private static const const_1475:int = 4;
      ...
      private var var_1023:PopularTagsListCtrl;
      
      private var var_1022:GuestRoomListCtrl;
      
      private var var_1263:OfficialRoomListCtrl;
      ...
      private var var_1544:IWindow;
      
      private var var_1261:IRegionWindow;
      ...
      private const const_991:Point = new Point(100,10);
      
      public function MainViewCtrl(param1:HabboNavigator)
      {
         super();
         this._navigator = param1;
         this.var_1023 = new PopularTagsListCtrl(this._navigator);
         this.var_1022 = new GuestRoomListCtrl(this._navigator);
         this.var_1263 = new OfficialRoomListCtrl(this._navigator);
      ...
      public function open() : void
      {
         ...
         {
            this.prepare();
            this.var_15.position = this.const_991;
            _loc1_ = true;
         }
         this.refresh();
         ...
         if(_loc1_)
         {
            this._navigator.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_56,HabboToolbarIconEnum.NAVIGATOR,this.var_15));
         }
      }
      ...
      private function prepare() : void
      {
         ...
         this.var_183 = IWindowContainer(this.var_15.findChildByName("tab_content"));
         this.var_235 = IWindowContainer(this.var_15.findChildByName("custom_content"));
         this.var_211 = IWindowContainer(this.var_15.findChildByName("list_content"));
         this.var_271 = IWindowContainer(this.var_15.findChildByName("custom_footer"));
         this.var_1544 = this.var_15.findChildByName("loading_text");
         var _loc1_:IWindow = this.var_15.findChildByTag("close");
         _loc1_.procedure = this.onWindowClose;
         this.var_1261 = IRegionWindow(this.var_15.findChildByName("to_hotel_view"));
         if(!this.var_1261)
         {
            ErrorReportStorage.addDebugData("MainViewCtrl","prepare: _toHotelView is null!");
         }
         this.var_1261.procedure = this.onHotelView;
         ...
         this.var_15.scaler.setParamFlag(HabboWindowParam.const_762,false);
         this.var_15.scaler.setParamFlag(HabboWindowParam.const_1577,true);
      }
      ...
      public function refresh() : void
      {
         ...
         Util.moveChildrenToColumn(this.var_183,["custom_content","list_content"],this.var_235.y,8);
         this.var_211.height = this.var_211.height + _loc1_ - this.var_211.y - this.var_271.height + this.var_2808;
         Util.moveChildrenToColumn(this.var_183,["list_content","custom_footer"],this.var_211.y,0);
         this.var_2808 = this.var_271.height;
      ...
      {
         this.refreshList(param1,param2,this.var_1022,"guest_rooms");
      }
      
      private function refreshPopularTags(param1:Boolean, param2:Boolean) : void
      {
         this.refreshList(param1,param2,this.var_1023,"popular_tags");
      }
      
      private function refreshOfficialRooms(param1:Boolean, param2:Boolean) : void
      {
         this.refreshList(param1,param2,this.var_1263,"official_rooms");
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_676 == const_1052)
         {
            _loc3_ = Math.min(1,Math.max(0,this.var_211.blend - _loc2_));
            this.var_211.blend = _loc3_;
            this.var_235.blend = !!this.var_1262 ? Number(_loc3_) : Number(1);
            this.var_271.blend = !!this.var_1262 ? Number(_loc3_) : Number(1);
            if(_loc3_ == 0)
            {
               this.var_676 = const_670;
            }
         }
         else if(this.var_676 == const_670)
         {
            if(this.var_1543 % 10 == 1)
            {
               this.var_1544.visible = !this.var_1544.visible;
            }
            ++this.var_1543;
            if(!this._navigator.data.isLoading())
            {
               this.var_676 = const_1051;
            }
         }
         else if(this.var_676 == const_1051)
         {
            this.refresh();
            this.var_676 = const_1475;
         }
         else
         {
      ...
      {
         this.refreshScrollbar(this.var_1023);
      ...
      {
         this._navigator.refreshButton(this.var_1261,"icon_hotelview",!param1,null,0);
         this._navigator.refreshButton(this.var_1261,"icon_hotelview_reactive",param1,null,0);
      }
