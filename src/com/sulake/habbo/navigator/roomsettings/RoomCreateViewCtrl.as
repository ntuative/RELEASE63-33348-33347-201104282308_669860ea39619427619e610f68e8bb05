package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1175:TextFieldManager;
      
      private var var_45:Array;
      
      private var var_1174:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_620 = new Timer(100);
         this.var_620.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
      ...
      public function dispose() : void
      {
         if(this.var_620)
         {
            this.var_620.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_620.reset();
            this.var_620 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1174.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_1794 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1794 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_183 = IWindowContainer(this._navigator.getXmlWindow("roc_create_room"));
         ...
         var _loc3_:IWindow = this.var_183.findChildByTag("close");
         this.addMouseClickListener(_loc3_,this.onCancelButtonClick);
         this.var_1175 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_183.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
         var _loc4_:Rectangle = Util.getLocationRelativeTo(this.var_183.desktop,this.var_183.width,this.var_183.height);
         this.var_183.x = _loc4_.x;
         this.var_183.y = _loc4_.y;
      }
      
      public function refresh() : void
      {
         this.var_1175.goBackToInitialState();
         this.var_1175.input.textBackgroundColor = 4294967295;
         this.var_1174 = this.var_45[0];
         this.refreshRoomThumbnails();
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_69,HabboWindowStyle.const_29,HabboWindowParam.const_62,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         return Boolean(this.var_1175.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      
      private function getCreateButton() : IButtonWindow
      {
         return IButtonWindow(this.var_183.findChildByName("create_button"));
      }
      
      private function getCancelButton() : IButtonWindow
      {
         return IButtonWindow(this.var_183.findChildByName("back_button"));
      }
      ...
      {
         var _loc2_:String = this.var_1175.getText();
         var _loc3_:String = "model_" + this.var_1174.name;
