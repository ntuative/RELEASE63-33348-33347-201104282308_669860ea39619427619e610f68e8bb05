package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_417:IRoomSettingsCtrlOwner;
      ...
      private var var_1149:ICheckBoxWindow;
      
      private var var_1150:ICheckBoxWindow;
      
      private var var_1145:ICheckBoxWindow;
      
      private var var_612:ICheckBoxWindow;
      ...
      private var var_1736:IWindowContainer;
      ...
      public function onRoomSettings(param1:RoomSettingsData) : void
      {
         ...
         this._active = true;
         this.var_1735 = true;
         this.var_417.roomSettingsRefreshNeeded();
      }
      ...
      {
         if(param1 != this.var_345 || this.var_1146 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1146 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1678)
         {
            this.var_739.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1796)
         {
            this.var_739.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1660)
         {
            this.var_1151.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1623)
         {
            this.setTagError(this.var_922,param3,"${navigator.roomsettings.unacceptablewords}");
            this.setTagError(this.var_921,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1735)
         {
            this.setTagError(this.var_922,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            this.setTagError(this.var_921,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1562)
         {
            this.var_923.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_739.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_341,this.onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_565,this.onDoorModePasswordUnselect);
         ...
         this.var_739 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1151 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_922 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_921 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_923 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1153 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1149 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1150 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1145 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_612 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this._thumbnailContainer = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1147 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1148 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1736 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1405 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_244 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1152 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_1404 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1404.mouseThreshold = 0;
         this.var_1404.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSwitchView);
         this.var_1152.visible = false;
         if(!this._inRoom)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1736.visible = this._inRoom;
         if(this.var_738)
         {
         ...
         {
            this.populateForm();
            this.var_1147.visible = true;
            this.var_1405.visible = true;
            this._thumbnailContainer.visible = this._inRoom;
            this.var_1147.height = Util.getLowestPoint(this.var_1147) + 4;
         }
         this.var_1404.text = !!this.var_738 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this._thumbnailContainer.name,this.var_1147.name,this.var_1148.name,this.var_1405.name,this.var_1736.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_739.setText(_loc1_.name);
         this.var_1151.setText(_loc1_.description);
         this.var_923.setText("");
         ...
         this.setTag(this.var_922,_loc1_.tags[0]);
         this.setTag(this.var_921,_loc1_.tags[1]);
         if(this.var_1149)
         {
            if(_loc1_.allowPets)
            {
               this.var_1149.select();
            }
            else
            {
               this.var_1149.unselect();
            }
         }
         if(this.var_1150)
         {
            ...
            {
               this.var_1150.select();
            }
            else
            {
               this.var_1150.unselect();
            }
         }
         if(this.var_1145)
         {
            ...
            {
               this.var_1145.select();
            }
            else
            {
               this.var_1145.unselect();
            }
         }
         if(this.var_612)
         {
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = this.var_739.getText();
         _loc2_.description = this.var_1151.getText();
         ...
         {
            _loc8_ = this.var_923.getText();
            _loc9_ = this.var_1153.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_923.clearErrors();
               this.var_1153.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = this.var_1149.isSelected;
         _loc2_.allowFoodConsume = this.var_1150.isSelected;
         _loc2_.allowWalkThrough = this.var_1145.isSelected;
         _loc2_.hideWalls = this.var_612.isSelected;
         _loc2_.tags = new Array();
         this.addTag(this.var_922,_loc2_.tags);
         this.addTag(this.var_921,_loc2_.tags);
         this.clearErrors();
      ...
      {
         var _loc10_:* = null;
         var _loc1_:IWindowContainer = IWindowContainer(this.var_244.findChildByName("flat_controller_list"));
         var _loc2_:IButtonWindow = IButtonWindow(this.var_244.findChildByName("remove_flat_ctrl"));
         var _loc3_:IButtonWindow = IButtonWindow(this.var_244.findChildByName("remove_all_flat_ctrls"));
         var _loc4_:IWindow = this.var_244.findChildByName("flat_ctrls_caption_txt");
         var _loc5_:IWindow = this.var_244.findChildByName("flat_ctrls_info_txt");
         var _loc6_:IWindow = this.var_244.findChildByName("flat_ctrls_limit_txt");
         var _loc7_:IWindowContainer = IWindowContainer(this.var_244.findChildByName("flat_controllers_footer"));
         Util.hideChildren(this.var_244);
         this.var_244.findChildByName("ruler").visible = true;
         ...
         if(this.var_76.controllers.length > 0)
         {
            ...
            Util.moveChildrenToColumn(this.var_244,["flat_ctrls_caption_txt","flat_ctrls_limit_txt","flat_controller_list","flat_ctrls_info_txt","flat_controllers_footer"],_loc4_.y,5);
         }
         else
         {
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_69,HabboWindowStyle.const_29,HabboWindowParam.const_62,new Rectangle(0,0,100,20)));
      }
