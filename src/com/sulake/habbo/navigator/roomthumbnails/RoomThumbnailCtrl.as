package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_1644 = IButtonWindow(this.find("bg_tab"));
         this.var_1642 = IButtonWindow(this.find("top_tab"));
         this.var_1643 = IButtonWindow(this.find("obj_tab"));
         this.var_2169 = IWindowContainer(this.find("tile_grid"));
         this.var_2170 = IWindowContainer(this.find("now_editing_container"));
         Util.setProcDirectly(this.find("save"),this.onSaveButton);
         Util.setProcDirectly(this.find("cancel"),this.onCancelButton);
         Util.setProcDirectly(this.var_1644,this.onBgTabButton);
         Util.setProcDirectly(this.var_1642,this.onTopTabButton);
         Util.setProcDirectly(this.var_1643,this.onObjTabButton);
      }
      ...
      private function onSaveButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc5_ = new UpdateRoomThumbnailMessageComposer(this._navigator.data.enteredGuestRoom.method_1,this.var_67.data.bgImgId,this.var_67.data.frontImgId,_loc3_.length);
      ...
      {
         this.setEnabled(this.var_1644,this.var_67.mode != ThumbnailEditorModel.const_37);
         this.setEnabled(this.var_1642,this.var_67.mode != ThumbnailEditorModel.const_60);
         this.setEnabled(this.var_1643,this.var_67.mode != ThumbnailEditorModel.const_35);
      }
      
      private function method_6() : void
      {
         var _loc1_:IWindowContainer = this.var_2170;
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = this.var_2169;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_496)
            {
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(this._navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_69,HabboWindowStyle.const_29,HabboWindowParam.const_62,new Rectangle(0,0,param1.width,66)));
               param1.addListItem(_loc7_);
            }
            _loc10_ = _loc6_[_loc8_];
            _loc11_ = IRegionWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",WindowType.const_497,HabboWindowStyle.const_44,0 | 0,new Rectangle(_loc9_ * 66,0,66,66),this.onImgSel,_loc10_.id));
            _loc11_.mouseThreshold = 0;
            _loc12_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",HabboWindowType.const_324,HabboWindowStyle.const_44,HabboWindowParam.const_62,new Rectangle(0,0,66,66),this.onImgSel,_loc10_.id));
