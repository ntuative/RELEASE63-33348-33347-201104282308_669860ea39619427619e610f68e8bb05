package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      private static const const_556:int = 1;
      
      private static const const_1027:int = 2;
      
      private static const const_1026:int = 3;
      
      private static const const_456:Number = 50;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:IHabboToolbar, param6:HabboNotificationItem)
      {
         ...
         if(_loc8_ != null)
         {
            this.var_1816 = this._window.height - _loc8_.rectangle.bottom;
         }
         else
         {
            this.var_1816 = 15;
         }
         this.var_1815 = this._window.height;
         this.var_767 = 4;
         this.var_768 = 0;
         this._state = name_3;
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_556:
               ...
               _loc2_ = Number(this.var_1180) / Number(this.var_426["time_fade_in"]);
               if(this.var_1180 > int(this.var_426["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_1027:
               ...
               if(this.var_1458 > int(this.var_426["time_display"]) && !this.var_1814)
               {
                  this.startFadeOut();
               }
               break;
            case const_1026:
               ...
               _loc3_ = 1 - Number(this.var_1181) / Number(this.var_426["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1181 > int(this.var_426["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_1816;
         if(this._window.height < this.var_1815)
         {
            this._window.height = this.var_1815;
         }
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         var _loc3_:int = this._toolbar.orientation == "TOP" ? int(const_456) : 0;
         var _loc4_:int = this._toolbar.orientation == "BOTTOM" ? int(_loc2_.height - const_456) : int(_loc2_.height);
         var _loc5_:int = this._toolbar.orientation == "LEFT" ? int(const_456) : 0;
         var _loc6_:int = this._toolbar.orientation == "RIGHT" ? int(_loc2_.width - const_456) : int(_loc2_.width);
         if(this.var_426["position_horizontal_follow_toolbar"] == "RC4_R27" && (this._toolbar.orientation != "TOP" && this._toolbar.orientation != "BOTTOM"))
         {
            if(this._toolbar.orientation == "LEFT")
            {
               this._window.x = _loc5_ + const_600;
            }
            else
            {
               this._window.x = _loc6_ - this._window.width - const_600;
            }
         }
         else if(this.var_426["position_horizontal"] == "left")
         {
            this._window.x = _loc5_ + const_600;
         }
         else
         ...
         if(this.var_426["position_vertical_follow_toolbar"] == "RC4_R27" && (this._toolbar.orientation != "RIGHT" && this._toolbar.orientation != "LEFT"))
         {
            if(this._toolbar.orientation == "TOP")
            {
               this._window.y = _loc3_ + this.var_767;
            }
            else
            {
               this._window.y = _loc4_ - this._window.height - this.var_767;
            }
         }
         else if(this.var_426["position_vertical"] == "top")
         {
            this._window.y = _loc3_ + this.var_767;
         }
         else
      ...
      private function adjustBlend(param1:Number) : void
      {
         ...
         this._window.blend = this.var_768;
      }
   }
}
