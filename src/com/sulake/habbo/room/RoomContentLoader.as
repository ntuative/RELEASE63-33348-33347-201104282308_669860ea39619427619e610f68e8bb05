package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      public static const const_892:String = "RCL_LOADER_READY";
      
      private static const const_368:String = "RCL_PUBLICROOM_";
      
      private static const const_1874:int = 0;
      
      private static const const_1036:int = 1;
      
      private static const name_4:int = 2;
      
      private static const const_457:String = "place_holder";
      
      private static const const_664:String = "wall_place_holder";
      
      private static const const_666:String = "pet_place_holder";
      
      private static const PLACE_HOLDER_DEFAULT:String = const_457;
      
      private static const const_665:String = "room";
      
      private static const TILE_CURSOR:String = "tile_cursor";
      
      private static const const_1035:String = "selection_arrow";
      ...
      private var var_1009:Map = null;
      
      private var var_448:Dictionary;
      
      private var var_1008:Map = null;
      
      private var var_207:PublicRoomData = null;
      
      private var var_1529:Map = null;
      ...
      public function RoomContentLoader()
      {
         ...
         this.var_2773 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
      ...
      {
         if(this._state >= const_1036)
         {
            return;
         }
         this._stateEvents = param1;
         this.var_2771 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2770 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
         this.var_2772 = param2.getKey("public.room.dynamic.download.url","");
         this._publicRoomLoadNameTemplate = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         this._state = const_1036;
         this.initFurnitureData();
      }
      ...
      private function initFurnitureData() : void
      {
         ...
         var _loc1_:Array = this.var_441.getFurniData(this);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            for(_loc1_ in this.var_448)
            {
               delete this.var_448[_loc1_];
            }
            this.var_448 = null;
         }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            if(_loc6_.length > 0)
            {
               this.var_813.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
            ...
            _loc8_ = this.var_666.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               this.var_666.remove(_loc7_);
               this.var_666.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      private function continueInitilization() : void
      {
         if(this.var_2774)
         {
            ...
            {
               this._stateEvents.dispatchEvent(new Event(const_892));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(this.var_539 != null)
         {
            ...
            this.var_539.add(param1,param2);
         }
         if(this.var_541 != null)
         {
            this.var_541.remove(param2);
            this.var_541.add(param2,param1);
         }
      }
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         if(this.var_207 != null && (this.var_207.type == param1 || this.var_207.hasWorldType(param1)))
         {
         ...
         {
            return RoomObjectCategoryEnum.const_358;
         }
         return RoomObjectCategoryEnum.const_179;
      }
      ...
      {
         return [const_457,const_664,const_666,const_665,TILE_CURSOR,const_1035];
      }
      ...
      {
         return this.var_1009.getValue(param1) as String;
      }
      
      public function getPetColor(param1:int, param2:int) : PetColorResult
      {
         var _loc3_:Map = this.var_1008[param1];
         if(_loc3_ != null)
         {
      ...
      {
         if(this.var_813.getValue(param1) != null)
         {
            return this.var_813.getValue(param1);
         }
         return "";
      }
      ...
      {
         if(this.var_207 != null && this.var_207.hasWorldType(const_368 + param1))
         {
            return this.var_207.type;
         }
         return param1;
      }
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_277 || param1 == RoomObjectVisualizationEnum.const_72 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.const_26 || _loc2_ == RoomObjectCategoryEnum.const_25)
         {
            ...
            return int(this.var_666.getValue(param1));
         }
         return 0;
      }
         ...
         switch(_loc2_)
         {
            ...
            default:
               ...
               while(_loc9_ < _loc7_.length)
               {
                  ...
                  _loc8_.push(this.var_2772 + _loc10_);
                  _loc9_++;
               }
               return _loc8_;
         }
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(this.var_1529.getValue(param1) != null)
         {
            this.var_207 = this.var_1529.getValue(param1) as PublicRoomData;
         }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2773.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1667);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            ...
            else if(this.var_448[_loc5_] != null)
            {
         ...
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_525,_loc5_);
         }
      ...
      private function extractPetDataFromLoadedContent(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc6_ = this.var_448[param1];
            this.var_1008.add(_loc6_,_loc3_);
         }
      }
      ...
      private function extractPublicRoomDataFromLoadedContent(param1:String, param2:IAssetLibrary) : void
      {
         ...
         this.var_1529.add(param1,_loc4_);
         this.var_207 = _loc4_;
      ...
      public function extractObjectContent(param1:String, param2:String) : Boolean
      {
         ...
         this.var_814.add(param2,param1);
         if(this.initializeGraphicAssetCollection(param2,_loc3_))
         {
            return true;
         }
         this.var_814.remove(param2);
         return false;
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         if(_loc3_ == null)
         {
            _loc4_ = this.var_814.getValue(_loc2_);
            if(_loc4_ != null)
            {
      ...
      {
         if(this.getObjectCategory(const_368 + param1) == RoomObjectCategoryEnum.const_77)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_207.getWorldHeightScale(const_368 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_207 != null)
         {
            return this.var_207.getWorldScale(const_368 + param1);
         }
         return 32;
      }
