package com.sulake.habbo.room
{
   ...
   public class RoomMessageHandler
   {
      ...
      private var var_1353:int = -1.0E9;
      
      private var var_711:Object;
      
      public function RoomMessageHandler(param1:IRoomCreator)
      {
         this.var_711 = new Object();
         super();
         this.var_12 = param1;
      ...
      public function set connection(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            param1.addMessageEvent(new OneWayDoorStatusMessageEvent(this.method_5));
      ...
      private function onFloorHeightMap(param1:IMessageEvent) : void
      {
         ...
         if(this.var_711.objectData)
         {
            this.addActiveObject(_loc4_,_loc5_,this.var_711.objectData);
            this.var_711.objectData = null;
         }
         else
         {
            this.var_711.floorReady = true;
         }
      }
      ...
      private function onObjectInject(param1:IMessageEvent) : void
      {
         ...
         var _loc5_:int = _loc3_.roomCategory;
         var _loc6_:ObjectMessageData = _loc3_.data;
         if(this.var_711.floorReady)
         {
            this.addActiveObject(_loc4_,_loc5_,_loc6_);
         }
         else
         {
            this.var_711.objectData = _loc6_;
         }
      }
            ...
            if(_loc2_.avatar != null)
            {
               ...
               switch(_loc9_.moveType)
               {
                  case SlideObjectMessageData.const_1151:
                     _loc10_ = "mv";
                     break;
                  case SlideObjectMessageData.const_1292:
                     _loc10_ = "std";
               }
