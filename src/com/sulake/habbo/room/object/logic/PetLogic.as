   ...
   public class PetLogic extends MovingObjectLogic
   {
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(!this.var_2607)
         {
            ...
            if(param1 is RoomObjectAvatarChatUpdateMessage)
            {
               ...
               this.var_1356 = getTimer() + _loc5_.numberOfWords * 1000;
               return;
            }
            ...
            if(param1 is RoomObjectAvatarSleepUpdateMessage)
            {
               ...
               _loc2_.setNumber(RoomObjectVariableEnum.const_404,Number(_loc7_.isSleeping));
               return;
            }
         }
         ...
         if(param1 is RoomObjectAvatarExperienceUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_749,Number(_loc9_.gainedExperience));
            return;
         }
         if(param1 is RoomObjectAvatarFigureUpdateMessage)
         {
            _loc10_ = param1 as RoomObjectAvatarFigureUpdateMessage;
            _loc11_ = _loc2_.getString(RoomObjectVariableEnum.const_199);
            _loc2_.setString(RoomObjectVariableEnum.const_199,_loc10_.figure);
            _loc2_.setString(RoomObjectVariableEnum.const_1800,_loc10_.race);
            _loc2_.setNumber(RoomObjectVariableEnum.const_773,this.getPaletteIndex(_loc10_.figure));
            return;
         }
      }
      ...
      private function debugMouseEvent(param1:RoomSpriteMouseEvent) : void
      {
         ...
         if(!param1.altKey && !param1.ctrlKey)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_200,_loc3_ + this.var_975);
         }
         else if(param1.altKey && !param1.ctrlKey)
         {
            ++this.var_1891;
            _loc2_.setNumber(RoomObjectVariableEnum.const_291,this.var_1891);
            _loc2_.setNumber(RoomObjectVariableEnum.const_166,NaN);
         }
         else if(param1.ctrlKey && !param1.altKey)
         {
            ++this.var_1892;
            _loc2_.setNumber(RoomObjectVariableEnum.const_166,this.var_1892);
         }
         else
         {
            this.var_975 += 45;
