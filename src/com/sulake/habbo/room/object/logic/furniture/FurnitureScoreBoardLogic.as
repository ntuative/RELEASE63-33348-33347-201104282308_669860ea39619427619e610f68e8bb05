package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureScoreBoardLogic extends FurnitureLogic
   {
      ...
      private static const const_1001:int = 3000;
      ...
      private function updateScore(param1:int) : void
      {
         ...
         {
            _loc3_ = this.var_727 - _loc2_;
            if(_loc3_ < 0)
            {
               _loc3_ = -_loc3_;
            }
            if(_loc3_ * const_461 > const_1001)
            {
               this.var_1130 = const_1001 / _loc3_;
            }
            else
            {
               this.var_1130 = const_461;
            }
      ...
      override public function update(param1:int) : void
      {
         ...
         if(object != null)
         {
            ...
            if(_loc2_ != this.var_727 && param1 >= this.var_1394 + this.var_1130)
            {
               _loc3_ = param1 - this.var_1394;
               _loc4_ = _loc3_ / this.var_1130;
               _loc5_ = 1;
               if(this.var_727 < _loc2_)
               {
                  _loc5_ = -1;
               }
               if(_loc4_ > _loc5_ * (this.var_727 - _loc2_))
               {
                  _loc4_ = _loc5_ * (this.var_727 - _loc2_);
               }
               object.setState(_loc2_ + _loc5_ * _loc4_,0);
               this.var_1394 = param1 - (_loc3_ - _loc4_ * this.var_1130);
            }
         }
      }
   }
