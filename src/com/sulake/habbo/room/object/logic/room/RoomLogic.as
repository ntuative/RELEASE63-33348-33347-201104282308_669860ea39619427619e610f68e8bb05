package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1869:int = 255;
      
      private var var_1482:uint = 16777215;
      
      private var var_1867:int = 255;
      
      private var var_1206:uint = 16777215;
      
      private var var_1866:int = 255;
      
      private var var_1205:int = 0;
      
      private var var_1868:int = 1500;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_509,RoomObjectMouseEvent.const_147];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1306,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_975,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_829,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_728,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_734,1);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1205)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1869;
            if(_loc2_ - this.var_1205 >= this.var_1868)
            {
               _loc3_ = this.var_1206;
               _loc4_ = this.var_1866;
               this.var_1205 = 0;
            }
            else
            {
               _loc7_ = this.var_1482 >> 16 & 255;
               _loc8_ = this.var_1482 >> 8 & 255;
               _loc9_ = this.var_1482 & 255;
               _loc10_ = this.var_1206 >> 16 & 255;
               _loc11_ = this.var_1206 >> 8 & 255;
               _loc12_ = this.var_1206 & 255;
               _loc13_ = (_loc2_ - this.var_1205) / this.var_1868;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1867 + (this.var_1866 - this.var_1867) * _loc13_;
               this._color = _loc3_;
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_975,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_952:
               param2.setString(RoomObjectVariableEnum.const_215,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_726:
               param2.setString(RoomObjectVariableEnum.const_209,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_871:
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_533:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_246)
               {
                  _loc5_ = "null";
               }
               ...
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_925:
         ...
         if(_loc4_)
         {
            ...
            param2.setString(RoomObjectVariableEnum.const_1289,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1239:
               param2.setNumber(RoomObjectVariableEnum.const_829,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1126:
               param2.setNumber(RoomObjectVariableEnum.const_728,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_734,_loc3_);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1123,int(param1.bgOnly));
         this.var_1482 = this._color;
         this.var_1867 = this.var_1869;
         this.var_1206 = _loc3_;
         this.var_1866 = _loc4_;
         this.var_1205 = getTimer();
         this.var_1868 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_501,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1632,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1526,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1615,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_501,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_173 || _loc12_ == RoomPlaneData.const_309)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
