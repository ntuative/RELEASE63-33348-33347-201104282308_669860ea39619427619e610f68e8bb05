package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1801:String = "cone";
      
      public static const const_1791:String = "plane";
      
      public static const const_1717:String = "sphere";
      ...
      private var var_2691:Number;
      
      private var _direction:Vector3D;
      
      private var var_987:Number = 0.1;
      ...
      public function reset() : void
      {
         ...
         this.var_988 = 0;
         this.var_1064 = false;
         this.init(0,0,0,this._direction,this.var_2691,this.var_987,this.var_2686,true);
      }
      ...
      public function configureParticle(param1:int, param2:Boolean, param3:Array, param4:Boolean) : void
      {
         ...
         _loc5_["fade"] = param4;
         this.var_1227.push(_loc5_);
      }
      
      override protected function ignite() : void
      {
         this.var_1064 = true;
         if(this.var_988 < this.var_1501)
         {
            if(this.age > 1)
            {
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         while(_loc10_ < this.var_2687)
         {
            ...
            _loc4_.init(param1.x,param1.y,param1.z,_loc3_,this._energy,this.var_987,_loc6_,_loc7_,_loc9_,_loc8_);
            this.var_372.push(_loc4_);
            ++this.var_988;
            _loc10_++;
         }
      }
      ...
      {
         var _loc1_:int = Math.floor(Math.random() * this.var_1227.length);
         return this.var_1227[_loc1_];
      }
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_988 < this.var_1501)
         {
            if(this.age % this.var_2689 == 0)
            {
               this.releaseParticles(this,this.direction);
            }
         }
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_988 < this.var_1501)
         {
            ...
            this.y = (2 - this.var_257) * this.y - (1 - this.var_257) * this.lastY + this.var_1930 * this.var_987 * this.var_987;
         ...
         for each(_loc2_ in this.var_372)
         {
            ...
            _loc2_.y = (2 - this.var_257) * _loc2_.y - (1 - this.var_257) * _loc2_.lastY + this.var_1930 * this.var_987 * this.var_987;
         ...
         for each(_loc2_ in _loc1_)
         {
            ...
            this.var_372.splice(this.var_372.indexOf(_loc2_),1);
            _loc2_.dispose();
         }
      }
