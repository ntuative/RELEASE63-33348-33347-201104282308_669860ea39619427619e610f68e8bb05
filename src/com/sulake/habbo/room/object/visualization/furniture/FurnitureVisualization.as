package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1838:Number = Math.sqrt(0.5);
       
      
      private var _direction:int;
      
      private var var_2831:Number = NaN;
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(param4)
         {
            this.var_1555 |= this.updateAnimation(_loc6_);
         }
         else
         {
            _loc7_ = this.updateAnimation(_loc6_) | this.var_1555;
            this.var_1555 = 0;
         }
         if(_loc5_ || _loc7_ != 0)
         {
      ...
      protected function updateSprites(param1:int, param2:Boolean, param3:int) : void
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(this.var_642 != spriteCount)
         {
            createSprites(this.var_642);
         }
         if(param2)
         {
      ...
      private function updateSprite(param1:int, param2:int) : void
      {
         ...
         if(_loc4_ != null && _loc3_ != null)
         {
            ...
            if(_loc5_ != null && _loc5_.asset != null)
            {
               ...
               _loc4_.clickHandling = this.var_2739;
            }
            else
            {
      ...
      protected function getBlendMode(param1:int) : String
      {
         ...
         switch(param1)
         {
            case LayerData.const_416:
               break;
            case LayerData.const_1141:
               _loc2_ = "null";
               break;
            case LayerData.INK_DARKEN:
               _loc2_ = "null";
               break;
            case LayerData.const_1263:
               _loc2_ = "null";
         }
         return _loc2_;
      }
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_473 != _loc3_.getUpdateID() || param1 != var_87 || param2 != this.var_2831)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            this.var_2833 = _loc3_.getNumber(RoomObjectVariableEnum.const_288);
            ...
            this.var_1270 = this.getAdClickUrl(_loc3_);
            if(this.var_1270 == null || this.var_1270.indexOf("http") != 0)
            {
               this.var_1270 = null;
            }
            this.var_2739 = this.var_1270 != null;
      ...
      private function updateAssetAndSpriteCache(param1:Number, param2:int) : void
      {
         if(this.var_2830 != param2 || this.var_2829 != param1)
         {
            ...
            this.var_2832 = this.getSize(param1);
      ...
      {
         this.var_642 = param1;
         this.var_2029 = this.var_642 - this.getAdditionalSpriteCount();
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         var _loc3_:String = this.var_1031[param2];
         var _loc4_:Boolean = this.var_1030[param2];
         if(_loc3_ == null || _loc3_.length == 0)
         {
            _loc5_ = this.var_2832;
            _loc3_ = this._type;
            _loc6_ = "";
            if(param2 != this.var_2029)
            {
      ...
      {
         if(this.var_832[param3] != null && !this.var_2030)
         {
      ...
      {
         if(this.var_829[param2] != null)
         {
            return this.var_829[param2];
         }
         if(this._data == null)
         {
