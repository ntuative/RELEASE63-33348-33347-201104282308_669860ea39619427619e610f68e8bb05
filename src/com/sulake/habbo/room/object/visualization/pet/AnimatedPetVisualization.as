package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1395:String = "head";
      
      private static const const_655:int = 1;
      
      private static const const_1025:int = 1000;
      
      private static const const_1397:String = "pet_experience_bubble_png";
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1397) as BitmapDataAsset;
            if(_loc3_ != null)
            {
               _loc2_ = (_loc3_.content as BitmapData).clone();
               this.var_358 = new ExperienceData(_loc2_);
            }
         }
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != this.var_2519)
            {
               this.var_2519 = _loc3_;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_291);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_166);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.const_291);
            if(!isNaN(_loc6_))
            {
            ...
            this.var_2041 = _loc3_.getNumber(RoomObjectVariableEnum.const_404) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_200);
            if(!isNaN(_loc8_))
            {
               this.var_1812 = _loc8_;
            }
            else
            {
               this.var_1812 = direction;
            }
            this.var_1457 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2215 = _loc3_.getNumber(RoomObjectVariableEnum.const_749);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_773);
            if(_loc9_ != this.var_1813)
            {
               this.var_1813 = _loc9_;
               this.var_2518 = this.var_1813.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_358 != null)
         {
            ...
            if(this.var_1457 > 0)
            {
               ...
               if(_loc2_ < const_1025)
               {
                  this.var_358.alpha = int(Math.sin(_loc2_ / const_1025 * 0) * 255);
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc3_.asset = this.var_358.image;
                     _loc3_.offsetX = -20;
                     _loc3_.offsetY = -80;
                     _loc3_.alpha = this.var_358.alpha;
                     _loc3_.visible = true;
                  }
                  else
                  {
      ...
      {
         return super.getAdditionalSpriteCount() + const_655;
      }
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2518);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_655)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_655))
            {
               if(param2 >= FurnitureVisualizationData.const_534.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_534[param2];
               if(_loc4_ == 1)
               {
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_1812);
         }
         return direction;
      }
      ...
      {
         if(this.var_953[param1] == null)
         {
            if(this._animationData.getTag(var_87,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1395)
            {
               this.var_953[param1] = true;
            }
            else
            {
               this.var_953[param1] = false;
            }
         }
         return this.var_953[param1];
      }
   }
}
