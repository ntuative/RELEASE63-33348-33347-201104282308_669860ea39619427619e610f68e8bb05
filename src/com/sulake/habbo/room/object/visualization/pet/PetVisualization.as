package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetVisualization extends RoomObjectSpriteVisualization implements IPetImageListener
   {
      ...
      private var var_684:PetVisualizationData = null;
      ...
      private const const_1402:int = 3;
      ...
      private var var_1841:Number = NaN;
      ...
      {
         this.var_684 = param1 as PetVisualizationData;
         createSprites(this.const_1402);
         var _loc2_:BitmapData = (this.var_684.getAvatarRendererAsset("pet_experience_bubble_png") as BitmapDataAsset).content as BitmapData;
         this.var_358 = new ExperienceData(_loc2_.clone());
         return true;
      }
      ...
      private function updateModel(param1:IRoomObjectModel, param2:Number) : Boolean
      {
         ...
         {
            this.var_2041 = param1.getNumber(RoomObjectVariableEnum.const_404) > 0;
            this.var_1465 = param1.getString(RoomObjectVariableEnum.const_166);
            this.var_274 = param1.getString(RoomObjectVariableEnum.const_291);
            this._postureParameter = param1.getString(RoomObjectVariableEnum.const_891);
            this.var_1841 = param1.getNumber(RoomObjectVariableEnum.const_200);
            this.var_1457 = param1.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2215 = param1.getNumber(RoomObjectVariableEnum.const_749);
      ...
      private function updateObject(param1:IRoomObject, param2:IRoomGeometry, param3:Boolean = false) : Boolean
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param3 || var_473 != param1.getUpdateID() || this.var_1844 != param2.updateId)
         {
            _loc4_ = param1.getDirection().x - param2.direction.x;
            _loc4_ = (_loc4_ % 360 + 360) % 360;
            _loc5_ = this.var_1841;
            if(isNaN(this.var_1841))
            {
               _loc5_ = _loc4_;
            }
            else
            ...
            if(_loc4_ != this.var_2042 || param3)
            {
               this.var_2042 = _loc4_;
               _loc4_ -= 112.5;
               _loc4_ = (_loc4_ + 360) % 360;
               this.var_60.setDirectionAngle(AvatarSetType.const_34,_loc4_);
            }
            if(_loc5_ != this.var_2039 || param3)
            {
      ...
      private function getAvatarImage(param1:Number) : IAvatarImage
      {
         ...
         if(_loc3_ == null)
         {
            _loc3_ = this.var_684.getAvatar(this.var_623,param1,this);
            if(_loc3_ != null)
            {
      ...
      private function updateShadow(param1:Number) : void
      {
         ...
         this.var_685 = null;
         _loc2_ = getSprite(this.const_1865);
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(param1 < 48)
         {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         var _loc12_:Boolean = this.var_969 || this.var_1190 > 0 || this.var_1840;
         this.var_358.alpha = 0;
         if(this.var_1457 > 0)
         {
            _loc13_ = param2 - this.var_1457;
            if(_loc13_ < AvatarAction.const_1025)
            {
               this.var_358.alpha = int(Math.sin(_loc13_ / 0 * 0) * 255);
               this.var_358.setExperience(this.var_2215);
               this.var_1190 = this.const_2149;
            }
            else
            {
               this.var_1457 = 0;
            }
            _loc14_ = getSprite(this.const_1880);
            if(_loc14_ != null)
            {
               if(this.var_358.alpha > 0)
               {
                  _loc14_.asset = this.var_358.image;
                  _loc14_.offsetX = -20;
                  _loc14_.offsetY = -80;
                  _loc14_.alpha = this.var_358.alpha;
         ...
         if(_loc11_ || _loc12_)
         {
            ...
            _loc14_ = getSprite(this.const_1057);
            if(_loc14_)
            {
               _loc19_ = this.var_60.getImage(AvatarSetType.const_34,false);
               if(_loc19_ != null)
               {
      ...
      private function updateActions(param1:IAvatarImage) : void
      {
         ...
         if(this.var_1465 != null && this.var_1465 != "")
         {
            param1.appendAction(AvatarAction.const_327,this.var_1465);
         }
         ...
         var _loc2_:int = param1.getSprites().length + this.const_1402;
