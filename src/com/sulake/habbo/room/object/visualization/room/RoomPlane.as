package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      public static const const_1810:int = 0;
      ...
      private var var_961:IPlaneRasterizer = null;
      ...
      {
         return this._isVisible && this.var_772;
      }
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         ...
         {
            return this.var_961.getTextureIdentifier(param1,this.normal);
         }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_772 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_362))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(this.needsNewTexture(param1,param2))
         {
            ...
            if(this.var_961 != null)
            {
               _loc3_ = this.var_961.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_1843,this.var_2549,this.var_2547,this.var_2544,this.var_2545,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_1844 != geometry.updateId)
         {
            geometryChanged = true;
         }
         if(!geometryChanged || !this.var_772)
         {
            if(!this.visible)
            {
               return false;
         ...
         if(geometryChanged)
         {
            ...
            i = 0;
            while(i < this.var_1416.length)
            {
               cosAngle = Vector3d.cosAngle(geometry.directionAxis,this.var_1416[i]);
               if(cosAngle > -0.001)
               {
                  if(this._isVisible)
                  {
            ...
            originPos = geometry.getScreenPosition(this.var_1191);
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_163.z - originZ,this.var_115.z - originZ,this.var_82.z - originZ,this.var_116.z - originZ);
            if(this._type == TYPE_LANDSCAPE)
            {
               relativeDepth += 0.02;
            }
            this.var_2548 = relativeDepth;
            this._isVisible = true;
            this.var_1844 = geometry.updateId;
         }
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_2546);
      ...
      private function renderTexture(param1:IRoomGeometry, param2:BitmapData) : void
      {
         ...
         if(this._type == const_132 || this._type == TYPE_LANDSCAPE)
         {
      ...
      private function draw(param1:BitmapData, param2:Matrix) : void
      {
         ...
         if(this._bitmapData != null)
         {
            if(param2.a == 1 && param2.d == 1 && param2.c == 0 && param2.b != 0 && Math.abs(param2.b) <= 1 && (this._type == const_132 || this._type == TYPE_LANDSCAPE))
            {
               _loc3_ = 0;
               _loc4_ = 0;
               _loc5_ = 0;
      ...
      public function addRectangleMask(param1:Number, param2:Number, param3:Number, param4:Number) : Boolean
      {
         ...
         if(this.var_960)
         {
            _loc5_ = null;
            _loc6_ = 0;
            while(_loc6_ < this.var_361.length)
            {
               _loc5_ = this.var_361[_loc6_] as RoomPlaneRectangleMask;
               if(_loc5_ != null)
               {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_251.length == this.var_962.length)
         {
            while(_loc1_ < this.var_251.length)
            {
               ...
               {
                  _loc6_ = false;
                  while(_loc2_ < this.var_962.length)
                  {
                     _loc7_ = this.var_962[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
         ...
         if(this.var_361.length > this.var_1466.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_960 || this.var_251.length == 0 && this.var_361.length == 0 && !this.var_362 || this.var_815 == null)
         {
            return;
         }
         ...
         if(this.var_362)
         {
            ...
            while(_loc5_ < this.var_251.length)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_68.width - this.var_68.width * _loc3_.leftSideLoc / this.var_304.length;
                  _loc11_ = this.var_68.height - this.var_68.height * _loc3_.rightSideLoc / this.var_303.length;
                  _loc12_ = _loc3_.type;
                  this.var_815.updateMask(this.var_68,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  this.var_962.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < this.var_361.length)
            {
               _loc4_ = this.var_361[_loc6_] as RoomPlaneRectangleMask;
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_68.width - this.var_68.width * _loc4_.leftSideLoc / this.var_304.length;
                  _loc11_ = this.var_68.height - this.var_68.height * _loc4_.rightSideLoc / this.var_303.length;
                  _loc13_ = this.var_68.width * _loc4_.leftSideLength / this.var_304.length;
                  _loc14_ = this.var_68.height * _loc4_.rightSideLength / this.var_303.length;
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         this.var_226.copyChannel(param1,param1.rect,const_656,BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         this.var_226.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(this.var_226,this.var_226.rect,const_656,BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
   }
}
