package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1546:int = 16777215;
      
      public static const const_1792:int = 13421772;
      
      private static const const_1011:int = 16777215;
      
      private static const const_1013:int = 13421772;
      
      private static const const_1014:int = 10066329;
      
      private static const const_1012:int = 10066329;
      
      public static const const_1626:int = 16777215;
      
      public static const const_1643:int = 13421772;
      
      public static const const_1773:int = 10066329;
      ...
      private var var_1169:uint = 16777215;
      
      private var var_2474:int = 255;
      
      private var var_2472:int = 255;
      
      private var var_2468:int = 255;
      
      private var var_1782:Boolean = true;
      
      private var var_1783:int = 0;
      
      private var var_1862:int = -1000;
      
      private const const_2145:int = 250;
      ...
      protected function defineSprites() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            ...
            {
               if(_loc3_.type == RoomPlane.const_132 && (_loc3_.leftSide.length < 1 || _loc3_.rightSide.length < 1))
               {
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1306);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1262);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            _loc13_ = null;
            if(_loc12_ == RoomPlaneData.const_206)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_235,true,_loc11_,_loc6_);
               if(_loc14_.z != 0)
               {
                  _loc13_.color = const_1546;
               }
               else
               {
                  _loc13_.color = const_1792;
               }
            ...
            else if(_loc12_ == RoomPlaneData.const_173)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_132,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
                  _loc13_.hasTexture = false;
               }
               ...
               {
                  _loc13_.color = const_1013;
               }
               else
               {
                  _loc13_.color = const_1014;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_309)
            {
               ...
               if(_loc14_.y > 0)
               {
                  _loc13_.color = const_1626;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_1643;
               }
               else
               {
                  _loc13_.color = const_1773;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1630)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_132,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_309)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this.var_1862 + this.const_2145 && !_loc6_ && !_loc8_)
         {
            return;
         }
         ...
         {
            _loc10_ = 0;
            while(_loc10_ < this.var_350.length)
            {
               _loc11_ = this.var_617[_loc10_];
               _loc12_ = getSprite(_loc11_);
               _loc13_ = this.var_350[_loc10_] as RoomPlane;
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_1782)
                  {
                     _loc14_ = uint(_loc13_.color);
                     _loc15_ = uint((_loc14_ & 255) * this.var_2468 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2472 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2474 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1844)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1467 || _loc3_.y != this.var_2469 || _loc3_.z != this.var_2471 || param1.scale != this.var_2473))
            {
               this.var_1467 = _loc3_.x;
               this.var_2469 = _loc3_.y;
               this.var_2471 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1289);
            if(_loc3_ != this.var_2470)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2470 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_975));
            if(_loc4_ != this.var_1169)
            {
               this.var_1169 = _loc4_;
               this.var_2468 = this.var_1169 & 255;
               this.var_2472 = this.var_1169 >> 8 & 255;
               this.var_2474 = this.var_1169 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1123));
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_175 != param1.getUpdateID())
         {
            ...
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_829));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_728));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_734));
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         if(param2 != this.var_1585)
         {
            this.var_1585 = param2;
         }
         else
         {
            param2 = null;
         }
         if(param3 != this.var_1583)
         {
         ...
         while(_loc4_ < this.var_139.length)
         {
            ...
            if(_loc5_ != null)
            {
               if(_loc5_.type == RoomPlane.const_235 && param1 != null)
               {
                  _loc5_.id = param1;
               }
               else if(_loc5_.type == RoomPlane.const_132 && param2 != null)
               {
                  _loc5_.id = param2;
               }
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_350;
         if(this.var_350.length == 0)
         {
            _loc6_ = this.var_139;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_350.length > 0;
         var _loc9_:int = 0;
               ...
               if(_loc12_ != null)
               {
                  if(_loc12_.update(param1,_loc5_))
                  {
                     if(_loc12_.visible)
                     {
                        ...
                        if(_loc12_.type != RoomPlane.const_235)
                        {
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1783;
      }
         ...
         while(_loc8_ < this.var_501.maskCount)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               while(_loc13_ < this.var_139.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_132 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_132 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_246)
                              {
