package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualizationData implements IRoomObjectVisualizationData
   {
      ...
      private var var_542:WallRasterizer;
      
      private var var_544:FloorRasterizer;
      
      private var var_816:WallAdRasterizer;
      
      private var var_543:LandscapeRasterizer;
      ...
      {
         super();
         this.var_542 = new WallRasterizer();
         this.var_544 = new FloorRasterizer();
         this.var_816 = new WallAdRasterizer();
         this.var_543 = new LandscapeRasterizer();
      ...
      public function initialize(param1:XML) : Boolean
      {
         ...
         {
            _loc7_ = _loc2_[0];
            this.var_542.initialize(_loc7_);
         }
         ...
         {
            _loc10_ = _loc5_[0];
            this.var_543.initialize(_loc10_);
         }
