package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCell
   {
      ...
      private var var_690:PlaneTexture;
      ...
      public function getHeight(param1:IVector3d) : int
      {
         ...
         if(this.var_690 != null)
         {
            _loc2_ = this.var_690.getBitmap(param1);
            if(_loc2_ != null)
            {
            ...
            if(_loc2_ != null)
            {
               if(!this.isStatic)
               {
                  ...
                  while(_loc6_ < _loc3_)
                  {
                     ...
                     _loc8_ = this.var_1043[_loc6_ % this.var_1043.length] as IGraphicAsset;
