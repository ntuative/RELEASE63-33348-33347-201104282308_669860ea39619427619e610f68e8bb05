package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private static var var_1485:int = 2;
      ...
      private var var_1877:TriggerConfs;
      
      private var var_1875:ActionTypes;
      
      private var var_1876:ConditionTypes;
      ...
      {
         this.var_1877 = new TriggerConfs();
         this.var_1875 = new ActionTypes();
         this.var_1876 = new ConditionTypes();
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1208 = new SliderWindowController(this.var_79,IWindowContainer(this.find(this.var_51,"delay_slider_container")),this.var_79.assets,0,20,1);
         this.var_1208.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1208.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_784.hideAll(this.var_254);
         }
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1208.getValue()) : 0;
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.stuffTypeSelectionCode = this.var_36.stuffTypeSelectionCode < 1 ? int(var_1485) : int(this.var_36.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.stuffTypeSelectionCode = (this.var_36.stuffTypeSelectionCode + 1) % (var_1485 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1877);
         this.refreshConfigureElement(this.var_1875);
         this.refreshConfigureElement(this.var_1876);
