package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      private var var_1091:Number = 1.0;
      ...
      public function setValue(param1:Number, param2:Boolean = true) : void
      {
         ...
         param1 = Math.min(this.var_1091,param1);
         this.var_885 = param1;
         if(param2)
         {
      ...
      private function updateSliderPosition() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.x = this.getSliderPosition(this.var_885);
         }
      ...
      {
         return int(this.var_1627 * (Number(param1 - this._minValue) / (this.var_1091 - this._minValue)));
      }
      
      private function getValueAtPosition(param1:Number) : Number
      {
         return param1 / this.var_1627 * (this.var_1091 - this._minValue) + this._minValue;
      }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_884)
         {
            if(param1.type == WindowMouseEvent.const_51 || param1.type == WindowMouseEvent.const_221)
            {
               this.var_884 = false;
            }
         }
         if(!this.var_884 || param1.type != WindowEvent.const_286)
         {
            return;
         }
         if(this.var_581 != 0)
         {
            ...
            _loc4_ = Math.round(_loc3_ / this.var_581) * this.var_581;
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_581 != 0)
            {
               _loc3_ = this.var_885 + this.var_581;
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null && this.var_713 != null)
            {
               _loc2_.bitmap = new BitmapData(this.var_713.width,this.var_713.height,true,16777215);
               _loc2_.bitmap.copyPixels(this.var_713,this.var_713.rect,new Point(0,0),null,null,true);
               _loc2_.procedure = this.sliderProcedure;
               this.var_1627 = _loc1_.width - _loc2_.width;
            }
         }
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_713 = BitmapData(_loc2_.content);
      }
   }
}
