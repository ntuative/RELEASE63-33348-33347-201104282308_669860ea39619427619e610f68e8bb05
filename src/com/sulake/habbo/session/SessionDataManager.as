package com.sulake.habbo.session
{
   ...
   public class SessionDataManager extends Component implements ISessionDataManager
   {
      ...
      private var var_1924:GroupDetailsView;
      ...
      private var var_646:ProductDataParser;
      ...
      private var var_1922:UserTagManager;
      
      private var var_1499:BadgeImageManager;
      
      private var var_1222:HabboGroupInfoManager;
      
      private var var_984:IgnoredUsersManager;
      ...
      private var var_1224:FaceBookSession;
      
      public function SessionDataManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         super(param1,param2,param3);
         this.var_2950 = [];
         this.var_1922 = new UserTagManager(events);
         this.var_1222 = new HabboGroupInfoManager(this,events);
         this.var_984 = new IgnoredUsersManager(this);
         this.var_1224 = new FaceBookSession();
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_312)
         {
            this.var_312.removeEventListener(FurnitureDataParser.const_135,this.onFurnitureReady);
            this.var_312.dispose();
            this.var_312 = null;
         }
         if(this.var_646)
         {
            this.var_646.removeEventListener(ProductDataParser.const_135,this.onProductsReady);
      ...
      private function initBadgeImageManager() : void
      {
         ...
         this.var_1499 = new BadgeImageManager(context.root.assets,events,this.var_192,this._localization);
      }
      ...
      private function onHabboCommunicationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_1922.communication = this._communication;
         this.var_1222.communication = this._communication;
         this.var_1224.communication = this._communication;
         this.var_984.registerMessageEvents();
      }
      ...
      private function onConfigurationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         if(!this.var_312)
         {
            ...
            this.var_312 = new FurnitureDataParser(this.var_523,this._wallItems,this.var_522,this._localization);
            this.var_312.addEventListener(FurnitureDataParser.const_135,this.onFurnitureReady);
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         this.var_2384 = _loc2_.clubLevel;
      ...
      private function onUserObject(param1:IMessageEvent) : void
      {
         ...
         this.var_2847 = _loc3_.respectTotal;
         this._respectLeft = _loc3_.respectLeft;
         this.var_796 = _loc3_.petRespectLeft;
         this.var_623 = _loc3_.figure;
         this.var_947 = _loc3_.sex;
         this.var_1745 = _loc3_.realName;
         this.var_2659 = _loc3_.identityId;
         this.var_984.initIgnoreList();
      }
      ...
      private function onUserChange(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.id == -1)
         {
            this.var_623 = _loc2_.figure;
            this.var_947 = _loc2_.sex;
            events.dispatchEvent(new HabboSessionFigureUpdatedEvent(this._id,this.var_623,this.var_947));
         }
      }
      ...
      private function onAvailabilityStatus(param1:IMessageEvent) : void
      {
         ...
         this.var_2658 = _loc2_.isOpen;
         this.var_2657 = _loc2_.onShutDown;
      }
      ...
      {
         return this._securityLevel >= SecurityLevelEnum.const_1252;
      }
      
      public function getUserTags(param1:int) : Array
      {
         return this.var_1922.getTags(param1);
      }
      
      public function getBadgeImage(param1:String) : BitmapData
      {
         return this.var_1499.getBadgeImage(param1);
      }
      ...
      public function showGroupBadgeInfo(param1:int) : void
      {
         ...
         {
            this.var_1924 = new GroupDetailsView(this);
         }
         var _loc2_:HabboGroupDetails = this.var_1222.getGroupDetails(param1);
         if(_loc2_ != null)
         {
            this.var_1924.showGroupDetails(param1);
         }
      }
      
      public function getGroupDetails(param1:int) : HabboGroupDetails
      {
         return this.var_1222.getGroupDetails(param1);
      }
      
      public function getGroupBadgeId(param1:int) : String
      {
         return this.var_1222.getBadgeId(param1);
      }
      
      public function getGroupBadgeImage(param1:String) : BitmapData
      {
         return this.var_1499.getBadgeImage(param1,BadgeImageManager.const_1216);
      }
      ...
      {
         return this.var_984.isIgnored(param1);
      }
      
      public function ignoreUser(param1:String) : void
      {
         this.var_984.ignoreUser(param1);
      }
      
      public function unignoreUser(param1:String) : void
      {
         this.var_984.unignoreUser(param1);
      }
      ...
      {
         var _loc2_:IConnection = this._communication.getHabboMainConnection(null);
         if(param1 < 0 || this.var_796 < 1 || _loc2_ == null)
         {
            throw new Error("Failed to give respect to pet: " + param1);
         }
         _loc2_.send(new RespectPetMessageComposer(param1));
         this.var_796 = this.var_796 - 1;
      }
      ...
      public function getFloorItemDataByName(param1:String, param2:int = 0) : IFurnitureData
      {
         ...
         var _loc3_:Array = this.var_522.getValue(param1);
      ...
      public function loadProductData(param1:IProductDataListener = null) : Boolean
      {
         ...
         if(this.var_1223.indexOf(param1) == -1)
         {
            this.var_1223.push(param1);
         }
         if(this.var_646 == null)
         {
            _loc2_ = this.var_192.getKey("productdata.load.url");
            this.var_646 = new ProductDataParser(_loc2_,this.var_1171);
            this.var_646.addEventListener(ProductDataParser.const_135,this.onProductsReady);
         }
         return false;
      }
      ...
      private function onProductsReady(param1:Event) : void
      {
         ...
         this.var_646.removeEventListener(ProductDataParser.const_135,this.onProductsReady);
         this.var_1923 = true;
         for each(_loc2_ in this.var_1223)
         {
