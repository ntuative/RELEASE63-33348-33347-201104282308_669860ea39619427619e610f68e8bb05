package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1010:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1378:String = "sendAccessTokenToServer";
      
      private static const const_1379:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1378,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1379,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_1010);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_1010);
         }
      }
