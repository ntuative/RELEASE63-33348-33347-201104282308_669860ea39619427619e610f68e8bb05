package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager, IUpdateReceiver
   {
      ...
      private static const const_1381:int = 60;
      ...
      private var var_1434:ByteArray;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null, param4:Boolean = true)
      {
         ...
         events.addEventListener(TraxSongLoadEvent.const_865,this.onTraxLoadComplete);
      ...
      public function playSound(param1:String) : void
      {
         ...
         if(_loc2_ == null)
         {
            ...
            switch(param1)
            {
               case HabboSoundTypesEnum.const_1127:
                  _loc3_ = "sound_call_for_help";
                  break;
               case HabboSoundTypesEnum.const_1759:
                  _loc3_ = "sound_guide_received_invitation";
                  break;
               case HabboSoundTypesEnum.const_1103:
               ...
               case HabboSoundTypesEnum.const_1235:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1609:
      ...
      private function loadSample(param1:int) : void
      {
         ...
         _loc4_.load(_loc3_);
         this.var_615.add(_loc4_,param1);
      }
      ...
      private function addTraxSongForDownload(param1:int, param2:String) : IHabboSound
      {
         ...
         if(!_loc3_.ready)
         {
            this.var_1167.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      private function createTraxInstance(param1:int, param2:String, param3:Boolean = true) : TraxSequencer
      {
         ...
         var _loc5_:TraxSequencer = new TraxSequencer(param1,_loc4_,this.var_616,events);
         _loc5_.volume = this.var_499;
      ...
      private function validateSampleAvailability(param1:TraxSequencer, param2:Boolean) : void
      {
         ...
         {
            if(this.var_616.getValue(int(_loc4_[_loc6_])) == null)
            {
               if(param2)
               {
      ...
      {
         if(this.var_192 == null || this._connection == null || this._roomEngine == null || this.var_234 != null)
         {
            return;
         }
         this.var_234 = new HabboMusicController(this,events,this._roomEngine.events,this._connection);
      }
      ...
      private function onTraxLoadComplete(param1:Event) : void
      {
         ...
         this.var_234.onSongLoaded(_loc2_.id);
      }
      
      private function ioErrorHandler(param1:Event) : void
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1720,this.var_759));
         this.var_759 = -1;
         this.var_758 = null;
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            this.setHabboToolbarIconState(this.var_499 > 0);
            return;
         }
      ...
      private function storeVolumeSetting() : void
      {
         ...
         {
            this._connection.send(new SetSoundSettingsComposer(int(this.var_499 * 100)));
         }
      }
      ...
      {
         this.var_499 = param1;
         this.var_234.updateVolume(this.var_499);
      ...
      private function processLoadedSample(param1:Sound) : void
      {
         ...
         {
            _loc2_ = this.var_615.remove(param1);
            if(this.var_616.getValue(_loc2_) == null)
            {
               this.var_1434.clear();
               _loc3_ = param1.length;
               param1.extract(this.var_1434,int(_loc3_ * 44.1));
               _loc4_ = new TraxSample(this.var_1434,_loc2_,TraxSample.const_1682,TraxSample.const_1633);
               this.var_616.add(_loc2_,_loc4_);
            }
         }
      }
      ...
      private function processLoadedSamples() : void
      {
         ...
         if(this.var_1168.length > 0)
         {
            _loc1_ = getTimer();
            _loc2_ = _loc1_;
            while(_loc2_ - _loc1_ < const_1381 && this.var_1168.length > 0)
            {
               _loc3_ = this.var_1168.splice(0,1)[0];
               this.processLoadedSample(_loc3_);
               _loc2_ = getTimer();
            }
            if(this.var_615.length == 0 && this.var_759 != -1)
            {
               this.var_758.ready = true;
               _loc4_ = this.var_759;
               this.var_759 = -1;
               this.var_758 = null;
               events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_865,_loc4_));
            }
         }
      }
      ...
      private function loadNextSong() : void
      {
         var _loc1_:int = 0;
         var _loc2_:* = null;
         if(this.var_758 == null && this.var_1167.length > 0)
         {
            _loc1_ = this.var_1167.getKey(0);
            _loc2_ = this.var_1167.remove(_loc1_);
            if(_loc2_ != null)
            {
               this.validateSampleAvailability(_loc2_,true);
               if(_loc2_.ready)
               {
                  events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_865,_loc1_));
               }
               else
               {
                  this.var_758 = _loc2_;
