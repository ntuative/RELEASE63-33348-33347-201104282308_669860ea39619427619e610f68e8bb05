package com.sulake.habbo.sound.trax
{
   ...
   public class TraxSample
   {
      ...
      public static const const_1682:String = "sample_44khz";
      
      public static const const_1663:String = "sample_22khz";
      
      public static const const_1602:String = "sample_11khz";
      
      public static const const_1633:String = "sample_16bit";
      
      public static const const_1669:String = "sample_8bit";
      ...
      private static const const_190:int = 65535;
      
      private static const const_75:int = 127;
      
      private static const const_191:int = 32767;
      ...
      public function TraxSample(param1:ByteArray, param2:int, param3:String = "sample_44khz", param4:String = "sample_16bit")
      {
         ...
         var _loc6_:int = this.var_151 * this.var_72;
         ...
         while(_loc11_ < _loc10_)
         {
            ...
            if(_loc11_ >= _loc10_ - 1 - const_986)
            {
               _loc12_ *= (_loc10_ - _loc11_ - 1) / Number(const_986);
            }
            ...
            _loc9_ *= _loc5_;
            _loc9_ += _loc14_;
            if(_loc11_ % this.var_151 == this.var_151 - 1)
            {
               this.var_128[int(_loc11_ / this.var_151)] = _loc9_;
               _loc9_ = 0;
            }
            _loc11_++;
         }
      ...
      {
         return this.var_128.length * this.var_151 * this.var_72;
      }
      ...
      public function setSample(param1:Vector.<int>, param2:int, param3:int, param4:int) : int
      {
         ...
         var _loc5_:int = this.var_151 * this.var_72;
         param4 /= _loc5_;
         if(param2 < 0)
         {
            param3 += param2;
         ...
         if(this.var_72 == 1)
         {
            if(this.var_151 == 2)
            {
               while(_loc6_-- > 0)
               {
                  ...
                  var _loc11_:*;
                  param1[_loc11_ = param2++] = (_loc8_ >> 16 & const_190) - const_191;
                  var _loc12_:*;
                  param1[_loc12_ = param2++] = (_loc8_ & const_190) - const_191;
               }
            }
            else if(this.var_151 == 4)
            {
               while(_loc6_-- > 0)
               {
                  _loc8_ = this.var_128[param4++];
         ...
         else if(this.var_72 >= 2)
         {
            ...
            if(this.var_151 == 2)
            {
               ...
               {
                  _loc8_ = this.var_128[param4++];
                  _loc10_ = int((_loc8_ >> 16 & const_190) - const_191);
                  _loc9_ = this.var_72;
                  while(_loc9_ > 0)
                  {
                  ...
                  _loc10_ = int((_loc8_ & const_190) - const_191);
                  _loc9_ = this.var_72;
                  while(_loc9_ > 0)
                  {
                     param1[_loc11_ = param2++] = _loc10_;
      ...
      public function addSample(param1:Vector.<int>, param2:int, param3:int, param4:int) : int
      {
         ...
         if(this.var_72 == 1)
         {
            if(this.var_151 == 2)
            {
               while(_loc6_-- > 0)
               {
                  ...
                  var _loc10_:*;
                  param1[_loc10_ = param2++] = param1[_loc10_] + ((_loc7_ >> 16 & const_190) - const_191);
                  var _loc11_:*;
                  param1[_loc11_ = param2++] = param1[_loc11_] + ((_loc7_ & const_190) - const_191);
               }
            }
            else if(this.var_151 == 4)
            {
         ...
         else if(this.var_72 >= 2)
         {
            ...
            if(this.var_151 == 2)
            {
               ...
               {
                  _loc7_ = this.var_128[param4++];
                  _loc9_ = int((_loc7_ >> 16 & const_190) - const_191);
                  _loc8_ = this.var_72;
                  while(_loc8_ > 0)
                  {
                  ...
                  _loc9_ = int((_loc7_ & const_190) - const_191);
                  _loc8_ = this.var_72;
                  while(_loc8_ > 0)
                  {
                     param1[_loc10_ = param2++] = param1[_loc10_] + _loc9_;
