package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private var var_1461:LogoutController;
      ...
      private function onCommunicationManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._connection = this.var_243.getHabboMainConnection(null);
         this.tryInitialize();
      }
      ...
      private function onConfigurationManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_955 = this._config.getKey("client.toolbar.static.enabled","false") == "RC4_R27";
         this.tryInitialize();
      }
      
      private function tryInitialize() : void
      {
         if(this.var_243 && this._windowManager && this._config)
         {
            this.var_243.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(this.onAuthenticationOK));
            unlock();
         }
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         if(this._config && this._config.getKey("client.logout.enabled","false") == "RC4_R27")
         {
            this.var_1461 = new LogoutController(this,this._windowManager,this._assetLibrary,events,this._config);
         }
         if(this._view == null)
         {
            return;
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_1264,this.onSetToolbarIconBitmapEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_56,this.onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_536,this.onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1256,this.onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1142,this.onHideWindowEvent);
         this._state = true;
      ...
      private function onAnimateWindowEvent(param1:HabboToolbarShowMenuEvent) : void
      {
         ...
         if(param1.type == HabboToolbarShowMenuEvent.const_56)
         {
