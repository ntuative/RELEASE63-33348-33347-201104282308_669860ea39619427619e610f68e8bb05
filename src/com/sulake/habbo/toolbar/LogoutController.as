package com.sulake.habbo.toolbar
{
   ...
   public class LogoutController
   {
      ...
      private static const const_1355:uint = 16777215;
      
      private static const const_1353:uint = 12247545;
      
      private static const const_1356:String = "HELP";
      
      private static const const_1354:String = "ROOMINFO";
      ...
      private const const_500:int = 44;
      ...
      public function LogoutController(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IEventDispatcher, param5:IHabboConfigurationManager)
      {
         ...
         this.var_326 = this._window.findChildByName("roominfo_region");
         ...
         this.hideRoomInfo();
         this.var_1719 = this._config.getKey("roominfo.widget.enabled") == "1";
         if(this.var_1719)
         {
            this._events.addEventListener(HabboToolbarEvent.const_344,this.onRoomView);
            this._events.addEventListener(HabboToolbarEvent.const_306,this.onHotelView);
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_1719)
         {
            this._events.removeEventListener(HabboToolbarEvent.const_344,this.onRoomView);
            this._events.removeEventListener(HabboToolbarEvent.const_306,this.onHotelView);
         }
         this._events = null;
         this._config = null;
         if(this._window)
      ...
      {
         this._list.removeListItem(this.var_326);
      }
      
      private function showRoomInfo() : void
      {
         this._list.addListItemAt(this.var_326,0);
      }
      ...
      private function createWindow(param1:String) : IWindow
      {
         ...
         _loc3_.x = _loc4_.width - _loc3_.width - this.const_474;
         _loc3_.y = this.const_500;
         return _loc3_;
      }
      ...
      private function showConfirmation() : void
      {
         if(!this.var_605)
         {
            this.var_605 = this.createWindow("logout_confirmation_xml") as IWindowContainer;
         }
      }
      ...
      private function onClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "logout_region":
               ...
               break;
            case "help_region":
               this._toolbar.toggleWindowVisibility(const_1356);
               break;
            case "roominfo_region":
               this._toolbar.toggleWindowVisibility(const_1354);
               break;
            case "confirm":
               if(false)
               {
