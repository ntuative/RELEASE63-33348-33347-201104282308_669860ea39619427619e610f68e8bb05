package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_233:Boolean = true;
      
      private static const const_1470:Number = 25;
      
      private static const const_1519:Number = 90;
      
      private static const const_1049:int = 50;
      
      private static const const_1469:int = 50;
       
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_1538:IToolbarView;
      
      private var var_823:Timer;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:IToolbarView)
      {
         ...
         this.var_671 = new Object();
         this.var_670 = new Array();
         this.var_672 = new Array();
         super();
         this._windowManager = param1;
         this.var_1538 = param2;
         this.var_823 = new Timer(const_1470);
         this.var_823.addEventListener(TimerEvent.TIMER,this.animationUpdate);
      }
      ...
      public function refresh() : void
      {
         ...
         {
            this.repositionWindow(this.var_384[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_1049 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_1049 || param1.desktop.height - param1.y < const_1469;
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = this.var_1538.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
            ...
            this.var_384.push(_loc3_.menuId);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Point = this.var_1538.getIconLoc(param1.iconId);
      ...
      {
         return this.var_670[this.var_672.indexOf(param1)];
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return this.var_672[this.var_670.indexOf(param1)];
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = this.var_672.indexOf(param2);
         if(_loc3_ > -1)
         {
            this.var_672.splice(_loc3_,1);
            this.var_670.splice(_loc3_,1);
         }
         this.var_670.push(param1.name);
         this.var_672.push(param2);
         param1.addEventListener(WindowEvent.const_286,this.windowEventListener);
         param1.addEventListener(WindowEvent.const_216,this.windowEventListener);
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(this.var_671[_loc3_] == null)
            {
               this.var_671[_loc3_] = new Array();
            }
            if(this.var_671[_loc3_].indexOf(param1) < 0)
            {
               this.var_671[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      public function removeItem(param1:String) : void
      {
         if(this.var_384.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               this.var_384.splice(this.var_384.indexOf(param1),1);
            }
         }
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_670.length)
         {
            if(this.var_670[_loc2_] == param1.window.name)
            {
               _loc3_ = this.var_672[_loc2_];
               if(this.var_671[_loc3_] != null)
               {
                  _loc4_ = 0;
                  while(_loc4_ < this.var_671[_loc3_].length)
                  {
                     this.repositionWindow(this.var_671[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
      ...
      private function animationUpdate(param1:TimerEvent) : void
      {
         ...
         if(this.var_384.length == 0)
         {
            this.var_823.stop();
         }
         var _loc7_:int = 0;
         while(_loc7_ < this.var_384.length)
         {
            _loc2_ = this._itemList[this.var_384[_loc7_]];
            if(_loc2_.active)
            {
