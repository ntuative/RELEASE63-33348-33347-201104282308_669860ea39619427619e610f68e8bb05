package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_1050:uint = 11;
      ...
      private var var_209:IHabboFriendList;
      
      private var var_1258:IHabboWindowManager;
      ...
      private var var_270:PerformanceTracker = null;
      
      private var var_453:FramerateTracker = null;
      
      private var var_269:LatencyTracker = null;
      
      private var var_674:LagWarningLogger = null;
      
      private var var_673:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_270 = new PerformanceTracker();
         this.var_453 = new FramerateTracker();
         this.var_269 = new LatencyTracker();
         this.var_674 = new LagWarningLogger();
         this.var_673 = new ToolbarClickTracker(this);
         this.var_1540 = new Array(const_1050);
         var _loc4_:int = 0;
         while(_loc4_ < const_1050)
         {
            this.var_1540[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1680,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1767,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1532,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_776,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1302,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1258)
            {
               this.var_1258.release(new IIDHabboWindowManager());
               this.var_1258 = null;
            }
            if(this.var_290)
            {
            ...
            if(this.var_209)
            {
               if(!this.var_209.disposed)
               {
                  Component(this.var_209).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
                  Component(this.var_209).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
                  Component(this.var_209).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
                  Component(this.var_209).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
                  Component(this.var_209).events.removeEventListener(HabboFriendListTrackingEvent.const_445,this.onFriendlistTrackingEvent);
               }
               this.var_209.release(new IIDHabboFriendList());
               this.var_209 = null;
            }
            if(this.var_136)
            {
            ...
            if(this._roomEngine)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomObjectRoomAdEvent.const_203,this.onRoomAdClick);
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_350,this.onRoomAction);
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_322,this.onRoomAction);
               }
            ...
            {
               this.var_320.stop();
               this.var_320.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
               this.var_320 = null;
            }
      ...
      {
         this.var_1540[param2] = param1;
      }
      
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_192 = IHabboConfigurationManager(param2);
         if(this.var_192)
         {
            if(this.var_269 != null)
            {
               this.var_269.configuration = this.var_192;
            }
            if(this.var_270 != null)
            {
               this.var_270.configuration = this.var_192;
            }
            ...
            if(this.var_192)
            {
               ...
               {
                  this.var_674.configure(this.var_192);
               }
               if(this.var_453 != null)
               {
                  this.var_453.configure(this.var_192);
               }
               if(this.var_673 != null)
               {
                  this.var_673.configure(this.var_192);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_759,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_67,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_467,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_269 != null)
            {
               this.var_269.communication = this._communication;
               this.var_269.connection = param1;
            }
            if(this.var_674 != null)
            {
               this.var_674.connection = param1;
            }
         }
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_759)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1583);
         }
         else if(param1.type == HabboHotelViewEvent.const_467)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1786);
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1763);
               break;
            case HabboCommunicationEvent.const_955:
               this.trackLoginStep(HabboLoginTrackingStep.const_1824,String(this._communication.port));
               break;
      ...
      {
         this.var_1258 = IHabboWindowManager(param2);
         if(this.var_1258)
         {
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_192)
            {
               if(this.var_192.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = this.var_192.getKey("client.fatal.error.url");
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1540)
                  {
                  ...
                  if(this.var_270 != null)
                  {
                     _loc4_["null"] = this.var_270.flashVersion;
                     _loc4_["null"] = this.var_270.averageUpdateInterval;
                  }
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1253);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1253,this.onCoreRunning);
         }
      }
      ...
      {
         this.var_209 = param2 as IHabboFriendList;
         Component(this.var_209).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
         Component(this.var_209).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
         Component(this.var_209).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
         Component(this.var_209).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
         Component(this.var_209).events.addEventListener(HabboFriendListTrackingEvent.const_445,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_445:
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2800)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1788);
            this.var_2800 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.privateRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1302,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_776,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_203,this.onRoomAdClick);
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_350,this.onRoomAction);
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_322,this.onRoomAction);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_290 = param2 as IAdManager;
         this.var_290.events.addEventListener(AdEvent.const_492,this.onRoomAdLoad);
      }
      ...
      private function onRoomAction(param1:RoomEngineEvent) : void
      {
         if(param1.type == RoomEngineEvent.const_350)
         {
            if(this.var_2010 < 1)
            {
               if(!this.var_320)
               {
                  this.var_320 = new Timer(60000,1);
                  this.var_320.addEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
                  this.var_320.start();
               }
            }
         }
         else if(param1.type == RoomEngineEvent.const_322)
         {
            if(this.var_320)
            {
               this.var_320.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
         ...
         if(!disposed)
         {
            if(this._connection)
            {
               if(this.var_453)
               {
                  ...
                  this.trackConversionPoint("Performance","fps",String(this.var_453.frameRate),_loc2_);
                  ++this.var_2010;
               }
            }
         }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_673)
         {
            this.var_673.track(param1.iconName);
         }
      }
      ...
      {
         if(this.var_192 != null && !Boolean(this.var_192.getKey("processlog.enabled")))
         {
            return;
         }
      ...
      {
         this.var_674.chatLagDetected(param1);
      }
      
      public function update(param1:uint) : void
      {
         var _loc2_:int = getTimer();
         if(this.var_550 > -1 && _loc2_ < this.var_550)
         {
            ++this.var_2012;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_2012);
         }
         if(this.var_550 > -1 && _loc2_ - this.var_550 > 15000)
         {
            ++this.var_2011;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_2011);
         }
         this.var_550 = _loc2_;
         if(this.var_270 != null)
         {
            this.var_270.update(param1,this.var_550);
         }
         if(this.var_269 != null)
         {
            this.var_269.update(param1,this.var_550);
         }
         if(this.var_453 != null)
         {
            this.var_453.trackUpdate(param1,this,this.var_550);
         }
         if(this.var_674 != null)
         {
            this.var_674.update(this.var_550);
         }
      }
   }
}
