package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private const const_1360:String = "room_view";
      
      private const const_2142:String = "room_widget";
      
      private var var_49:IWindowContainer;
      
      private var var_734:int = 50;
      
      private var var_2934:XML = null;
      ...
      public function setLayout(param1:XML, param2:IHabboWindowManager, param3:IHabboConfigurationManager) : void
      {
         ...
         if(param3)
         {
            if(param3.getKey("friendbar.enabled") == "RC4_R27")
            {
         ...
         while(_loc6_ < this.var_49.numChildren)
         {
            ...
            {
               _loc5_.addEventListener(WindowEvent.const_153,this.trimContainer);
            }
            _loc6_++;
         }
      }
      ...
      public function addWidgetWindow(param1:String, param2:IWindow) : Boolean
      {
         ...
         {
            if(String(_loc3_[_loc5_]).indexOf(this.const_2142) == 0)
            {
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = this.var_49.getChildByTag(this.const_1360) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function set toolbarOrientation(param1:String) : void
      {
         ...
         switch(param1)
         {
            case "LEFT":
               ...
               _loc2_.width = this.var_49.desktop.width - this.var_734;
               _loc2_.y = 0;
            ...
            case "TOP":
               ...
               _loc2_.height = this.var_49.desktop.height - this.var_734;
               break;
            case "BOTTOM":
               _loc2_.x = 0;
               _loc2_.width = this.var_49.desktop.width;
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = this.var_49.findChildByTag(this.const_1360) as IWindowContainer;
         if(!_loc1_)
         {
            return null;
         }
