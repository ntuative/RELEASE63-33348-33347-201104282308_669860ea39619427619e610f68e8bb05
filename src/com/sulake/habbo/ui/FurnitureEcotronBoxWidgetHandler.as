package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_883,RoomWidgetEcotronBoxOpenMessage.const_842,RoomWidgetEcotronBoxOpenedMessage.const_1807];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_883:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_842:
