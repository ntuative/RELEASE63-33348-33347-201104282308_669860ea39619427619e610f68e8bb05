package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         {
            this.var_234.events.addEventListener(NowPlayingEvent.const_104,this.onNowPlayingChanged);
      ...
      {
         return RoomWidgetEnum.const_634;
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            if(this._container.sessionDataManager != null)
            {
               ...
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_162,this.onBadgeImage);
            }
            if(this._container.roomSessionManager != null)
            {
               this._container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_183,this.onFigureUpdate);
         ...
         if(this._container.sessionDataManager != null)
         {
            ...
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_162,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
            this._container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_183,this.onFigureUpdate);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_698.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_698.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_234 != null)
         {
            this.var_234.events.removeEventListener(NowPlayingEvent.const_104,this.onNowPlayingChanged);
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_347);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_874);
         _loc1_.push(RoomWidgetFurniActionMessage.const_897);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_904);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_915);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_703);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1752);
         _loc1_.push(RoomWidgetPetCommandMessage.const_554);
         _loc1_.push(RoomWidgetPetCommandMessage.const_965);
         _loc1_.push(RoomWidgetUserActionMessage.const_480);
         _loc1_.push(RoomWidgetUserActionMessage.const_419);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_693);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_580)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_419 || param1.type == RoomWidgetUserActionMessage.const_480 || param1.type == RoomWidgetUserActionMessage.const_549)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_347:
            ...
            case RoomWidgetUserActionMessage.const_561:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_964,_loc3_.name);
            ...
            case RoomWidgetFurniActionMessage.const_272:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_874:
            ...
            case RoomWidgetFurniActionMessage.const_897:
               ...
               break;
            case RoomWidgetUserActionMessage.const_419:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_904:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_915:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_703:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_25:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_304);
               _loc6_.id = param1.id;
               ...
               if(_loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_418) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_418);
               }
               ...
               {
                  _loc25_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_349);
               ...
               _loc11_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1212);
               _loc12_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1078);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  _loc29_ = "";
                  _loc30_ = "";
                  if(_loc6_.extraParam == RoomWidgetInfostandExtraParamEnum.const_792)
                  {
                     _loc31_ = this.var_234.getRoomItemPlaylist();
                     if(_loc31_ != null)
                     {
                  ...
                  else if(_loc6_.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_398) == 0)
                  {
                     _loc32_ = _loc6_.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_398.length);
                     _loc27_ = parseInt(_loc32_);
                     _loc30_ = "null";
                  }
                  if(_loc27_ != -1)
                  {
                     _loc33_ = this.var_234.getSongInfo(_loc27_);
                     if(_loc33_ != null)
                     {
            ...
            case RoomObjectCategoryEnum.const_33:
               ...
               {
                  if(_loc13_.type != RoomObjectTypeEnum.const_527)
                  {
                     return null;
                  }
                  _loc14_ = "null";
               ...
               if(_loc18_ != null)
               {
                  _loc15_.carryItem = _loc18_.getModel().getNumber(RoomObjectVariableEnum.const_552);
               }
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.const_134)
               {
                  _loc15_.realName = this._container.sessionDataManager.realName;
               }
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.const_113)
               {
                  ...
                  if(_loc18_ != null)
                  {
                     _loc39_ = _loc18_.getModel().getString(RoomObjectVariableEnum.const_887);
                  ...
                  if(!_loc35_)
                  {
                     _loc15_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_707;
                  }
                  if(!_loc36_)
                  {
                     _loc15_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_790;
                  }
               ...
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc16_.push(RoomWidgetUserInfoUpdateEvent.const_1734);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_698.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_698.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_887);
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this.var_234 != null)
         {
            ...
            if(_loc2_ != -1)
            {
               _loc5_ = this.var_234.getSongInfo(_loc2_);
               if(_loc5_ != null)
               {
                  _loc3_ = _loc5_.name;
            ...
            this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_410,_loc2_,_loc3_,_loc4_));
         }
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_234 != null)
         {
            _loc2_ = this.var_234.getSongInfo(param1.id);
            if(_loc2_ != null)
            {
