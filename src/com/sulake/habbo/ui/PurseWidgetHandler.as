   ...
   public class PurseWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            this._container.catalog.events.removeEventListener(PurseEvent.const_116,this.purseEventHandler);
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         ...
         if(this._container.catalog)
         {
            ...
            this._container.catalog.events.addEventListener(PurseEvent.const_116,this.purseEventHandler);
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetPurseData.const_684);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetPurseData.const_684:
               ...
               this._container.events.dispatchEvent(new RoomWidgetPurseUpdateEvent(RoomWidgetPurseUpdateEvent.const_116,_loc2_.getActivityPointsForType(Purse.const_197)));
               break;
            case RoomWidgetOpenCatalogMessage.const_390:
               ...
               if(this._container.catalog != null)
               {
                  ...
                  {
                     case RoomWidgetOpenCatalogMessage.const_1198:
                        this._container.catalog.openCatalogPage(CatalogPageName.const_1821);
                        break;
                     case RoomWidgetOpenCatalogMessage.const_1210:
      ...
      private function purseEventHandler(param1:PurseEvent) : void
      {
         ...
         switch(param1.type)
         {
            case PurseEvent.const_71:
               ...
               break;
            case PurseEvent.const_116:
               _loc2_ = new RoomWidgetPurseUpdateEvent(RoomWidgetPurseUpdateEvent.const_116,param1.balance);
         }
         if(_loc2_)
         {
