package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private static const const_1403:int = 1000;
      ...
      private var var_1099:IRoomWidgetFactory = null;
      
      private var var_441:ISessionDataManager = null;
      
      private var var_16:IRoomSessionManager = null;
      
      private var var_529:IAvatarRenderManager = null;
      ...
      private var var_2556:uint = 16777215;
      ...
      private var var_1849:Rectangle;
      ...
      public function set friendList(param1:IHabboFriendList) : void
      {
         ...
         if(this._friendList)
         {
            ...
            this._friendList.events.addEventListener(FriendRequestEvent.const_342,this.processEvent);
         }
      }
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            ...
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_525,this.onRoomContentLoaded);
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_700,this.onRoomContentLoaded);
         }
      }
      ...
      public function set toolbar(param1:IHabboToolbar) : void
      {
         ...
         this._toolbar.events.addEventListener(HabboToolbarEvent.const_626,this.onToolbarRepositionEvent);
      ...
      public function set layout(param1:XML) : void
      {
         ...
         {
            this.var_201.toolbarSize = this._toolbar.size;
            this.var_201.toolbarOrientation = this._toolbar.orientation;
         }
      }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_777.length)
            {
               _loc6_ = this.var_777.getWithIndex(_loc1_) as IRoomWidgetHandler;
               if(_loc6_ != null)
               {
                  _loc6_.dispose();
               }
         ...
         if(this._friendList && this._friendList.events)
         {
            ...
            this._friendList.events.removeEventListener(FriendRequestEvent.const_342,this.processEvent);
         }
         ...
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            ...
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_525,this.onRoomContentLoaded);
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_700,this.onRoomContentLoaded);
         }
         ...
         {
            this._toolbar.events.removeEventListener(HabboToolbarEvent.const_626,this.onToolbarRepositionEvent);
      ...
      public function init() : void
      {
         if(this._roomEngine != null && this.var_31 != null)
         {
            this.var_779 = this._roomEngine.loadRoomResources(this.var_31.roomResources);
         ...
         if(this.var_290 != null && this.var_31.state == RoomSessionEvent.const_287)
         {
            this.var_1848 = !this.var_290.showInterstitial();
         }
      ...
      {
         if(this.var_779 == null || this.var_779.length == 0)
         {
            return;
         }
         var _loc2_:int = this.var_779.indexOf(param1.contentType);
         if(_loc2_ != -1)
         {
            this.var_779.splice(_loc2_,1);
         }
         if(this.var_779.length == 0)
         {
      ...
      public function createWidget(param1:String) : void
      {
         ...
         _loc2_ = this.var_1099.createWidget(param1);
         if(_loc2_ == null)
         {
            return;
         }
         ...
         this.var_201.addWidgetWindow(param1,_loc2_.mainWindow);
         ...
         if(_loc4_ != null)
         {
            ...
            if(!this.var_777.add(param1,_loc4_))
            {
               _loc4_.dispose();
            }
            _loc8_ = null;
            ...
            if(_loc9_ != null)
            {
               ...
               {
                  _loc8_ = this.var_778.getValue(_loc11_);
                  if(_loc8_ == null)
                  {
                     _loc8_ = [];
                     this.var_778.add(_loc11_,_loc8_);
                  }
                  else
                  {
            ...
            if(_loc10_ != null)
            {
               ...
               {
                  _loc8_ = this.var_780.getValue(_loc12_);
                  if(_loc8_ == null)
                  {
                     _loc8_ = [];
                     this.var_780.add(_loc12_,_loc8_);
                  }
                  _loc8_.push(_loc4_);
               }
            }
         ...
         {
            param1 = "null";
            _loc13_ = new RoomWidgetRoomViewUpdateEvent(param1,this.var_201.roomViewRect);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         var _loc2_:Array = this.var_778.getValue(param1.type);
         if(_loc2_ != null)
         {
      ...
      private function isFurnitureSelectionDisabled(param1:RoomEngineObjectEvent) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc4_ != null)
            {
               if(_loc4_.getNumber(RoomObjectVariableEnum.const_1296) == 1)
               {
                  _loc2_ = true;
                  if(this.var_441.isAnyRoomController)
                  {
                     _loc2_ = false;
                  }
               }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.ROOM_OBJECT_SELECTED:
               ...
               {
                  _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_279,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               }
               if(this.var_894 != null && _loc3_ == RoomObjectCategoryEnum.const_33)
               {
                  _loc7_ = this.var_31.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_172)
                  {
                     this.var_894.userSelected(_loc7_.webID,_loc7_.name);
                  }
               }
               break;
            ...
            case RoomEngineObjectEvent.const_484:
               ...
               break;
            case RoomEngineObjectEvent.const_709:
               if(!this.var_31.isRoomController && !this.var_441.isAnyRoomController)
               {
                  return;
               }
            ...
            case RoomEngineObjectEvent.const_156:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_1152,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               this.processWidgetMessage(_loc5_);
               break;
            ...
            case RoomEngineObjectEvent.const_142:
               ...
               this.processWidgetMessage(_loc5_);
               break;
            case RoomEngineSoundMachineEvent.const_247:
               this.processEvent(param1);
         }
         if(_loc4_ != null)
         {
      ...
      public function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomEngineEvent.const_571:
               _loc2_ = new RoomWidgetRoomEngineUpdateEvent(RoomWidgetRoomEngineUpdateEvent.const_377,param1.roomId,param1.roomCategory);
         }
         if(_loc2_ != null)
         {
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         var _loc5_:int = 0;
         if(this.var_306.indexOf(param1) >= 0)
         {
            return;
         }
         ...
         if(_loc7_ != null)
         {
            _loc13_ = this._roomEngine.getRoomNumberValue(this.var_31.roomId,this.var_31.roomCategory,RoomVariableEnum.const_846);
            _loc14_ = this._roomEngine.getRoomNumberValue(this.var_31.roomId,this.var_31.roomCategory,RoomVariableEnum.const_806);
            _loc15_ = this._roomEngine.getRoomNumberValue(this.var_31.roomId,this.var_31.roomCategory,RoomVariableEnum.const_767);
            _loc16_ = this._roomEngine.getRoomNumberValue(this.var_31.roomId,this.var_31.roomCategory,RoomVariableEnum.const_730);
         ...
         _loc10_.addEventListener(WindowMouseEvent.const_160,this.canvasMouseHandler);
         _loc10_.addEventListener(WindowMouseEvent.const_224,this.canvasMouseHandler);
         ...
         _loc10_.addEventListener(WindowMouseEvent.const_221,this.canvasMouseHandler);
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(this.var_2556);
      ...
      public function getFirstCanvasId() : int
      {
         if(this.var_306 != null)
         {
            ...
            {
               return this.var_306[0];
            }
         }
         return 0;
      }
      
      public function method_10() : Rectangle
      {
         if(!this.var_201)
         {
            return null;
      ...
      public function canvasMouseHandler(param1:WindowEvent) : void
      {
         ...
         switch(_loc2_.type)
         {
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
               _loc3_ = "null";
               break;
            case WindowMouseEvent.const_160:
               _loc3_ = "null";
               break;
            ...
            case WindowMouseEvent.const_221:
               _loc3_ = "null";
               break;
            case WindowMouseEvent.const_224:
               _loc3_ = "null";
               break;
            default:
               return;
         ...
         if(_loc4_ == _loc2_.target)
         {
            ...
            this._roomEngine.handleRoomCanvasMouseEvent(this.var_306[0],_loc6_,_loc7_,_loc3_,_loc2_.altKey,_loc2_.ctrlKey,_loc2_.shiftKey,_loc2_.buttonDown);
         }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         this.var_1849 = _loc2_.rectangle;
         this._roomEngine.modifyRoomCanvas(this.var_31.roomId,this.var_31.roomCategory,this.var_306[0],_loc2_.width,_loc2_.height);
         if(this.var_511 == null)
         {
            this.var_511 = new Timer(const_1403,1);
      ...
      private function onResizeTimerEvent(param1:TimerEvent) : void
      {
         ...
         this.events.dispatchEvent(new RoomWidgetRoomViewUpdateEvent(_loc2_,this.var_1849));
      }
      ...
      private function trackZoomTime(param1:Boolean) : void
      {
         ...
         {
            _loc2_ = getTimer();
            _loc3_ = Math.round((_loc2_ - this.var_1847) / 1000);
      ...
      {
         if(this.var_16 != null && this.var_31 != null && this.var_1848 && this._loadingComplete)
         {
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_583:
               ...
               this.var_227 = this._windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_402,WindowStyle.const_1261,WindowParam.const_103) as IToolTipWindow;
               this.var_227.setParamFlag(WindowParam.const_30,false);
