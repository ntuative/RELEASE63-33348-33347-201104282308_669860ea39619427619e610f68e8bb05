      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomQueueMessage.CHANGE_TO_SPECTATOR_QUEUE:
               this._container.roomSession.changeQueue(RoomSessionQueueEvent.const_1202);
               break;
            ...
            case RoomWidgetRoomQueueMessage.const_951:
               ...
               {
                  this._container.catalog.openCatalogPage(CatalogPageName.const_205,true);
               }
         }
         return null;
      }
            ...
            case RoomSessionQueueEvent.const_475:
               ...
               switch(_loc2_.queueSetTarget)
               {
                  case RoomSessionQueueEvent.const_1170:
                     _loc3_ = "null";
                     break;
                  case RoomSessionQueueEvent.const_1202:
                     _loc3_ = "null";
               }
               if(_loc3_ == null)
               {
               ...
               if(_loc5_.length > 1)
               {
                  if(_loc4_ && _loc2_.queueTypes.indexOf(RoomSessionQueueEvent.const_1257) != -1)
                  {
                     _loc6_ = _loc2_.getQueueSize(RoomSessionQueueEvent.const_1257) + 1;
                     _loc7_ = true;
                  }
                  else
                  {
                     _loc6_ = _loc2_.getQueueSize(RoomSessionQueueEvent.const_1757) + 1;
                  }
               }
               else
               {
