package com.sulake.habbo.widget
{
   ...
   public class RoomWidgetFactory extends Component implements IRoomWidgetFactory
   {
      ...
      private var var_2930:IAssetLibrary;
      ...
      public function RoomWidgetFactory(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_2930 = param1.root.assets;
      ...
      public function createWidget(param1:String) : IRoomWidget
      {
         ...
         switch(param1)
         {
            case RoomWidgetEnum.const_389:
               _loc2_ = new RoomChatWidget(this._windowManager,assets,this.var_58,this.var_142,this.var_2204++,this,this._questEngine);
               break;
            case RoomWidgetEnum.CHAT_INPUT_WIDGET:
               if(this.var_142.getKey("new.chat.widget.enabled") == "1")
               {
                  _loc2_ = new RoomChatInputWidget(this._windowManager,assets,this.var_58,this.var_142,this);
               }
               else
               {
                  _loc2_ = new RoomChatInputWidgetOld(this._windowManager,assets,this.var_58,this.var_142,this);
               }
               break;
            case RoomWidgetEnum.const_634:
               _loc2_ = new InfostandWidget(this._windowManager,assets,this.var_58,this.var_142,this._catalog);
               break;
            case RoomWidgetEnum.const_523:
               _loc2_ = new MeMenuWidget(this._windowManager,assets,this.var_58,events,this.var_142);
               break;
            ...
            case RoomWidgetEnum.const_615:
               _loc2_ = new TeaserFurniWidget(this._windowManager,assets,this.var_58,this.var_142,this._inventory);
               break;
            ...
            case RoomWidgetEnum.const_589:
               _loc2_ = new LoadingBarWidget(this._windowManager,assets,this.var_58,this.var_142);
               break;
            case RoomWidgetEnum.const_696:
               _loc2_ = new RoomQueueWidget(this._windowManager,assets,this.var_58,this.var_142);
               break;
            case RoomWidgetEnum.const_124:
               _loc2_ = new VoteWidget(this._windowManager,assets,this.var_58,this.var_142);
               break;
            ...
            case RoomWidgetEnum.const_136:
               _loc2_ = new AvatarInfoWidget(this._windowManager,assets,this.var_142,this.var_58,this);
               break;
            ...
            case RoomWidgetEnum.const_542:
               _loc2_ = new PlayListEditorWidget(this._windowManager,this._soundManager,assets,this.var_58,this.var_142,this._catalog);
               break;
