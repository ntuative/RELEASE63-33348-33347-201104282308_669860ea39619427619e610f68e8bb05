package com.sulake.habbo.widget.avatarinfo
{
   ...
   public class AvatarInfoView
   {
      ...
      private static const const_1359:int = 25;
      ...
      protected var var_2478:Boolean;
      
      protected var var_1613:int;
      
      protected var var_2345:int;
      
      protected var var_1330:XML;
      
      protected var var_1329:Boolean;
      
      protected var var_2125:FixedSizeStack;
      
      protected var var_2126:int = -1000000;
      ...
      {
         this.var_2125 = new FixedSizeStack(const_1359);
         super();
         this._widget = param1;
         this._userId = param2;
         this._userName = param3;
         this.var_1613 = param5;
         this.var_2345 = param4;
         this.var_2478 = param6;
         this.var_1330 = XmlAsset(this._widget.assets.getAssetByName("avatar_info_widget")).content as XML;
      }
      ...
      protected function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.buildFromXML(this.var_1330,0) as IWindowContainer;
         if(!this._window)
         {
            return;
         }
      ...
      {
         this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_698));
      ...
      public function update(param1:Rectangle, param2:Point, param3:Number) : void
      {
         ...
         if(!this.var_1329)
         {
            ...
            if(this.var_1613 == RoomObjectTypeEnum.const_172 || this.var_1613 == RoomObjectTypeEnum.const_527)
            {
            ...
            this.var_2125.addValue(_loc5_);
            _loc6_ = this.var_2125.getMax();
            if(_loc6_ < this.var_2126 - const_1005)
            {
               _loc6_ = this.var_2126 - const_1005;
            }
            _loc7_ = param2.y - _loc6_;
            this.var_2126 = _loc6_;
