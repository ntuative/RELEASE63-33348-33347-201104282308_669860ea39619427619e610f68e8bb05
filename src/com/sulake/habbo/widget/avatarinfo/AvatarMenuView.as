package com.sulake.habbo.widget.avatarinfo
{
   ...
   public class AvatarMenuView extends AvatarInfoView
   {
      ...
      protected static const const_1316:uint = 0;
      
      protected static const const_447:uint = 1;
      
      protected static const const_1315:uint = 2;
      
      private static const const_1425:uint = 4282663229;
      
      private static const const_1426:uint = 4283715916;
       
      
      protected var _data:AvatarInfoData;
      
      protected var var_574:uint = 0;
      ...
      public function AvatarMenuView(param1:AvatarInfoWidget, param2:int, param3:String, param4:int, param5:int, param6:AvatarInfoData)
      {
         ...
         this._data = param6;
         var_1330 = XmlAsset(_widget.assets.getAssetByName("avatar_menu_widget")).content as XML;
      }
      ...
      override protected function createWindow() : void
      {
         ...
         _window = _widget.windowManager.buildFromXML(var_1330,0) as IWindowContainer;
         if(!_window)
         {
            return;
         }
      ...
      protected function updateButtons() : void
      {
         ...
         if(this.var_574 == const_1316 || this.var_574 == const_447)
         {
            ...
            else
            {
               ...
               this.var_574 = const_447;
            }
         }
         if(this.var_574 == const_447)
         {
