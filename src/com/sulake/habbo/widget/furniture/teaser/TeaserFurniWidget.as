package com.sulake.habbo.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_1842:int = 0;
      
      private const const_1840:int = 1;
      
      private const const_1844:int = 2;
      
      private const const_1845:int = 3;
      
      private const const_1841:int = 4;
      
      private const const_2124:int = 0;
      
      private const const_2126:int = 1;
      
      private const const_2121:int = 2;
      
      private const const_2119:int = 3;
      
      private const const_2120:int = 4;
      
      private const const_2122:int = 5;
      
      private const const_1846:String = "deco_img";
      
      private const const_1843:String = "dialog_bg";
      
      private const const_2125:String = "%campaign%_dialog_bg.png";
      
      private const const_364:String = "%campaign%_gift_package.png";
      
      private const const_2118:String = "%campaign%_gift_content.png";
      ...
      public function TeaserFurniWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboInventory)
      {
         ...
         this.var_1385 = this.var_142.getKey("image.library.url","http://images.habbo.com/c_images/");
         this.var_1385 += "Viral/";
      }
      ...
      override public function dispose() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1384.length)
         {
            _loc2_ = this.var_1384.pop();
            _loc2_.dispose();
            _loc1_++;
         }
         this.var_142 = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_478,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_768,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_886,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTeaserDataUpdateEvent.const_478,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_478:
               _loc2_ = this.const_1842;
               this._shareId = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_886:
               ...
               {
                  _loc2_ = this.const_1841;
               }
               this._shareId = null;
               this.var_1387 = param1.itemCategory;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_768:
               _loc2_ = this.const_1840;
         ...
         if(this._window && (this.var_1386 != _loc2_ || _loc3_ != this.var_177))
         {
            this._window.dispose();
            this._window = null;
         }
         ...
         if(!this._window)
         {
            switch(this.var_1386)
            {
               case this.const_1842:
                  ...
                  break;
               case this.const_1840:
                  if(this.var_402 == this.const_2124)
                  {
                  ...
                  else if(this.var_402 == this.const_2126)
                  {
                  ...
                  else if(this.var_402 == this.const_2121)
                  {
                  ...
                  else if(this.var_402 == this.const_2119)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                  ...
                  else if(this.var_402 == this.const_2120)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_177,"client.show.not_enough_fb_friends");
                  ...
                  else if(this.var_402 == this.const_2122)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
            ...
            _loc5_ = this.const_2125.replace("%campaign%",this.var_177);
            this.setDecoImage(_loc5_,this.const_1843);
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_812);
      ...
      private function onPostButton(param1:WindowEvent) : void
      {
         ...
         var _loc4_:String = this.var_142.getKey("viral.furni.post_type","feed");
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(this._inventory)
         {
            if(this.var_1387 != 0)
            {
               this._inventory.toggleInventoryPage(this.var_1387 == 1 ? "null" : InventoryCategory.const_141);
            }
         }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_743,"ViralGift",param1,param2,param3);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1384.push(new ImageDownloader(this,_assets,this.var_177,this.var_1385,param1,param2));
            return;
         }
