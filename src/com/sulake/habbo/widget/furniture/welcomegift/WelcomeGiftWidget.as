package com.sulake.habbo.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_677:String = "welcome_gift_email_unverified";
      
      private const const_1067:String = "welcome_gift_email_verified";
      
      private const const_1514:String = "welcome_gift_email_change";
      
      private const const_2167:int = 4;
      ...
      private function createMainView() : void
      {
         ...
         if(this.var_1299)
         {
            this.setViewState(this.const_1067);
         }
         else
         {
            this.setViewState(this.const_677);
         }
      }
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_677:
               ...
               this._view.findChildByName("edit_text").visible = this.var_1047;
               this._view.findChildByName("edit").setParamFlag(WindowParam.const_30,this.var_1047);
               break;
            case this.const_1067:
            ...
            case this.const_1514:
               ...
               this.setBitmap("email_icon","email_icon");
               this.setButtonState("save_email",this.var_1047);
      ...
      {
         messageListener.processWidgetMessage(new RoomWidgetFurniActionMessage(RoomWidgetFurniActionMessage.const_827,this._furniId,0));
         this.disposeView();
      }
      
      private function cancelEmailChange(param1:WindowMouseEvent) : void
      {
         this.setViewState(!!this.var_1299 ? this.const_1067 : this.const_677);
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_491,this.updateEventHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_491,this.updateEventHandler);
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_491:
               this.var_1579 = param1.email;
               this.var_1299 = param1.isVerified;
               this.var_1047 = param1.allowEmailChange;
      ...
      private function emailChangeHandler(param1:RoomWidgetChangeEmailResultEvent) : void
      {
         ...
         {
            if(param1.result == this.const_2167)
            {
               this.var_1047 = false;
            }
