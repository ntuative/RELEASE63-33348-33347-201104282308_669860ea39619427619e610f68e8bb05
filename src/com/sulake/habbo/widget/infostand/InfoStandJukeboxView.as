package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandJukeboxView extends InfoStandFurniView
   {
      ...
      {
         if(param1.type == RoomWidgetSongUpdateEvent.const_410)
         {
            this.var_1894 = param1.songId;
         }
         if(param1.songId == this.var_1894)
         {
            this._songName = param1.songName;
            this.var_2706 = param1.songAuthor;
            this.updateNowPlaying(this.var_1894 >= 0);
         }
      }
      ...
      private function updateNowPlaying(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            ...
            this.nowPlayingAuthorName = this.var_2706;
         }
         else
         {
