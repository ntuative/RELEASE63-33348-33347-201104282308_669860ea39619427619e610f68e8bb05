package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private var var_197:PetCommandTool;
      
      private var _petData:Map;
      
      private var var_492:int;
      
      private const const_2137:int = 152;
      
      private const const_2139:int = 16;
      
      private const const_1352:int = 4;
      
      private const const_2131:uint = 14342874;
      
      private const const_2138:uint = 3815994;
      
      private const const_2134:uint = 2085362;
      
      private const const_2140:uint = 39616;
      
      private const const_2135:uint = 10513106;
      
      private const const_2130:uint = 8734654;
      
      private const const_2136:uint = 9094430;
      
      private const const_2132:uint = 6200576;
      
      private const const_2141:String = "happiness";
      
      private const const_2133:String = "experience";
      
      private const const_2129:String = "energy";
      ...
      {
         if(this.var_53 == null || this.var_46 == null || this.var_101 == null)
         {
            return;
         }
         ...
         this.var_46.height = this.var_53.height + 20;
         this._window.width = Math.max(this.var_46.width,this.var_101.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_46.width < this.var_101.width)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_2141,param1.nutrition,param1.nutritionMax,this.const_2140,this.const_2134);
         this.updateStateElement(this.const_2133,param1.experience,param1.experienceMax,this.const_2130,this.const_2135);
         this.updateStateElement(this.const_2129,param1.energy,param1.energyMax,this.const_2132,this.const_2136);
         ...
         this.updateWindow();
         this.var_492 = param1.id;
         this._petData.remove(param1.id);
         this._petData.add(param1.id,param1);
         if(this.var_197 && this.var_197.isVisible() && param1.isOwnPet)
         {
            this.var_197.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:CommandConfiguration) : void
      {
         ...
         this.var_197.setEnabledCommands(param1,param2);
      }
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(this.const_2137,this.const_2139,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),this.const_2131);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,this.const_2138);
         var _loc9_:Rectangle = new Rectangle(1,1 + this.const_1352,_loc7_.width - 2,_loc7_.height - 2 - this.const_1352);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,this.const_1352);
      ...
      private function openTrainView() : void
      {
         if(this.var_197 == null)
         {
            this.var_197 = new PetCommandTool(this._widget);
         }
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_492) as InfoStandPetData;
         if(_loc1_ != null)
         {
            this.var_197.showWindow(true);
            this.var_197.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(this.var_46 != null)
         {
            this.var_53 = this.var_46.findChildByName("infostand_element_list") as IItemListWindow;
         }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_197 && this.var_197.getPetId() == this.var_492)
               {
                  this.var_197.showWindow(false);
               }
               break;
            case "btn_train":
               this.openTrainView();
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1811,true);
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_430,this._widget.petData.ownerId);
