package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_1110:TagListRenderer;
      
      private var var_144:IBorderWindow;
      
      private var var_2891:int;
      
      private const const_1074:int = 5;
      
      private const const_1892:int = 7829367;
      
      private const const_1891:int = 16777215;
      
      private const const_2171:int = 2000;
      
      private const const_2172:int = 50;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_1110 = new TagListRenderer(param1,this.onTagSelected);
      }
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         while(_loc9_ < 5)
         {
            _loc8_ = this.var_46.findChildByName("badge_" + _loc9_);
            if(_loc8_ != null)
            {
               _loc8_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.showBadgeInfo);
               _loc8_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OUT,this.hideBadgeInfo);
            }
            _loc9_++;
         }
         _loc8_ = this.var_46.findChildByName("badge_group");
      ...
      private function showGroupBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         _loc3_ = this.var_144.getChildByName("name") as ITextWindow;
         if(_loc3_ != null)
         {
            _loc3_.text = "Group Info";
         }
         _loc4_ = this.var_144.getChildByName("description") as ITextWindow;
         if(_loc4_ != null)
         {
         ...
         this.var_144.x = _loc5_.left - this.var_144.width;
         this.var_144.y = _loc5_.top + (_loc5_.height - this.var_144.height) / 2;
      }
      ...
      private function showBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         this.method_3();
         _loc6_ = this.var_144.getChildByName("name") as ITextWindow;
         if(_loc6_ != null)
         {
            _loc6_.text = this._widget.localizations.getBadgeName(_loc5_);
         }
         _loc6_ = this.var_144.getChildByName("description") as ITextWindow;
         if(_loc6_ != null)
         {
         ...
         this.var_144.x = _loc7_.left - this.var_144.width;
         this.var_144.y = _loc7_.top + (_loc7_.height - this.var_144.height) / 2;
      }
      ...
      private function method_3() : void
      {
         ...
         this.var_144 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IBorderWindow;
         if(this.var_144 == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            if(param1 == "")
            {
               ...
               _loc3_.textColor = this.const_1892;
            }
            else
            {
               _loc3_.textColor = this.const_1891;
            }
            _loc3_.enable();
         }
         else
         ...
         _loc3_.text = param1;
         _loc3_.height = Math.min(_loc3_.textHeight + this.const_1074,this.const_2172);
         if(param2)
         {
            _loc3_.addEventListener(WindowKeyboardEvent.const_312,this.onMottoKeyboard);
            _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc3_.removeEventListener(WindowKeyboardEvent.const_312,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_1110.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      protected function updateInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         this.setMotto(param1.motto,param1.type == RoomWidgetUserInfoUpdateEvent.const_134);
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.const_707:
               _loc2_ = "${infostand.button.trade.tooltip.shutdown}";
               break;
            case RoomWidgetUserInfoUpdateEvent.const_790:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc5_ = getTimer();
            if(_loc5_ - this.var_2891 > this.const_2171 && _loc3_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2891 = _loc5_;
            }
         }
         else
         {
            _loc2_.textColor = this.const_1892;
         }
      }
