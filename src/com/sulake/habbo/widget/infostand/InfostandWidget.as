package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private const const_1861:String = "infostand_user_view";
      
      private const const_1860:String = "infostand_furni_view";
      
      private const const_1856:String = "infostand_pet_view";
      
      private const const_1858:String = "infostand_bot_view";
      
      private const const_1857:String = "infostand_jukebox_view";
      
      private const const_1859:String = "infostand_songdisk_view";
      
      private var var_1178:InfoStandFurniView;
      
      private var var_184:InfoStandUserView;
      
      private var var_357:InfoStandPetView;
      ...
      private const const_2146:int = 3000;
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboCatalog)
      {
         ...
         this.var_1178 = new InfoStandFurniView(this,this.const_1860,this._catalog);
         this.var_184 = new InfoStandUserView(this,this.const_1861);
         this.var_357 = new InfoStandPetView(this,this.const_1856,this._catalog);
         this.var_424 = new InfoStandBotView(this,this.const_1858);
         this.var_948 = new InfoStandJukeboxView(this,this.const_1857,this._catalog);
         this.var_949 = new InfoStandSongDiskView(this,this.const_1859,this._catalog);
         this.var_1449 = new InfostandUserData();
         this.var_652 = new InfostandFurniData();
         this._petData = new InfoStandPetData();
         this.var_159 = new Timer(this.const_2146);
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetUserFigureUpdateEvent.const_183,this.onUserFigureUpdate);
         param1.addEventListener(RoomWidgetUserBadgesUpdateEvent.const_151,this.onUserBadges);
         param1.addEventListener(RoomWidgetBadgeImageUpdateEvent.const_901,this.onBadgeImage);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetUserFigureUpdateEvent.const_183,this.onUserFigureUpdate);
         param1.removeEventListener(RoomWidgetUserBadgesUpdateEvent.const_151,this.onUserBadges);
         param1.removeEventListener(RoomWidgetBadgeImageUpdateEvent.const_901,this.onBadgeImage);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_419,this.var_357.getCurrentPetId()));
      }
      ...
      private function onUserInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         this.selectView(this.const_1861);
         if(this.var_159)
         {
            this.var_159.stop();
         }
      ...
      private function onBotInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         this.selectView(this.const_1858);
         if(this.var_159)
         {
            this.var_159.stop();
         }
      ...
      private function onFurniInfo(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         if(param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_792)
         {
            this.var_948.update(param1);
            this.selectView(this.const_1857);
         }
         else if(param1.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_398) != -1)
         {
            this.var_949.update(param1);
            this.selectView(this.const_1859);
         }
         else
         {
            this.var_1178.update(param1);
            this.selectView(this.const_1860);
         }
         if(this.var_159)
         {
            this.var_159.stop();
      ...
      private function onPetInfo(param1:RoomWidgetPetInfoUpdateEvent) : void
      {
         ...
         this.var_357.update(this.petData);
         this.selectView(this.const_1856);
         if(this.var_159)
         {
            this.var_159.start();
         }
      ...
      {
         this.var_357.updateEnabledTrainingCommands(param1.id,new CommandConfiguration(param1.allCommands,param1.enabledCommands));
      }
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            this.var_184.setTags(param1.tags,this.var_2507);
         }
      }
      ...
      private function onRoomObjectRemoved(param1:RoomWidgetRoomObjectUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomObjectUpdateEvent.const_184:
               ...
               if(this.var_357 != null && this.var_357.window != null && this.var_357.window.visible)
               {
