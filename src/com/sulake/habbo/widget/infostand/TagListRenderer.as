package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_2160:int = 5;
      
      private const const_2161:int = 5;
      
      private var _widget:InfostandWidget;
      
      private var var_150:Function;
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(this.var_1260 + param1.height > this.var_1259.height)
         {
            return false;
         }
         ...
         {
            this._offsetX = 0;
            this.var_1260 += param1.height + this.const_2161;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1260);
         this._offsetX += param1.width + this.const_2160;
         return true;
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1541 != null && this.var_1541.indexOf(param1) != -1)
         {
         ...
         _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_150);
