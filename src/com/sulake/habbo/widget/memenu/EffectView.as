package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private const const_2144:int = 1000;
      ...
      private var var_930:IWindow;
      
      public function EffectView()
      {
         super();
         this.var_215 = new Timer(this.const_2144);
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            this.var_930 = this._window.findChildByName("effect_hilite");
