package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      {
         this.var_499 = param1.volume;
         if(this.var_897 != null)
         {
            this.var_897.setValue(this.var_499);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_870));
      }
      ...
      private function setSoundsOffIcon(param1:BitmapData = null) : void
      {
         ...
         else if(this.var_499 == 0)
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1662);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1659);
         }
      }
      ...
      private function setSoundsOnIcon(param1:BitmapData = null) : void
      {
         ...
         else if(this.var_499 == 1)
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1660);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1661);
         }
      }
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_706);
         }
         else
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_873);
         }
