package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class MainWindowHandler
   {
      ...
      private var var_1020:IBorderWindow;
      
      private var var_1019:IBorderWindow;
      ...
      private var var_2014:IScrollbarWindow;
      ...
      public function MainWindowHandler(param1:PlayListEditorWidget, param2:IHabboMusicController)
      {
         ...
         this._widget = param1;
         this.var_234 = param2;
         var _loc3_:Array = [PlayListEditorWidgetAssetsEnum.const_826,PlayListEditorWidgetAssetsEnum.const_974,PlayListEditorWidgetAssetsEnum.const_628,PlayListEditorWidgetAssetsEnum.const_522,PlayListEditorWidgetAssetsEnum.const_824];
      ...
      public function destroy() : void
      {
         if(this.var_234)
         {
            this.var_234.stop(HabboMusicPrioritiesEnum.const_405);
            this.var_234 = null;
         }
         if(this.var_551)
         {
      ...
      {
         this.var_234.requestUserSongDisks();
         var _loc1_:IPlayListController = this.var_234.getRoomItemPlaylist();
         if(_loc1_ != null)
         {
      ...
      public function refreshLoadableAsset(param1:String = "") : void
      {
         ...
         {
            this.assignWindowBitmapByAsset(this.var_1020,"music_inventory_splash_image",PlayListEditorWidgetAssetsEnum.const_826);
         }
         if(param1 == "" || param1 == PlayListEditorWidgetAssetsEnum.const_974)
         {
            this.assignWindowBitmapByAsset(this.var_1019,"playlist_editor_splash_image",PlayListEditorWidgetAssetsEnum.const_974);
         }
         if(param1 == "" || param1 == PlayListEditorWidgetAssetsEnum.const_628)
         {
            this.var_233.setPreviewPlayingBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_628));
         }
         if(param1 == "" || param1 == PlayListEditorWidgetAssetsEnum.const_522)
         {
            this.var_233.setGetMoreMusicBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_522));
         }
         if(param1 == "" || param1 == PlayListEditorWidgetAssetsEnum.const_824)
         {
            this.var_321.addSongsBackgroundImage = this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_824);
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_1020 = _loc2_.getChildByName("my_music_border") as IBorderWindow;
         this.var_1019 = _loc2_.getChildByName("playlist_border") as IBorderWindow;
         ...
         this.var_2014 = this.var_1020.getChildByName("music_inventory_scrollbar") as IScrollbarWindow;
         this.var_2013 = this.var_1019.getChildByName("playlist_scrollbar") as IScrollbarWindow;
      ...
      {
         return this.var_1020.getChildByName("music_inventory_itemgrid") as IItemGridWindow;
      }
      
      private function getPlayListEditorItemList() : IItemListWindow
      {
         return this.var_1019.getChildByName("playlist_editor_itemlist") as IItemListWindow;
      }
      
      private function getMusicInventoryStatusContainer() : IWindowContainer
      {
         return this.var_1020.getChildByName("preview_play_container") as IWindowContainer;
      }
      
      private function getPlayListStatusContainer() : IWindowContainer
      {
         return this.var_1019.getChildByName("now_playing_container") as IWindowContainer;
      }
      ...
      private function selectPlayListStatusViewByFurniPlayListState() : void
      {
         ...
         if(_loc1_.isPlaying)
         {
            this.var_321.selectView(PlayListStatusView.const_582);
         }
         else if(_loc1_.length > 0)
         {
            this.var_321.selectView(PlayListStatusView.const_1100);
         }
         else
         {
            this.var_321.selectView(PlayListStatusView.const_766);
         }
      }
      ...
      private function selectMusicStatusViewByMusicState() : void
      {
         ...
         {
            this.var_233.show();
            this.var_233.selectView(MusicInventoryStatusView.const_752);
         }
         else if(this.var_234.getSongDiskInventorySize() <= const_1474)
         {
            this.var_233.show();
            this.var_233.selectView(MusicInventoryStatusView.const_957);
         }
         else
         {
            this.var_233.hide();
      ...
      public function onSongDiskInventoryReceived() : void
      {
         ...
         this.var_2014.visible = this.var_551.itemCount > const_1473;
      }
      ...
      public function onNowPlayingChanged(param1:RoomWidgetPlayListEditorNowPlayingEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetPlayListEditorNowPlayingEvent.const_104:
               ...
               if(param1.id != -1)
               {
                  _loc3_ = this.var_234.getSongInfo(param1.id);
            ...
            case RoomWidgetPlayListEditorNowPlayingEvent.const_122:
               ...
               this.selectMusicStatusViewByMusicState();
               break;
            case RoomWidgetPlayListEditorNowPlayingEvent.const_120:
      ...
      {
         return this.var_234.getSongIdPlayingAtPriority(HabboMusicPrioritiesEnum.const_405) != -1;
      }
   }
}
