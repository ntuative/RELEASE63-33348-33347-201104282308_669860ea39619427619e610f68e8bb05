package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_766:String = "PLSV_ADD_SONGS";
      
      public static const const_1100:String = "PLSV_START_PLAYBACK";
      
      public static const const_582:String = "PLSV_NOW_PLAYING";
      ...
      {
         if(this.var_44 != const_582)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_407[this.var_44];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_407[const_766];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_407.add(const_582,_loc1_);
