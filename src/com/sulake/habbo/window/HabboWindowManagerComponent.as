package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_451:uint = 3;
      
      private static const const_1364:uint = 1;
      ...
      private var var_1739:ProfilerOutput;
      
      private var var_1408:ProfilerAgentTask;
      
      private var var_1409:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_914 = new SkinContainer(_loc4_.content as XML,assets);
         this._windowRenderer = new WindowRenderer(this.var_914);
         this.var_198 = new Array(const_451);
         ...
         var _loc6_:int = 0;
         while(_loc6_ < const_451)
         {
            this.var_198[_loc6_] = new WindowContext("layer_" + _loc6_,this._windowRenderer,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this.var_263 = this.var_198[const_1364];
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1739)
            {
               this.var_1739 = new ProfilerOutput(context,this,this._windowRenderer);
            }
            this.var_1739.profiler = _loc3_;
            this.var_1408 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1408);
            this.var_1409 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1409);
            this.var_1154 = true;
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_198)
            {
               ...
               {
                  IDisposable(this.var_198.pop()).dispose();
               }
            }
            this.var_198 = null;
            if(this.var_245)
      ...
      {
         return this.var_263.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      {
         return this.var_263.getWindowParser().windowToXMLString(param1);
      }
      
      public function getLayoutByTypeAndStyle(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = this.var_245[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? this.var_245[0][param1] as XML : _loc4_;
      }
      
      public function getDefaultsByTypeAndStyle(param1:uint, param2:uint) : DefaultAttStruct
      {
         return this.var_914.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      {
         return this.var_198[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = this.var_198[param2].getDesktopWindow();
      ...
      {
         return this.var_198[param2].getDesktopWindow().getChildByName(param1);
      }
      
      public function getActiveWindow(param1:uint = 1) : IWindow
      {
         return this.var_198[param1].getDesktopWindow().getChildAt(this.var_263.getDesktopWindow().numChildren - 1);
      }
      ...
      {
         var _loc2_:IWindowContext = this.var_198[param1];
      ...
      public function update(param1:uint) : void
      {
         ...
         _loc2_ = 0;
         while(_loc2_ < const_451)
         {
            this.var_198[_loc2_].render(param1);
            _loc2_++;
         }
         if(this.var_1154)
         {
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1674,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1809,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1636,param2.name + ": " + param2.toString());
            }
         }
      }
      ...
      private function performTestCases() : void
      {
         ...
         _loc1_.begin(this);
         _loc1_.test({
            "type":WindowType.const_590,
            "style":WindowStyle.const_170,
            "caption":"Testing",
            "count":800,
            "properties":[_loc2_]
         });
