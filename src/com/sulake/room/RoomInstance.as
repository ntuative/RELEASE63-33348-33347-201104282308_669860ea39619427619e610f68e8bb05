package com.sulake.room
{
   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      private var var_167:IRoomRendererBase;
      ...
      public function dispose() : void
      {
         ...
         {
            for(_loc1_ in this.var_610)
            {
               delete this.var_610[_loc1_];
            }
            this.var_610 = null;
         }
         this.var_1402 = [];
      ...
      {
         if(this.var_1403.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
      ...
      {
         if(this.var_1402.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
         ...
         if(this.var_610[param1] != param2)
         {
            this.var_610[param1] = param2;
         }
      }
      ...
      public function update() : void
      {
         ...
         var _loc2_:int = this.var_582.length - 1;
         while(_loc2_ >= 0)
         {
            _loc3_ = int(this.var_582[_loc2_]);
      ...
      public function createObjectInternal(param1:int, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         if(_loc5_ != null)
         {
            ...
            if(this.var_167 != null)
            {
               this.var_167.feedRoomObject(_loc6_);
            }
            return _loc6_;
         }
         return null;
      ...
      public function disposeObject(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc4_ != null)
            {
               if(this.var_167)
               {
                  this.var_167.removeRoomObject(_loc4_.getInstanceId());
               }
         ...
         if(_loc3_ != null)
         {
            ...
            while(_loc4_ < _loc2_)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(this.var_167)
                  {
                     this.var_167.removeRoomObject(_loc6_);
                  }
               }
               _loc4_++;
            }
      ...
      public function setRenderer(param1:IRoomRendererBase) : void
      {
         ...
         while(_loc3_ >= 0)
         {
            ...
            while(_loc6_ >= 0)
            {
               ...
               if(_loc7_ != null)
               {
                  this.var_167.feedRoomObject(_loc7_);
               }
               _loc6_--;
            }
            _loc3_--;
