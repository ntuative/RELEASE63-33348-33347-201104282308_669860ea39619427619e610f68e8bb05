package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      public static const const_872:int = 3;
      ...
      private var var_150:IRoomManagerListener;
      
      private var var_2972:IRoomContentLoader;
      
      private var var_583:IRoomObjectFactory = null;
      
      private var var_484:IRoomObjectVisualizationFactory = null;
      
      private var _state:int = 0;
      
      private var var_1097:XML = null;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         events.addEventListener(RoomContentLoadedEvent.const_525,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_700,this.onContentLoaded);
      }
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_583 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_583 == null || this.var_484 == null)
         {
            return;
         }
         this._state = const_1575;
         if(this.var_1097 != null)
         {
            _loc1_ = this.var_1097;
            this.var_1097 = null;
            this.initialize(_loc1_,this.var_150);
         }
      }
      ...
      public function createRoom(param1:String, param2:XML) : IRoomInstance
      {
         ...
         var _loc4_:int = this.var_582.length - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this.var_582[_loc4_];
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_583.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_583 != null)
         {
            return this.var_583.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this._state == const_858)
         {
            return;
         }
         if(this.var_55 == null)
         {
            this._state = const_858;
            return;
         }
         if(this.var_55.getGraphicAssetCollection(param1) != null)
         {
            ...
            {
               this._state = const_872;
               if(this.var_150 != null)
               {
                  this.var_150.roomManagerInitialized();
               }
            }
         }
         else
         {
            this._state = const_858;
            this.var_150.roomManagerInitialized(false);
         }
      }
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         if(_loc2_ == null)
         {
            if(this.var_150 != null)
            {
               this.var_150.contentLoaded(null,false);
            }
            return;
         }
      ...
      private function processLoadedContentTypes() : void
      {
         ...
         while(this.var_890.length > 0)
         {
            ...
            if(_loc3_ == null)
            {
               if(this.var_150 != null)
               {
                  this.var_150.contentLoaded(_loc2_,false);
               }
               return;
            }
            ...
            if(this.var_150 != null)
            {
               this.var_150.contentLoaded(_loc2_,true);
            }
            if(this.var_584.length > 0)
            {
      ...
      private function updateObjectContents(param1:String) : void
      {
         ...
         if(this.var_55 == null || this.var_484 == null)
         {
            return;
         }
         ...
         var _loc7_:IRoomObjectVisualizationData = this.var_484.getRoomObjectVisualizationData(param1,_loc5_,_loc2_);
            ...
            if(_loc9_ != null)
            {
               ...
               for each(_loc12_ in _loc11_)
               {
                  ...
                  while(_loc14_ >= 0)
                  {
                     ...
                     if(_loc15_ != null)
                     {
                        _loc16_ = this.var_484.createRoomObjectVisualization(_loc5_);
                        if(_loc16_ != null)
                        {
                           ...
                           else
                           {
                              ...
                              _loc17_ = this.var_583.createRoomObjectLogic(_loc6_);
                              ...
                              if(this.var_150 != null)
                              {
                                 this.var_150.objectInitialized(_loc10_,_loc15_.getId(),_loc12_);
                              }
                           }
                        }
                        else
