package com.sulake.room.object.logic
{
   ...
   public class ObjectLogicBase implements IRoomObjectEventHandler
   {
      ...
      private var var_353:IRoomObjectController;
      ...
      {
         if(this.var_353 == param1)
         {
            return;
         }
         if(this.var_353 != null)
         {
            this.var_353.setEventHandler(null);
         }
         if(param1 == null)
         {
            this.dispose();
         ...
         {
            this.var_353 = param1;
            this.var_353.setEventHandler(this);
         }
      }
      ...
      public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         if(param1 != null)
         {
            if(this.var_353 != null)
            {
               this.var_353.setLocation(param1.loc);
               this.var_353.setDirection(param1.dir);
            }
         }
      }
   }
