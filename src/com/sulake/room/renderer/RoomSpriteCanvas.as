package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_1451:int = 50;
      
      private static const const_1034:Number = 60;
      
      private static const const_1452:Number = 50;
      ...
      private var var_661:RoomObjectCache;
      ...
      private var var_2749:Number = -1.0E7;
      
      private var var_2747:Number = -1.0E7;
      ...
      private var var_2753:Array;
      
      private var var_809:int = 0;
      
      private var var_1976:Number = 0.0;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this.var_265.addChild(this.var_96);
         ...
         this.var_661 = new RoomObjectCache(_loc6_);
         this.var_802 = new ColorTransform();
         this.var_660 = new Matrix();
      ...
      {
         this.var_535.x -= param1 - this.var_659;
         this.var_659 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_535.y -= param1 - this.var_656;
         this.var_656 = param1;
      }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_960 = true;
            if(this.var_141 != null && !this.var_265.contains(this.var_141))
            {
               this.var_265.addChild(this.var_141);
               this.var_96.mask = this.var_141;
            }
         }
         else if(!param1 && this.var_960)
         {
            this.var_960 = false;
            if(this.var_141 != null && this.var_265.contains(this.var_141))
            {
               this.var_265.removeChild(this.var_141);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_657 != null)
         {
            ...
            {
               this.cleanSprite(this.var_657[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            this.var_657 = [];
         }
      ...
      {
         this.var_661.removeObjectCache(param1);
      }
      
      public function render(param1:int) : void
      {
         this.var_1975 = !this.var_1975;
         ...
         if(this.var_536 != this.var_2748 || this.var_534 != this.var_2750)
         {
            _loc8_ = true;
         }
         if(this.var_96.x != this.var_659 || this.var_96.y != this.var_656)
         {
            this.var_96.x = this.var_659;
            this.var_96.y = this.var_656;
            _loc8_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_533.sortOn("z",0 | 0);
         if(_loc5_ < this.var_533.length)
         {
            this.var_533.splice(_loc5_);
         }
         var _loc9_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc9_ = this.var_533[_loc4_] as SortableSprite;
            if(_loc9_ != null)
            {
         ...
         this.var_2748 = this.var_536;
         this.var_2750 = this.var_534;
      }
      ...
      private function calculateUpdateInterval(param1:int) : void
      {
         ...
         if(this.var_1520 > 0)
         {
            ...
            if(_loc2_ > const_1034 * 3)
            {
               Logger.log("Really slow frame update " + _loc2_ + "ms");
               this.var_2752 = _loc2_;
            }
            if(_loc2_ <= MAXIMUM_VALID_FRAME_UPDATE_INTERVAL)
            {
               ++this.var_810;
               if(this.var_810 == const_367 + 1)
               {
                  this.var_485 = _loc2_;
                  this.var_1976 = this.var_2751;
               }
               else if(this.var_810 > const_367 + 1)
               {
                  _loc3_ = Number(this.var_810 - const_367);
                  this.var_485 = this.var_485 * (_loc3_ - 1) / _loc3_ + Number(_loc2_) / _loc3_;
                  this.var_1976 = this.var_1976 * (_loc3_ - 1) / _loc3_ + Number(this.var_2751) / _loc3_;
                  if(this.var_810 > const_367 + const_1451)
                  {
                     this.var_810 = const_367;
                     if(!this.var_1247 && this.var_485 > const_1034)
                     {
                        this.var_1247 = true;
                        Logger.log("Room canvas updating really slow - now entering frame skipping mode...");
                     }
                     else if(this.var_1247 && this.var_485 < const_1452)
                     {
                        this.var_1247 = false;
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            this.var_661.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = this.var_661.getObjectCache(param2);
         ...
         _loc6_.update(this._geometry,param3,!_loc9_.isEmpty || param4,this.var_1975 && this.var_1247);
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  _loc19_ = _loc13_ + _loc18_.offsetX + this.var_659;
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_656;
                  if(this.rectangleVisible(_loc19_,_loc20_,_loc22_.width,_loc22_.height))
                  {
                     ...
                     if(_loc17_ == null)
                     {
                        ...
                        this.var_533.push(_loc17_);
                        _loc17_.name = param2;
                     }
                     _loc17_.sprite = _loc18_;
                     _loc17_.x = _loc19_ - this.var_659;
                     _loc17_.y = _loc20_ - this.var_656;
      ...
      {
         if(param1 < this.var_536 && param1 + param3 >= 0 && (param2 < this.var_534 && param2 + param4 >= 0))
         {
            if(!this.var_2953)
            {
               return true;
      ...
      private function rectangleVisibleWithExclusion(param1:int, param2:int, param3:int, param4:int) : Boolean
      {
         ...
         if(param1 + param3 >= this.var_536)
         {
            param3 -= this.var_536 + 1 - (param1 + param3);
         }
         if(param2 + param4 >= this.var_534)
         {
            param4 -= this.var_534 + 1 - (param2 + param4);
         }
         for each(_loc5_ in this.var_2753)
         {
      ...
      {
         if(param1 < 0 || param1 >= this.var_1001)
         {
            return null;
         }
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         {
            _loc3_ = this.var_657.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
         ...
         if(param2 < 0 || param2 >= this.var_1001)
         {
      ...
      private function getSortableSprite(param1:int) : SortableSprite
      {
         ...
         return this.var_533[param1] as SortableSprite;
      }
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false, param4:Boolean = true, param5:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            this.var_660.identity();
            if(flipH)
            {
               this.var_660.scale(-1,1);
               this.var_660.translate(data.width,0);
            }
            if(flipV)
            {
               this.var_660.scale(1,-1);
               this.var_660.translate(0,data.height);
            }
            finalData.draw(data,this.var_660);
            if(name.length > 0)
            {
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            this.var_802.redMultiplier = tR;
            this.var_802.greenMultiplier = tG;
            this.var_802.blueMultiplier = tB;
            finalData.colorTransform(finalData.rect,this.var_802);
            if(name.length > 0)
            {
               this.var_264.addBitmapData(cacheName,finalData);
            }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         param1 -= this.var_659;
         param2 -= this.var_656;
         this.var_535.x = param1;
         this.var_535.y = param2;
         if(this.var_1248 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_1977;
         }
         this.var_1977 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1248;
         return this.var_1977;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_536 / 2;
         var _loc12_:Number = param2 - this.var_534 / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_1978,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
      ...
      private function checkMouseHits(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = this.var_658.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        this.var_658.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2749 || param2 != this.var_2747)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = this.var_658.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = this.var_658.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = this.createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  this.bufferMouseEvent(_loc11_,_loc9_);
      ...
      {
         if(this.var_380 != null && param1 != null)
         {
            this.var_380.add(param2,param1);
         }
      }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this._container == null || this.var_380 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         ...
         {
            _loc2_ = this.var_380.getKey(_loc1_);
            _loc3_ = this.var_380.getWithIndex(_loc1_);
      ...
      public function update() : void
      {
         if(this.var_1248 == 0)
         {
            this.checkMouseHits(this.var_535.x,this.var_535.y,MouseEvent.MOUSE_MOVE);
         }
         this.var_1248 = 0;
         ++this.var_1978;
      }
