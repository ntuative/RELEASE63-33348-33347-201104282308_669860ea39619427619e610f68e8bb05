package com.sulake.room.renderer.cache
{
   ...
   public class RoomObjectLocationCacheItem
   {
      ...
      {
         this.var_1317 = new Vector3d();
         super();
         this._roomObjectVariableAccurateZ = param1;
         this.var_396 = new Vector3d();
      }
      ...
      public function getScreenLocation(param1:IRoomObject, param2:IRoomGeometry) : IVector3d
      {
         ...
         if(param2.updateId != this.var_1844 || param1.getUpdateID() != this.var_2900)
         {
            this.var_2900 = param1.getUpdateID();
            if(param2.updateId != this.var_1844 || _loc4_.x != this.var_1317.x || _loc4_.y != this.var_1317.y || _loc4_.z != this.var_1317.z)
            {
               this.var_1844 = param2.updateId;
               this.var_1317.assign(_loc4_);
               _loc3_ = true;
            }
         }
         this.var_2899 = _loc3_;
         if(_loc3_)
         {
            ...
            if(isNaN(_loc6_) || _loc6_ == 0)
            {
               ...
               if(_loc7_.x != _loc4_.x || _loc7_.y != _loc4_.y)
               {
                  ...
                  this.var_396.assign(_loc5_);
                  if(_loc8_ != null)
                  {
                     this.var_396.z = _loc8_.z;
                  }
               }
               else
               {
            ...
            this.var_396.x = Math.round(this.var_396.x);
            this.var_396.y = Math.round(this.var_396.y);
         }
         return this.var_396;
      }
   }
