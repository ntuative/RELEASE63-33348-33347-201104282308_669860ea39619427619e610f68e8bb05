package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      private var var_1597:int = 128;
      
      private var var_1596:Boolean = false;
      
      private var var_2964:Point;
      ...
      {
         if(param1 != this.var_2072 || param2 != this.var_2073)
         {
      ...
      {
         if(this.var_1597 > 255 || bitmapData == null)
         {
            return false;
         }
