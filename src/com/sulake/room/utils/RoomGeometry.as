package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_944:Number = 64;
      
      public static const const_1232:Number = 32;
      ...
      private var var_2083:Number = 1.0;
      
      private var var_2084:Number = 1.0;
      
      private var var_2085:Number = 1.0;
      
      private var var_94:Vector3d;
      
      private var var_469:Vector3d;
      
      private var var_2966:Number = -500.0;
      
      private var var_2967:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_1319 = new Vector3d();
         this.var_467 = new Vector3d();
         this._direction = new Vector3d();
         this.var_1320 = new Vector3d();
         this.var_2083 = 1;
         this.var_2084 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_2085 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         this.var_467.assign(this.var_94);
         this.var_467.x *= this.var_466;
         this.var_467.y *= this.var_470;
         this.var_467.z *= this.var_468;
         return this.var_467;
      }
      ...
      {
         if(this.var_466 != param1 * this.var_2083)
         {
            this.var_466 = param1 * this.var_2083;
            ++this.var_172;
         }
      }
      ...
      {
         if(this.var_470 != param1 * this.var_2084)
         {
            this.var_470 = param1 * this.var_2084;
            ++this.var_172;
         }
      }
      ...
      {
         if(this.var_468 != param1 * this.var_2085)
         {
            this.var_468 = param1 * this.var_2085;
            ++this.var_172;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_94.x /= this.var_466;
         this.var_94.y /= this.var_470;
         this.var_94.z /= this.var_468;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_469.x;
         var _loc3_:Number = this.var_469.y;
         var _loc4_:Number = this.var_469.z;
         this.var_469.assign(param1);
         this._direction.assign(param1);
         if(this.var_469.x != _loc2_ || this.var_469.y != _loc3_ || this.var_469.z != _loc4_)
         {
            ++this.var_172;
         }
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_1319.assign(this.var_158);
         }
         else
         {
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(this.var_567 != null)
         {
            ...
            this.var_567.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            this.var_567.add(_loc3_,_loc4_);
            ++this.var_172;
         }
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_567 != null)
         {
            ...
            return this.var_567.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1320.assign(_loc22_);
         }
         else
         {
            this.var_1320.assign(_loc17_);
         }
         ++this.var_172;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.x *= this.var_466;
         _loc2_.y *= this.var_470;
         _loc2_.z *= this.var_468;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1320);
         if(_loc3_ < this.var_2966 || _loc3_ > this.var_2967)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_470;
            _loc2_.z *= this.var_468;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1320);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_94.x * this.var_466,this.var_94.y * this.var_470,this.var_94.z * this.var_468);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_158;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_466,param2.y * this.var_470,param2.z * this.var_468);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_466,param3.y * this.var_470,param3.z * this.var_468);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_466,param4.y * this.var_470,param4.z * this.var_468);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1232;
         }
         else
         {
            this.scale = const_944;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_944;
      }
